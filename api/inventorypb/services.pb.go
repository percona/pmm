...
var file_inventorypb_services_proto_rawDesc = []byte{
	...
	0x5f, 0x53, 0x45, 0x52, 0x56, 0x49, 0x43, 0x45, 0x10, 0x05, 0x32, 0x9b, 0x12, 0x0a, 0x08, 0x53,
	...
	0x64, 0x12, 0xc8, 0x01, 0x0a, 0x12, 0x41, 0x64, 0x64, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x53, 0x51,
...
var file_inventorypb_services_proto_depIdxs = []int32{
	...
	19, // 47: inventory.Services.AddProxySQLService:input_type -> inventory.AddProxySQLServiceRequest
	21, // 48: inventory.Services.AddHAProxyService:input_type -> inventory.AddHAProxyServiceRequest
	23, // 49: inventory.Services.AddExternalService:input_type -> inventory.AddExternalServiceRequest
	25, // 50: inventory.Services.RemoveService:input_type -> inventory.RemoveServiceRequest
	27, // 51: inventory.Services.AddCustomLabels:input_type -> inventory.AddCustomLabelsRequest
	29, // 52: inventory.Services.RemoveCustomLabels:input_type -> inventory.RemoveCustomLabelsRequest
	31, // 53: inventory.Services.ChangeService:input_type -> inventory.ChangeServiceRequest
	8,  // 54: inventory.Services.ListServices:output_type -> inventory.ListServicesResponse
	10, // 55: inventory.Services.ListActiveServiceTypes:output_type -> inventory.ListActiveServiceTypesResponse
	12, // 56: inventory.Services.GetService:output_type -> inventory.GetServiceResponse
	14, // 57: inventory.Services.AddService:output_type -> inventory.AddServiceResponse
	20, // 58: inventory.Services.AddProxySQLService:output_type -> inventory.AddProxySQLServiceResponse
	22, // 59: inventory.Services.AddHAProxyService:output_type -> inventory.AddHAProxyServiceResponse
	24, // 60: inventory.Services.AddExternalService:output_type -> inventory.AddExternalServiceResponse
	26, // 61: inventory.Services.RemoveService:output_type -> inventory.RemoveServiceResponse
	28, // 62: inventory.Services.AddCustomLabels:output_type -> inventory.AddCustomLabelsResponse
	30, // 63: inventory.Services.RemoveCustomLabels:output_type -> inventory.RemoveCustomLabelsResponse
	32, // 64: inventory.Services.ChangeService:output_type -> inventory.ChangeServiceResponse
