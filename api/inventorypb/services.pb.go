...
var file_inventorypb_services_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb2, 0x03, 0x0a, 0x19, 0x41, 0x64, 0x64,
	0x50, 0x72, 0x6f, 0x78, 0x79, 0x53, 0x51, 0x4c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52,
	...
	0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f,
	0x72, 0x79, 0x2e, 0x41, 0x64, 0x64, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x53, 0x51, 0x4c, 0x53, 0x65,
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xea, 0x02,
	...
	0x52, 0x4e, 0x41, 0x4c, 0x5f, 0x53, 0x45, 0x52, 0x56, 0x49, 0x43, 0x45, 0x10, 0x05, 0x32, 0xd0,
	0x10, 0x0a, 0x08, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0xb7, 0x01, 0x0a, 0x0c,
	...
	0x73, 0x2f, 0x41, 0x64, 0x64, 0x12, 0xcb, 0x01, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x48, 0x41, 0x50,
...
var (
	...
	file_inventorypb_services_proto_goTypes   = []interface{}{
		...
		(*AddProxySQLServiceRequest)(nil),      // 18: inventory.AddProxySQLServiceRequest
		...
		(*AddCustomLabelsRequest)(nil),         // 25: inventory.AddCustomLabelsRequest
		(*AddCustomLabelsResponse)(nil),        // 26: inventory.AddCustomLabelsResponse
		(*RemoveCustomLabelsRequest)(nil),      // 27: inventory.RemoveCustomLabelsRequest
		(*RemoveCustomLabelsResponse)(nil),     // 28: inventory.RemoveCustomLabelsResponse
		(*ChangeServiceRequest)(nil),           // 29: inventory.ChangeServiceRequest
		(*ChangeServiceResponse)(nil),          // 30: inventory.ChangeServiceResponse
		nil,                                    // 31: inventory.MySQLService.CustomLabelsEntry
		nil,                                    // 32: inventory.MongoDBService.CustomLabelsEntry
		nil,                                    // 33: inventory.PostgreSQLService.CustomLabelsEntry
		nil,                                    // 34: inventory.ProxySQLService.CustomLabelsEntry
		nil,                                    // 35: inventory.HAProxyService.CustomLabelsEntry
		nil,                                    // 36: inventory.ExternalService.CustomLabelsEntry
		nil,                                    // 37: inventory.AddMySQLServiceRequest.CustomLabelsEntry
		nil,                                    // 38: inventory.AddMongoDBServiceRequest.CustomLabelsEntry
		nil,                                    // 39: inventory.AddPostgreSQLServiceRequest.CustomLabelsEntry
		nil,                                    // 40: inventory.AddProxySQLServiceRequest.CustomLabelsEntry
		nil,                                    // 41: inventory.AddHAProxyServiceRequest.CustomLabelsEntry
		nil,                                    // 42: inventory.AddExternalServiceRequest.CustomLabelsEntry
		nil,                                    // 43: inventory.AddCustomLabelsRequest.CustomLabelsEntry
	}
)

var file_inventorypb_services_proto_depIdxs = []int32{
	31, // 0: inventory.MySQLService.custom_labels:type_name -> inventory.MySQLService.CustomLabelsEntry
	32, // 1: inventory.MongoDBService.custom_labels:type_name -> inventory.MongoDBService.CustomLabelsEntry
	33, // 2: inventory.PostgreSQLService.custom_labels:type_name -> inventory.PostgreSQLService.CustomLabelsEntry
	34, // 3: inventory.ProxySQLService.custom_labels:type_name -> inventory.ProxySQLService.CustomLabelsEntry
	35, // 4: inventory.HAProxyService.custom_labels:type_name -> inventory.HAProxyService.CustomLabelsEntry
	36, // 5: inventory.ExternalService.custom_labels:type_name -> inventory.ExternalService.CustomLabelsEntry
	...
	18, // 23: inventory.AddServiceRequest.proxysql:type_name -> inventory.AddProxySQLServiceRequest
	19, // 24: inventory.AddServiceRequest.haproxy:type_name -> inventory.AddHAProxyServiceRequest
	21, // 25: inventory.AddServiceRequest.external:type_name -> inventory.AddExternalServiceRequest
	...
	37, // 32: inventory.AddMySQLServiceRequest.custom_labels:type_name -> inventory.AddMySQLServiceRequest.CustomLabelsEntry
	38, // 33: inventory.AddMongoDBServiceRequest.custom_labels:type_name -> inventory.AddMongoDBServiceRequest.CustomLabelsEntry
	39, // 34: inventory.AddPostgreSQLServiceRequest.custom_labels:type_name -> inventory.AddPostgreSQLServiceRequest.CustomLabelsEntry
	40, // 35: inventory.AddProxySQLServiceRequest.custom_labels:type_name -> inventory.AddProxySQLServiceRequest.CustomLabelsEntry
	41, // 36: inventory.AddHAProxyServiceRequest.custom_labels:type_name -> inventory.AddHAProxyServiceRequest.CustomLabelsEntry
	5,  // 37: inventory.AddHAProxyServiceResponse.haproxy:type_name -> inventory.HAProxyService
	42, // 38: inventory.AddExternalServiceRequest.custom_labels:type_name -> inventory.AddExternalServiceRequest.CustomLabelsEntry
	6,  // 39: inventory.AddExternalServiceResponse.external:type_name -> inventory.ExternalService
	43, // 40: inventory.AddCustomLabelsRequest.custom_labels:type_name -> inventory.AddCustomLabelsRequest.CustomLabelsEntry
	7,  // 41: inventory.Services.ListServices:input_type -> inventory.ListServicesRequest
	9,  // 42: inventory.Services.ListActiveServiceTypes:input_type -> inventory.ListActiveServiceTypesRequest
	11, // 43: inventory.Services.GetService:input_type -> inventory.GetServiceRequest
	13, // 44: inventory.Services.AddService:input_type -> inventory.AddServiceRequest
	19, // 45: inventory.Services.AddHAProxyService:input_type -> inventory.AddHAProxyServiceRequest
	21, // 46: inventory.Services.AddExternalService:input_type -> inventory.AddExternalServiceRequest
	23, // 47: inventory.Services.RemoveService:input_type -> inventory.RemoveServiceRequest
	25, // 48: inventory.Services.AddCustomLabels:input_type -> inventory.AddCustomLabelsRequest
	27, // 49: inventory.Services.RemoveCustomLabels:input_type -> inventory.RemoveCustomLabelsRequest
	29, // 50: inventory.Services.ChangeService:input_type -> inventory.ChangeServiceRequest
	8,  // 51: inventory.Services.ListServices:output_type -> inventory.ListServicesResponse
	10, // 52: inventory.Services.ListActiveServiceTypes:output_type -> inventory.ListActiveServiceTypesResponse
	12, // 53: inventory.Services.GetService:output_type -> inventory.GetServiceResponse
	14, // 54: inventory.Services.AddService:output_type -> inventory.AddServiceResponse
	20, // 55: inventory.Services.AddHAProxyService:output_type -> inventory.AddHAProxyServiceResponse
	22, // 56: inventory.Services.AddExternalService:output_type -> inventory.AddExternalServiceResponse
	24, // 57: inventory.Services.RemoveService:output_type -> inventory.RemoveServiceResponse
	26, // 58: inventory.Services.AddCustomLabels:output_type -> inventory.AddCustomLabelsResponse
	28, // 59: inventory.Services.RemoveCustomLabels:output_type -> inventory.RemoveCustomLabelsResponse
	30, // 60: inventory.Services.ChangeService:output_type -> inventory.ChangeServiceResponse
...
func file_inventorypb_services_proto_init() {
	...
	file_inventorypb_services_proto_msgTypes[28].OneofWrappers = []interface{}{}
	type x struct{}
