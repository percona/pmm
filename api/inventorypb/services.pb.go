...
func (*CheckServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_79dc70e48abe0aa8, []int{21}
}
...
func (m *CheckServiceRequest) GetServiceName() string {
	if m != nil {
		return m.ServiceName
	}
	return ""
...
func (*CheckServiceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_79dc70e48abe0aa8, []int{22}
}
...
func init() {
	...
	proto.RegisterType((*CheckServiceRequest)(nil), "inventory.CheckServiceRequest")
	proto.RegisterType((*CheckServiceResponse)(nil), "inventory.CheckServiceResponse")
}
...
var fileDescriptor_79dc70e48abe0aa8 = []byte{
	...
	,
}
...
type ServicesClient interface {
	...
	// CheckService if service exists.
...
func (c *servicesClient) CheckService(ctx context.Context, in *CheckServiceRequest, opts ...grpc.CallOption) (*CheckServiceResponse, error) {
	out := new(CheckServiceResponse)
	err := c.cc.Invoke(ctx, "/inventory.Services/CheckService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedServicesServer) CheckService(ctx context.Context, req *CheckServiceRequest) (*CheckServiceResponse, error) {
...
func _Services_CheckService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServicesServer).CheckService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inventory.Services/CheckService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServicesServer).CheckService(ctx, req.(*CheckServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Services_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Services_CheckService_Handler,
		},
	},
