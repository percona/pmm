...
// IsSuccess returns true when this add mongo Db service Ok response has a 2xx status code
func (o *AddMongoDBServiceOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this add mongo Db service Ok response has a 3xx status code
func (o *AddMongoDBServiceOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this add mongo Db service Ok response has a 4xx status code
func (o *AddMongoDBServiceOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this add mongo Db service Ok response has a 5xx status code
func (o *AddMongoDBServiceOK) IsServerError() bool {
	return false
}

// IsCode returns true when this add mongo Db service Ok response a status code equal to that given
func (o *AddMongoDBServiceOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *AddMongoDBServiceOK) String() string {
	return fmt.Sprintf("[POST /v1/inventory/Services/AddMongoDB][%d] addMongoDbServiceOk  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this add mongo DB service default response has a 2xx status code
func (o *AddMongoDBServiceDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this add mongo DB service default response has a 3xx status code
func (o *AddMongoDBServiceDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this add mongo DB service default response has a 4xx status code
func (o *AddMongoDBServiceDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this add mongo DB service default response has a 5xx status code
func (o *AddMongoDBServiceDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this add mongo DB service default response a status code equal to that given
func (o *AddMongoDBServiceDefault) IsCode(code int) bool {
...
func (o *AddMongoDBServiceDefault) String() string {
	return fmt.Sprintf("[POST /v1/inventory/Services/AddMongoDB][%d] AddMongoDBService default  %+v", o._statusCode, o.Payload)
}
