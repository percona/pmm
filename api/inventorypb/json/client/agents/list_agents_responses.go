...
type ListAgentsBody struct {
	...
	// Enum: [AGENT_TYPE_INVALID PMM_AGENT NODE_EXPORTER MYSQLD_EXPORTER MONGODB_EXPORTER POSTGRES_EXPORTER PROXYSQL_EXPORTER QAN_MYSQL_PERFSCHEMA_AGENT QAN_MYSQL_SLOWLOG_AGENT QAN_MONGODB_PROFILER_AGENT QAN_POSTGRESQL_PGSTATEMENTS_AGENT QAN_POSTGRESQL_PGSTATMONITOR_AGET RDS_EXPORTER EXTERNAL_EXPORTER]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["AGENT_TYPE_INVALID","PMM_AGENT","NODE_EXPORTER","MYSQLD_EXPORTER","MONGODB_EXPORTER","POSTGRES_EXPORTER","PROXYSQL_EXPORTER","QAN_MYSQL_PERFSCHEMA_AGENT","QAN_MYSQL_SLOWLOG_AGENT","QAN_MONGODB_PROFILER_AGENT","QAN_POSTGRESQL_PGSTATEMENTS_AGENT","QAN_POSTGRESQL_PGSTATMONITOR_AGET","RDS_EXPORTER","EXTERNAL_EXPORTER"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// ListAgentsBodyAgentTypeQANPOSTGRESQLPGSTATMONITORAGET captures enum value "QAN_POSTGRESQL_PGSTATMONITOR_AGET"
	ListAgentsBodyAgentTypeQANPOSTGRESQLPGSTATMONITORAGET string = "QAN_POSTGRESQL_PGSTATMONITOR_AGET"
