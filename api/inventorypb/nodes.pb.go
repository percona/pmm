...
type AddNodeRequest_Generic struct {
	Generic *AddGenericNodeRequest `protobuf:"bytes,2,opt,name=generic,proto3,oneof"`
}

type AddNodeRequest_Container struct {
	Container *AddContainerNodeRequest `protobuf:"bytes,3,opt,name=container,proto3,oneof"`
}

type AddNodeRequest_Remote struct {
	Remote *AddRemoteNodeRequest `protobuf:"bytes,4,opt,name=remote,proto3,oneof"`
}

type AddNodeRequest_RemoteRds struct {
	RemoteRds *AddRemoteRDSNodeRequest `protobuf:"bytes,5,opt,name=remote_rds,json=remoteRds,proto3,oneof"`
}

type AddNodeRequest_RemoteAzure struct {
	RemoteAzure *AddRemoteAzureDatabaseNodeRequest `protobuf:"bytes,6,opt,name=remote_azure,json=remoteAzure,proto3,oneof"`
}
...
var file_inventorypb_nodes_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x69, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x69, 0x6e, 0x76,
	...
	0x69, 0x6e, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x69, 0x6e, 0x76,
	...
	0x65, 0x6d, 0x6f, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x69, 0x6e,
	...
	0x5f, 0x72, 0x64, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x69, 0x6e, 0x76,
	...
	0x65, 0x6d, 0x6f, 0x74, 0x65, 0x5f, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
