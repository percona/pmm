...
var file_inventorypb_nodes_proto_rawDesc = string([]byte{
...
var (
	...
	file_inventorypb_nodes_proto_rawDescData []byte
)

func file_inventorypb_nodes_proto_rawDescGZIP() []byte {
	file_inventorypb_nodes_proto_rawDescOnce.Do(func() {
		file_inventorypb_nodes_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_inventorypb_nodes_proto_rawDesc), len(file_inventorypb_nodes_proto_rawDesc)))
	})
...
func file_inventorypb_nodes_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_inventorypb_nodes_proto_rawDesc), len(file_inventorypb_nodes_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   33,
			NumExtensions: 0,
			NumServices:   1,
