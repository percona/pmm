...
func (o *ListServicesOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/realtimeanalytics/services][%d] listServicesOk %s", 200, payload)
}
...
func (o *ListServicesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/realtimeanalytics/services][%d] ListServices default %s", o._statusCode, payload)
}
