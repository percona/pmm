...
// WithBody adds the body to the list files params
func (o *ListFilesParams) WithBody(body interface{}) *ListFilesParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list files params
func (o *ListFilesParams) SetBody(body interface{}) {
	o.Body = body
}
