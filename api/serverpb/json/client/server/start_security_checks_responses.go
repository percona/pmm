...
func (o *StartSecurityChecksOK) Error() string {
	return fmt.Sprintf("[POST /v1/SecurityChecks/Start][%d] startSecurityChecksOk  %+v", 200, o.Payload)
}
...
func (o *StartSecurityChecksDefault) Error() string {
	return fmt.Sprintf("[POST /v1/SecurityChecks/Start][%d] StartSecurityChecks default  %+v", o._statusCode, o.Payload)
}
