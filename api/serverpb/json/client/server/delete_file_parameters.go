...
// WithBody adds the body to the delete file params
func (o *DeleteFileParams) WithBody(body DeleteFileBody) *DeleteFileParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete file params
func (o *DeleteFileParams) SetBody(body DeleteFileBody) {
	o.Body = body
}
