...
type Settings struct {
	...
	AlertManagerAddress  string              `protobuf:"bytes,7,opt,name=alert_manager_address,json=alertManagerAddress,proto3" json:"alert_manager_address,omitempty"`
...
func (m *Settings) GetAlertManagerAddress() string {
	if m != nil {
		return m.AlertManagerAddress
	}
	return ""
}
...
type ChangeSettingsRequest struct {
	...
	AwsPartitions            []string           `protobuf:"bytes,6,rep,name=aws_partitions,json=awsPartitions,proto3" json:"aws_partitions,omitempty"`
	AlertManagerAddress      string             `protobuf:"bytes,7,opt,name=alert_manager_address,json=alertManagerAddress,proto3" json:"alert_manager_address,omitempty"`
	ClearAlertManagerAddress bool               `protobuf:"varint,8,opt,name=clear_alert_manager_address,json=clearAlertManagerAddress,proto3" json:"clear_alert_manager_address,omitempty"`
	...
	ClearAlerManagerRules    bool               `protobuf:"varint,10,opt,name=clear_aler_manager_rules,json=clearAlerManagerRules,proto3" json:"clear_aler_manager_rules,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}           `json:"-"`
	XXX_unrecognized         []byte             `json:"-"`
	XXX_sizecache            int32              `json:"-"`
}
...
func (m *ChangeSettingsRequest) GetAlertManagerAddress() string {
	if m != nil {
		return m.AlertManagerAddress
	}
	return ""
...
func (m *ChangeSettingsRequest) GetClearAlertManagerAddress() bool {
	if m != nil {
		return m.ClearAlertManagerAddress
	}
	return false
}
...
func (m *ChangeSettingsRequest) GetClearAlerManagerRules() bool {
	if m != nil {
		return m.ClearAlerManagerRules
	}
	return false
}
...
var fileDescriptor_9202d8f598083902 = []byte{
	...
	,
}
