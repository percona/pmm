...
type AWSPartitions int32

const (
	AWSPartitions_AWS_PARTITIONS_INVALID AWSPartitions = 0
	// "aws" AWS Standard partition.
	AWSPartitions_AWS AWSPartitions = 1
	// "aws-cn" AWS China partition.
	AWSPartitions_AWS_CN AWSPartitions = 2
	// "aws-us-gov" AWS GovCloud (US) partition.
	AWSPartitions_AWS_US_GOV AWSPartitions = 3
	// "aws-iso" AWS ISO (US) partition.
	AWSPartitions_AWS_ISO AWSPartitions = 4
	// "aws-iso-b" AWS ISOB (US) partition.
	AWSPartitions_AWS_ISO_B AWSPartitions = 5
)

var AWSPartitions_name = map[int32]string{
	0: "AWS_PARTITIONS_INVALID",
	1: "AWS",
	2: "AWS_CN",
	3: "AWS_US_GOV",
	4: "AWS_ISO",
...
var AWSPartitions_value = map[string]int32{
	"AWS_PARTITIONS_INVALID": 0,
	"AWS":                    1,
	"AWS_CN":                 2,
	"AWS_US_GOV":             3,
	"AWS_ISO":                4,
...
func (x AWSPartitions) String() string {
	return proto.EnumName(AWSPartitions_name, int32(x))
}

func (AWSPartitions) EnumDescriptor() ([]byte, []int) {
...
type Settings struct {
	...
	AwsPartitions        AWSPartitions       `protobuf:"varint,6,opt,name=aws_partitions,json=awsPartitions,proto3,enum=server.AWSPartitions" json:"aws_partitions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *Settings) GetAwsPartitions() AWSPartitions {
	if m != nil {
		return m.AwsPartitions
	}
	return AWSPartitions_AWS_PARTITIONS_INVALID
}
...
func init() {
	proto.RegisterEnum("server.AWSPartitions", AWSPartitions_name, AWSPartitions_value)
...
var fileDescriptor_9202d8f598083902 = []byte{
	...
	,
}
