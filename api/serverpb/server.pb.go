...
type VersionResponse struct {
	...
	// true if latest version is newer and updates are not disabled.
...
type CheckUpdatesResponse struct {
	...
	// Latest PMM version.
	LatestVersion            string               `protobuf:"bytes,2,opt,name=latest_version,json=latestVersion,proto3" json:"latest_version,omitempty"`
	LatestVersionReleaseDate *timestamp.Timestamp `protobuf:"bytes,3,opt,name=latest_version_release_date,json=latestVersionReleaseDate,proto3" json:"latest_version_release_date,omitempty"`
	XXX_NoUnkeyedLiteral     struct{}             `json:"-"`
	XXX_unrecognized         []byte               `json:"-"`
	XXX_sizecache            int32                `json:"-"`
}
...
func (m *CheckUpdatesResponse) GetLatestVersionReleaseDate() *timestamp.Timestamp {
	if m != nil {
		return m.LatestVersionReleaseDate
	}
	return nil
}
...
var fileDescriptor_9202d8f598083902 = []byte{
	...
	,
}
