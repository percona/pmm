...
var file_serverpb_server_proto_rawDesc = string([]byte{
...
var (
	...
	file_serverpb_server_proto_rawDescData []byte
)

func file_serverpb_server_proto_rawDescGZIP() []byte {
	file_serverpb_server_proto_rawDescOnce.Do(func() {
		file_serverpb_server_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_serverpb_server_proto_rawDesc), len(file_serverpb_server_proto_rawDesc)))
	})
...
func file_serverpb_server_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_serverpb_server_proto_rawDesc), len(file_serverpb_server_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   26,
			NumExtensions: 0,
			NumServices:   1,
