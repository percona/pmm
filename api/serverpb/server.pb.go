...
var file_serverpb_server_proto_rawDesc = []byte{
	...
	0x32, 0xf2, 0x0a, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x79, 0x0a, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x2e,
...
var file_serverpb_server_proto_depIdxs = []int32{
	...
	2,  // 21: server.ServerService.Version:input_type -> server.VersionRequest
	4,  // 22: server.ServerService.Readiness:input_type -> server.ReadinessRequest
	6,  // 23: server.ServerService.CheckUpdates:input_type -> server.CheckUpdatesRequest
	8,  // 24: server.ServerService.StartUpdate:input_type -> server.StartUpdateRequest
	10, // 25: server.ServerService.UpdateStatus:input_type -> server.UpdateStatusRequest
	15, // 26: server.ServerService.GetSettings:input_type -> server.GetSettingsRequest
	17, // 27: server.ServerService.ChangeSettings:input_type -> server.ChangeSettingsRequest
	19, // 28: server.ServerService.AWSInstanceCheck:input_type -> server.AWSInstanceCheckRequest
	3,  // 29: server.ServerService.Version:output_type -> server.VersionResponse
	5,  // 30: server.ServerService.Readiness:output_type -> server.ReadinessResponse
	7,  // 31: server.ServerService.CheckUpdates:output_type -> server.CheckUpdatesResponse
	9,  // 32: server.ServerService.StartUpdate:output_type -> server.StartUpdateResponse
	11, // 33: server.ServerService.UpdateStatus:output_type -> server.UpdateStatusResponse
	16, // 34: server.ServerService.GetSettings:output_type -> server.GetSettingsResponse
	18, // 35: server.ServerService.ChangeSettings:output_type -> server.ChangeSettingsResponse
	20, // 36: server.ServerService.AWSInstanceCheck:output_type -> server.AWSInstanceCheckResponse
