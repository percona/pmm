...
type SideContainerUpdateStatusSource int32

const (
	SideContainerUpdateStatusSource_GENERIC     SideContainerUpdateStatusSource = 0
	SideContainerUpdateStatusSource_PMM_UPDATER SideContainerUpdateStatusSource = 1
)

// Enum value maps for SideContainerUpdateStatusSource.
var (
	SideContainerUpdateStatusSource_name = map[int32]string{
		0: "GENERIC",
		1: "PMM_UPDATER",
	}
	SideContainerUpdateStatusSource_value = map[string]int32{
		"GENERIC":     0,
		"PMM_UPDATER": 1,
	}
)

func (x SideContainerUpdateStatusSource) Enum() *SideContainerUpdateStatusSource {
	p := new(SideContainerUpdateStatusSource)
	*p = x
	return p
}

func (x SideContainerUpdateStatusSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SideContainerUpdateStatusSource) Descriptor() protoreflect.EnumDescriptor {
	return file_serverpb_server_proto_enumTypes[1].Descriptor()
}

func (SideContainerUpdateStatusSource) Type() protoreflect.EnumType {
	return &file_serverpb_server_proto_enumTypes[1]
}

func (x SideContainerUpdateStatusSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SideContainerUpdateStatusSource.Descriptor instead.
func (SideContainerUpdateStatusSource) EnumDescriptor() ([]byte, []int) {
...
type SideContainerUpdateStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Source application checking for status.
	Source SideContainerUpdateStatusSource `protobuf:"varint,1,opt,name=source,proto3,enum=server.SideContainerUpdateStatusSource" json:"source,omitempty"`
}

func (x *SideContainerUpdateStatusRequest) Reset() {
	*x = SideContainerUpdateStatusRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SideContainerUpdateStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SideContainerUpdateStatusRequest) ProtoMessage() {}

func (x *SideContainerUpdateStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_serverpb_server_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SideContainerUpdateStatusRequest.ProtoReflect.Descriptor instead.
func (*SideContainerUpdateStatusRequest) Descriptor() ([]byte, []int) {
	return file_serverpb_server_proto_rawDescGZIP(), []int{11}
}

func (x *SideContainerUpdateStatusRequest) GetSource() SideContainerUpdateStatusSource {
	if x != nil {
		return x.Source
	}
	return SideContainerUpdateStatusSource_GENERIC
}

type SideContainerUpdateStatusResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// True when this update method is available.
	IsAvailable bool `protobuf:"varint,1,opt,name=is_available,json=isAvailable,proto3" json:"is_available,omitempty"`
	// True when update is requested.
	IsRequested bool `protobuf:"varint,2,opt,name=is_requested,json=isRequested,proto3" json:"is_requested,omitempty"`
}

func (x *SideContainerUpdateStatusResponse) Reset() {
	*x = SideContainerUpdateStatusResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SideContainerUpdateStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SideContainerUpdateStatusResponse) ProtoMessage() {}

func (x *SideContainerUpdateStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_serverpb_server_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SideContainerUpdateStatusResponse.ProtoReflect.Descriptor instead.
func (*SideContainerUpdateStatusResponse) Descriptor() ([]byte, []int) {
	return file_serverpb_server_proto_rawDescGZIP(), []int{12}
}

func (x *SideContainerUpdateStatusResponse) GetIsAvailable() bool {
	if x != nil {
...
func (x *SideContainerUpdateStatusResponse) GetIsRequested() bool {
	if x != nil {
...
type SideContainerUpdateRequestRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *SideContainerUpdateRequestRequest) Reset() {
	*x = SideContainerUpdateRequestRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SideContainerUpdateRequestRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SideContainerUpdateRequestRequest) ProtoMessage() {}

func (x *SideContainerUpdateRequestRequest) ProtoReflect() protoreflect.Message {
	mi := &file_serverpb_server_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SideContainerUpdateRequestRequest.ProtoReflect.Descriptor instead.
func (*SideContainerUpdateRequestRequest) Descriptor() ([]byte, []int) {
	return file_serverpb_server_proto_rawDescGZIP(), []int{13}
}

type SideContainerUpdateRequestResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *SideContainerUpdateRequestResponse) Reset() {
	*x = SideContainerUpdateRequestResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SideContainerUpdateRequestResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SideContainerUpdateRequestResponse) ProtoMessage() {}

func (x *SideContainerUpdateRequestResponse) ProtoReflect() protoreflect.Message {
	mi := &file_serverpb_server_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SideContainerUpdateRequestResponse.ProtoReflect.Descriptor instead.
func (*SideContainerUpdateRequestResponse) Descriptor() ([]byte, []int) {
...
var file_serverpb_server_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x67, 0x73, 0x22, 0x86, 0x0c, 0x0a, 0x15, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x53, 0x65, 0x74,
	...
	0x65, 0x6e, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x64, 0x62,
	0x61, 0x61, 0x73, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x44, 0x62, 0x61, 0x61, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c,
	0x65, 0x5f, 0x64, 0x62, 0x61, 0x61, 0x73, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x64,
	0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x44, 0x62, 0x61, 0x61, 0x73, 0x22, 0x46, 0x0a, 0x16, 0x43,
	...
	0x6e, 0x67, 0x73, 0x22, 0x94, 0x01, 0x0a, 0x20, 0x54, 0x65, 0x73, 0x74, 0x45, 0x6d, 0x61, 0x69,
	0x6c, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x55, 0x0a, 0x17, 0x65, 0x6d, 0x61, 0x69,
	0x6c, 0x5f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x73, 0x65, 0x74, 0x74, 0x69,
	0x6e, 0x67, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x19, 0x0a, 0x08, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x74, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x54, 0x6f, 0x22, 0x23, 0x0a, 0x21, 0x54, 0x65,
	...
	0x42, 0x0a, 0x17, 0x41, 0x57, 0x53, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x0b, 0x69, 0x6e,
	...
	0x06, 0x0a, 0x02, 0x44, 0x4f, 0x10, 0x05, 0x2a, 0x3f, 0x0a, 0x1f, 0x53, 0x69, 0x64, 0x65, 0x43,
	0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x47, 0x45,
	0x4e, 0x45, 0x52, 0x49, 0x43, 0x10, 0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x50, 0x4d, 0x4d, 0x5f, 0x55,
	0x50, 0x44, 0x41, 0x54, 0x45, 0x52, 0x10, 0x01, 0x32, 0xf0, 0x10, 0x0a, 0x06, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x12, 0x79, 0x0a, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x16,
	...
	0x3d, 0x92, 0x41, 0x27, 0x12, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x1c, 0x52,
	0x65, 0x74, 0x75, 0x72, 0x6e, 0x73, 0x20, 0x50, 0x4d, 0x4d, 0x20, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x20, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x0d, 0x12, 0x0b, 0x2f, 0x76, 0x31, 0x2f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x9e,
	0x02, 0x0a, 0x09, 0x52, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x12, 0x18, 0x2e, 0x73,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x22, 0x52, 0x92, 0x41, 0x34, 0x12, 0x0c, 0x47, 0x65, 0x74, 0x20, 0x73, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x1a, 0x24, 0x52, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x73, 0x20, 0x63,
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x20, 0x50, 0x4d, 0x4d, 0x20, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x20, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x15, 0x3a, 0x01, 0x2a, 0x22, 0x10, 0x2f, 0x76, 0x31, 0x2f, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e,
	0x67, 0x73, 0x2f, 0x47, 0x65, 0x74, 0x12, 0xa1, 0x01, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x1d, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	,
...
var (
	...
	file_serverpb_server_proto_msgTypes  = make([]protoimpl.MessageInfo, 28)
	file_serverpb_server_proto_goTypes   = []interface{}{
		(DistributionMethod)(0),                    // 0: server.DistributionMethod
		(SideContainerUpdateStatusSource)(0),       // 1: server.SideContainerUpdateStatusSource
		...
		(*SideContainerUpdateStatusRequest)(nil),   // 13: server.SideContainerUpdateStatusRequest
		(*SideContainerUpdateStatusResponse)(nil),  // 14: server.SideContainerUpdateStatusResponse
		(*SideContainerUpdateRequestRequest)(nil),  // 15: server.SideContainerUpdateRequestRequest
		(*SideContainerUpdateRequestResponse)(nil), // 16: server.SideContainerUpdateRequestResponse
		(*MetricsResolutions)(nil),                 // 17: server.MetricsResolutions
		(*EmailAlertingSettings)(nil),              // 18: server.EmailAlertingSettings
		(*SlackAlertingSettings)(nil),              // 19: server.SlackAlertingSettings
		(*STTCheckIntervals)(nil),                  // 20: server.STTCheckIntervals
		(*Settings)(nil),                           // 21: server.Settings
		(*GetSettingsRequest)(nil),                 // 22: server.GetSettingsRequest
		(*GetSettingsResponse)(nil),                // 23: server.GetSettingsResponse
		(*ChangeSettingsRequest)(nil),              // 24: server.ChangeSettingsRequest
		(*ChangeSettingsResponse)(nil),             // 25: server.ChangeSettingsResponse
		(*TestEmailAlertingSettingsRequest)(nil),   // 26: server.TestEmailAlertingSettingsRequest
		(*TestEmailAlertingSettingsResponse)(nil),  // 27: server.TestEmailAlertingSettingsResponse
		(*AWSInstanceCheckRequest)(nil),            // 28: server.AWSInstanceCheckRequest
		(*AWSInstanceCheckResponse)(nil),           // 29: server.AWSInstanceCheckResponse
...
var file_serverpb_server_proto_depIdxs = []int32{
	30, // 0: server.VersionInfo.timestamp:type_name -> google.protobuf.Timestamp
	...
	30, // 6: server.CheckUpdatesResponse.last_check:type_name -> google.protobuf.Timestamp
	1,  // 7: server.SideContainerUpdateStatusRequest.source:type_name -> server.SideContainerUpdateStatusSource
	31, // 8: server.MetricsResolutions.hr:type_name -> google.protobuf.Duration
	31, // 9: server.MetricsResolutions.mr:type_name -> google.protobuf.Duration
	31, // 10: server.MetricsResolutions.lr:type_name -> google.protobuf.Duration
	31, // 11: server.STTCheckIntervals.standard_interval:type_name -> google.protobuf.Duration
	31, // 12: server.STTCheckIntervals.rare_interval:type_name -> google.protobuf.Duration
	31, // 13: server.STTCheckIntervals.frequent_interval:type_name -> google.protobuf.Duration
	17, // 14: server.Settings.metrics_resolutions:type_name -> server.MetricsResolutions
	31, // 15: server.Settings.data_retention:type_name -> google.protobuf.Duration
	18, // 16: server.Settings.email_alerting_settings:type_name -> server.EmailAlertingSettings
	19, // 17: server.Settings.slack_alerting_settings:type_name -> server.SlackAlertingSettings
	20, // 18: server.Settings.stt_check_intervals:type_name -> server.STTCheckIntervals
	21, // 19: server.GetSettingsResponse.settings:type_name -> server.Settings
	17, // 20: server.ChangeSettingsRequest.metrics_resolutions:type_name -> server.MetricsResolutions
	31, // 21: server.ChangeSettingsRequest.data_retention:type_name -> google.protobuf.Duration
	18, // 22: server.ChangeSettingsRequest.email_alerting_settings:type_name -> server.EmailAlertingSettings
	19, // 23: server.ChangeSettingsRequest.slack_alerting_settings:type_name -> server.SlackAlertingSettings
	20, // 24: server.ChangeSettingsRequest.stt_check_intervals:type_name -> server.STTCheckIntervals
	21, // 25: server.ChangeSettingsResponse.settings:type_name -> server.Settings
	18, // 26: server.TestEmailAlertingSettingsRequest.email_alerting_settings:type_name -> server.EmailAlertingSettings
	3,  // 27: server.Server.Version:input_type -> server.VersionRequest
	5,  // 28: server.Server.Readiness:input_type -> server.ReadinessRequest
	7,  // 29: server.Server.CheckUpdates:input_type -> server.CheckUpdatesRequest
	9,  // 30: server.Server.StartUpdate:input_type -> server.StartUpdateRequest
	11, // 31: server.Server.UpdateStatus:input_type -> server.UpdateStatusRequest
	15, // 32: server.Server.SideContainerUpdateRequest:input_type -> server.SideContainerUpdateRequestRequest
	13, // 33: server.Server.SideContainerUpdateStatus:input_type -> server.SideContainerUpdateStatusRequest
	22, // 34: server.Server.GetSettings:input_type -> server.GetSettingsRequest
	24, // 35: server.Server.ChangeSettings:input_type -> server.ChangeSettingsRequest
	26, // 36: server.Server.TestEmailAlertingSettings:input_type -> server.TestEmailAlertingSettingsRequest
	28, // 37: server.Server.AWSInstanceCheck:input_type -> server.AWSInstanceCheckRequest
	4,  // 38: server.Server.Version:output_type -> server.VersionResponse
	6,  // 39: server.Server.Readiness:output_type -> server.ReadinessResponse
	8,  // 40: server.Server.CheckUpdates:output_type -> server.CheckUpdatesResponse
	10, // 41: server.Server.StartUpdate:output_type -> server.StartUpdateResponse
	12, // 42: server.Server.UpdateStatus:output_type -> server.UpdateStatusResponse
	16, // 43: server.Server.SideContainerUpdateRequest:output_type -> server.SideContainerUpdateRequestResponse
	14, // 44: server.Server.SideContainerUpdateStatus:output_type -> server.SideContainerUpdateStatusResponse
	23, // 45: server.Server.GetSettings:output_type -> server.GetSettingsResponse
	25, // 46: server.Server.ChangeSettings:output_type -> server.ChangeSettingsResponse
	27, // 47: server.Server.TestEmailAlertingSettings:output_type -> server.TestEmailAlertingSettingsResponse
	29, // 48: server.Server.AWSInstanceCheck:output_type -> server.AWSInstanceCheckResponse
...
func file_serverpb_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_serverpb_server_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SideContainerUpdateStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_serverpb_server_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SideContainerUpdateStatusResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_serverpb_server_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SideContainerUpdateRequestRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_serverpb_server_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SideContainerUpdateRequestResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
