...
import (
	...
	"github.com/percona/pmm/api/onboardingpb/json/client/tip_service"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *PMMPlatformAPI {
	...
	cli.TipService = tip_service.New(transport, formats)
	return cli
}
...
type PMMPlatformAPI struct {
	TipService tip_service.ClientService
...
func (c *PMMPlatformAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.TipService.SetTransport(transport)
}
