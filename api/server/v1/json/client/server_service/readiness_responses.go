...
func (o *ReadinessOK) Error() string {
	return fmt.Sprintf("[GET /api/server/v1/readyz][%d] readinessOk  %+v", 200, o.Payload)
}
...
func (o *ReadinessDefault) Error() string {
	return fmt.Sprintf("[GET /api/server/v1/readyz][%d] Readiness default  %+v", o._statusCode, o.Payload)
}
