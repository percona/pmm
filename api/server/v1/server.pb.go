...
type Settings struct {
	...
	// True if PMM Extensions is enabled. Read-only: it reports how this PMM
	// Server process was started, and cannot be changed through ChangeSettings.
	ExtensionsEnabled bool `protobuf:"varint,21,opt,name=extensions_enabled,json=extensionsEnabled,proto3" json:"extensions_enabled,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Settings) GetExtensionsEnabled() bool {
	if x != nil {
...
type ReadOnlySettings struct {
	...
	ExtensionsEnabled bool `protobuf:"varint,9,opt,name=extensions_enabled,json=extensionsEnabled,proto3" json:"extensions_enabled,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ReadOnlySettings) GetExtensionsEnabled() bool {
	if x != nil {
		return x.ExtensionsEnabled
	}
	return false
...
const file_server_v1_server_proto_rawDesc = "" +
	...
	"\x11frequent_interval\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x10frequentInterval\"\xeb\a\n" +
	"\bSettings\x12'\n" +
	...
	"\x12extensions_enabled\x18\x15 \x01(\bR\x11extensionsEnabledJ\x04\b\x14\x10\x15R\x16update_snooze_duration\"\xbe\x03\n" +
	...
	"\x12extensions_enabled\x18\t \x01(\bR\x11extensionsEnabled\"\x14\n" +
