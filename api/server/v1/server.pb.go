...
type Settings struct {
	...
	EnableMcp     bool `protobuf:"varint,21,opt,name=enable_mcp,json=enableMcp,proto3" json:"enable_mcp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Settings) GetEnableMcp() bool {
	if x != nil {
		return x.EnableMcp
	}
	return false
...
type ReadOnlySettings struct {
	...
	// True if the Model Context Protocol endpoint (/mcp) is enabled.
	EnableMcp     bool `protobuf:"varint,9,opt,name=enable_mcp,json=enableMcp,proto3" json:"enable_mcp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReadOnlySettings) GetEnableMcp() bool {
	if x != nil {
		return x.EnableMcp
	}
	return false
...
type ChangeSettingsRequest struct {
	...
	// Enable the Model Context Protocol endpoint (/mcp).
	EnableMcp     *bool `protobuf:"varint,16,opt,name=enable_mcp,json=enableMcp,proto3,oneof" json:"enable_mcp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChangeSettingsRequest) GetEnableMcp() bool {
	if x != nil && x.EnableMcp != nil {
		return *x.EnableMcp
	}
	return false
}
...
const file_server_v1_server_proto_rawDesc = "" +
	...
	"\n" +
	"enable_mcp\x18\x15 \x01(\bR\tenableMcpJ\x04\b\x14\x10\x15R\x16update_snooze_duration\"\xae\x03\n" +
	...
	"\n" +
	"enable_mcp\x18\t \x01(\bR\tenableMcp\"\x14\n" +
	...
	"\n" +
	"enable_mcp\x18\x10 \x01(\bH\vR\tenableMcp\x88\x01\x01B\x11\n" +
	...
	"\x17_enable_internal_pg_qanB\r\n" +
	"\v_enable_mcpJ\x04\b\x0f\x10\x10R\x16update_snooze_duration\"I\n" +
