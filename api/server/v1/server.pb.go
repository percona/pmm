...
func file_server_v1_server_proto_rawDescGZIP() []byte {
	file_server_v1_server_proto_rawDescOnce.Do(func() {
		file_server_v1_server_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_server_v1_server_proto_rawDescData)))
	})
	return []byte(file_server_v1_server_proto_rawDescData)
}
