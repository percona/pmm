...
type Settings struct {
	...
	EnableMcp     bool `protobuf:"varint,22,opt,name=enable_mcp,json=enableMcp,proto3" json:"enable_mcp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ReadOnlySettings struct {
	...
	// True if the Model Context Protocol endpoint (/mcp) is enabled.
	EnableMcp     bool `protobuf:"varint,10,opt,name=enable_mcp,json=enableMcp,proto3" json:"enable_mcp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_server_v1_server_proto_rawDesc = "" +
	...
	"sepEnabled\x12\x1d\n" +
	"\n" +
	"enable_mcp\x18\x16 \x01(\bR\tenableMcpJ\x04\b\x14\x10\x15R\x16update_snooze_duration\"\xcf\x03\n" +
