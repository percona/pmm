...
func (this *ParseServiceParamsSourceRequest) Validate() error {
	return nil
}
func (this *ParseServiceParamsSourceResponse) Validate() error {
	return nil
}
...
func (this *AgentMessage) Validate() error {
	...
	if oneOfNester, ok := this.GetPayload().(*AgentMessage_ParseServiceParamsSource); ok {
		if oneOfNester.ParseServiceParamsSource != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.ParseServiceParamsSource); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("ParseServiceParamsSource", err)
			}
		}
	}
...
func (this *ServerMessage) Validate() error {
	...
	if oneOfNester, ok := this.GetPayload().(*ServerMessage_ParseServiceParamsSource); ok {
		if oneOfNester.ParseServiceParamsSource != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.ParseServiceParamsSource); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("ParseServiceParamsSource", err)
			}
