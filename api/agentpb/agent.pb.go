...
type QANCollectRequest struct {
	Request              *CollectRequest `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *QANCollectRequest) GetRequest() *CollectRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
var fileDescriptor_0e8f797f46bba6fc = []byte{
	...
	,
}
