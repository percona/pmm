...
func file_agentpb_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agentpb_agent_proto_msgTypes[40].Exporter = func(v any, i int) any {
		...
		file_agentpb_agent_proto_msgTypes[45].Exporter = func(v any, i int) any {
		...
		file_agentpb_agent_proto_msgTypes[89].Exporter = func(v any, i int) any {
		...
		file_agentpb_agent_proto_msgTypes[90].Exporter = func(v any, i int) any {
