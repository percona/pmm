...
// StartActionRequest represents request to run an action by name.
...
// StartActionResponse represents message with an response to starting an action.
...
func (m *StartActionResponse) GetActionId() string {
	if m != nil {
		return m.ActionId
	}
	return ""
...
// StopActionRequest represents request to stop action with given id.
...
// StopActionResponse represents response to stop action request. It sends to server when an action was stopped.
...
func (m *StopActionResponse) GetActionId() string {
	if m != nil {
		return m.ActionId
	}
	return ""
...
// ActionResultRequest represents message with action results which agent send to server when action was finished.
type ActionResultRequest struct {
	ActionId             string   `protobuf:"bytes,1,opt,name=action_id,json=actionId,proto3" json:"action_id,omitempty"`
	LastPart             bool     `protobuf:"varint,2,opt,name=last_part,json=lastPart,proto3" json:"last_part,omitempty"`
...
func (m *ActionResultRequest) GetLastPart() bool {
	if m != nil {
		return m.LastPart
	}
	return false
...
func (m *ActionResultRequest) GetErrCode() int32 {
	if m != nil {
		return m.ErrCode
	}
	return 0
...
func (m *ActionResultRequest) GetErrMessage() string {
	if m != nil {
		return m.ErrMessage
	}
	return ""
...
// ActionResultResponse represents response to action results which server sends to agent.
...
var fileDescriptor_0e8f797f46bba6fc = []byte{
	...
	,
}
