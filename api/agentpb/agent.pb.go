...
const (
	ActionName_ACTION_NAME_INVALID ActionName = 0
	ActionName_PT_SUMMARY          ActionName = 1
	ActionName_PT_MYSQL_SUMMARY    ActionName = 2
	ActionName_MYSQL_EXPLAIN       ActionName = 3
)

var ActionName_name = map[int32]string{
	0: "ACTION_NAME_INVALID",
	1: "PT_SUMMARY",
	2: "PT_MYSQL_SUMMARY",
	3: "MYSQL_EXPLAIN",
}

var ActionName_value = map[string]int32{
	"ACTION_NAME_INVALID": 0,
	"PT_SUMMARY":          1,
	"PT_MYSQL_SUMMARY":    2,
	"MYSQL_EXPLAIN":       3,
}
...
func (x ActionName) String() string {
	return proto.EnumName(ActionName_name, int32(x))
}
...
type StartActionRequest struct {
	...
	Name                 ActionName `protobuf:"varint,2,opt,name=name,proto3,enum=agent.ActionName" json:"name,omitempty"`
...
func (m *StartActionRequest) GetName() ActionName {
	if m != nil {
		return m.Name
	}
	return ActionName_ACTION_NAME_INVALID
}

func (m *StartActionRequest) GetParameters() []string {
	if m != nil {
		return m.Parameters
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("agent.ActionName", ActionName_name, ActionName_value)
...
var fileDescriptor_0e8f797f46bba6fc = []byte{
	...
	,
}
