...
type StartActionRequest_MySQLExplainParams struct {
	...
	OutputFormat         MysqlExplainOutputFormat `protobuf:"varint,4,opt,name=output_format,json=outputFormat,proto3,enum=agent.MysqlExplainOutputFormat" json:"output_format,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *StartActionRequest_MySQLExplainParams) GetDb() string {
	if m != nil {
		return m.Db
	}
	return ""
...
func (m *CheckConnectionResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
var fileDescriptor_0e8f797f46bba6fc = []byte{
	...
	,
}
