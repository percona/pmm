...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x4d, 0x61, 0x70, 0x52, 0x04, 0x64, 0x6f, 0x63, 0x73, 0x22, 0xe5, 0x22, 0x0a, 0x12, 0x53, 0x74,
	...
	0x69, 0x6c, 0x65, 0x73, 0x1a, 0x31, 0x0a, 0x1d, 0x50, 0x42, 0x4d, 0x47, 0x65, 0x74, 0x41, 0x76,
	...
	0x28, 0x09, 0x52, 0x03, 0x64, 0x73, 0x6e, 0x42, 0x08, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d,
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	77,  // 100: agent.StartJobRequest.Echo.delay:type_name -> google.protobuf.Duration
	24,  // 101: agent.StartJobRequest.MySQLBackup.s3_config:type_name -> agent.S3LocationConfig
	24,  // 102: agent.StartJobRequest.MySQLRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	24,  // 103: agent.StartJobRequest.MongoDBBackup.s3_config:type_name -> agent.S3LocationConfig
	74,  // 104: agent.StartJobRequest.MongoDBRestoreBackup.pitr_timestamp:type_name -> google.protobuf.Timestamp
	24,  // 105: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	31,  // 106: agent.Agent.Connect:input_type -> agent.AgentMessage
	32,  // 107: agent.Agent.Connect:output_type -> agent.ServerMessage
