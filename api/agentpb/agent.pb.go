...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xb8, 0x07, 0x0a, 0x0c, 0x41,
	...
	0x65, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xc8, 0x06, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	85,  // 32: agent.CheckConnectionRequest.type:type_name -> inventory.ServiceType
	84,  // 33: agent.CheckConnectionRequest.timeout:type_name -> google.protobuf.Duration
	...
	84,  // 36: agent.StartJobRequest.timeout:type_name -> google.protobuf.Duration
	...
	81,  // 49: agent.JobProgress.timestamp:type_name -> google.protobuf.Timestamp
	...
	79,  // 53: agent.GetVersionsRequest.softwares:type_name -> agent.GetVersionsRequest.Software
	80,  // 54: agent.GetVersionsResponse.versions:type_name -> agent.GetVersionsResponse.Version
	86,  // 55: agent.AgentMessage.status:type_name -> google.rpc.Status
	...
	32,  // 70: agent.AgentMessage.get_versions:type_name -> agent.GetVersionsResponse
	...
	20,  // 80: agent.ServerMessage.check_connection:type_name -> agent.CheckConnectionRequest
	25,  // 81: agent.ServerMessage.start_job:type_name -> agent.StartJobRequest
	27,  // 82: agent.ServerMessage.stop_job:type_name -> agent.StopJobRequest
	22,  // 83: agent.ServerMessage.job_status:type_name -> agent.JobStatusRequest
	31,  // 84: agent.ServerMessage.get_versions:type_name -> agent.GetVersionsRequest
	87,  // 85: agent.SetStateRequest.AgentProcess.type:type_name -> inventory.AgentType
	40,  // 86: agent.SetStateRequest.AgentProcess.text_files:type_name -> agent.SetStateRequest.AgentProcess.TextFilesEntry
	36,  // 87: agent.SetStateRequest.AgentProcessesEntry.value:type_name -> agent.SetStateRequest.AgentProcess
	87,  // 88: agent.SetStateRequest.BuiltinAgent.type:type_name -> inventory.AgentType
	1,   // 89: agent.SetStateRequest.BuiltinAgent.text_files:type_name -> agent.TextFiles
	38,  // 90: agent.SetStateRequest.BuiltinAgentsEntry.value:type_name -> agent.SetStateRequest.BuiltinAgent
	...
	84,  // 107: agent.StartJobRequest.Echo.delay:type_name -> google.protobuf.Duration
	...
	24,  // 111: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	75,  // 112: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	76,  // 113: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	77,  // 114: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	78,  // 115: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	33,  // 116: agent.Agent.Connect:input_type -> agent.AgentMessage
	34,  // 117: agent.Agent.Connect:output_type -> agent.ServerMessage
