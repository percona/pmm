...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	37,  // 63: agent.AgentMessage.job_result:type_name -> agent.JobResult
	38,  // 64: agent.AgentMessage.job_progress:type_name -> agent.JobProgress
	...
	34,  // 70: agent.AgentMessage.start_job:type_name -> agent.StartJobResponse
	36,  // 71: agent.AgentMessage.stop_job:type_name -> agent.StopJobResponse
