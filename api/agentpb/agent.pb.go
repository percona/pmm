...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	1,   // 100: agent.StartActionRequest.MongoDBQueryGetParameterParams.text_files:type_name -> agent.TextFiles
	1,   // 101: agent.StartActionRequest.MongoDBQueryBuildInfoParams.text_files:type_name -> agent.TextFiles
	1,   // 102: agent.StartActionRequest.MongoDBQueryGetCmdLineOptsParams.text_files:type_name -> agent.TextFiles
	84,  // 103: agent.StartJobRequest.Echo.delay:type_name -> google.protobuf.Duration
	...
	75,  // 108: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	76,  // 109: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	77,  // 110: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	78,  // 111: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
