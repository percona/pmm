...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x22, 0xe4, 0x01, 0x0a, 0x16, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x43, 0x6f, 0x6e, 0x6e,
	...
	0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x22, 0xad, 0x0b, 0x0a,
	...
	0x69, 0x67, 0x1a, 0xbf, 0x02, 0x0a, 0x0d, 0x4d, 0x6f, 0x6e, 0x67, 0x6f, 0x44, 0x42, 0x42, 0x61,
	...
	0x38, 0x0a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x2e, 0x76, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x52, 0x09,
	...
	0x6e, 0x66, 0x69, 0x67, 0x1a, 0xae, 0x02, 0x0a, 0x14, 0x4d, 0x6f, 0x6e, 0x67, 0x6f, 0x44, 0x42,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xd4, 0x08, 0x0a, 0x0c,
	...
	0x6c, 0x74, 0x73, 0x46, 0x69, 0x6c, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x22, 0xe2, 0x07, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65, 0x73,
...
var (
	...
	file_agentpb_agent_proto_goTypes   = []interface{}{
		...
		(backup.DataModel)(0),                                          // 93: backup.v1beta1.DataModel
	}
)
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	93,  // 118: agent.StartJobRequest.MongoDBBackup.data_model:type_name -> backup.v1beta1.DataModel
	29,  // 119: agent.StartJobRequest.MongoDBBackup.s3_config:type_name -> agent.S3LocationConfig
	86,  // 120: agent.StartJobRequest.MongoDBRestoreBackup.pitr_timestamp:type_name -> google.protobuf.Timestamp
	29,  // 121: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	80,  // 122: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	81,  // 123: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	82,  // 124: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	83,  // 125: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	38,  // 126: agent.Agent.Connect:input_type -> agent.AgentMessage
	39,  // 127: agent.Agent.Connect:output_type -> agent.ServerMessage
	127, // [127:128] is the sub-list for method output_type
	126, // [126:127] is the sub-list for method input_type
