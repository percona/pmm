...
func (*JobResult_MySQLRestoreBackup) Descriptor() ([]byte, []int) {
	return file_agentpb_agent_proto_rawDescGZIP(), []int{37, 3}
}
...
func (*JobResult_MongoDBRestoreBackup) Descriptor() ([]byte, []int) {
	return file_agentpb_agent_proto_rawDescGZIP(), []int{37, 4}
}
...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0xad, 0x0b, 0x0a, 0x0f, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4a, 0x6f, 0x62, 0x52, 0x65,
	...
	0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0xbf, 0x02, 0x0a, 0x0d, 0x4d, 0x6f, 0x6e, 0x67,
	...
	0x50, 0x69, 0x74, 0x72, 0x12, 0x38, 0x0a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x75,
	0x70, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x6f,
	...
	0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0xae, 0x02, 0x0a, 0x14, 0x4d, 0x6f,
	...
	0x22, 0xd0, 0x09, 0x0a, 0x0c, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x3f, 0x0a, 0x0c, 0x73, 0x74, 0x61, 0x72, 0x74,
	0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x48, 0x00, 0x52, 0x0b, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c,
	0x6f, 0x61, 0x64, 0x22, 0xdc, 0x08, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65,
	...
	0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x3e, 0x0a, 0x0c, 0x73, 0x74, 0x61, 0x72, 0x74,
	0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x73, 0x74, 0x61, 0x72,
	0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
...
var (
	...
	file_agentpb_agent_proto_goTypes   = []interface{}{
		...
		(backup.DataModel)(0),                                          // 97: backup.v1beta1.DataModel
	}
)
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	90,  // 46: agent.JobResult.timestamp:type_name -> google.protobuf.Timestamp
	76,  // 47: agent.JobResult.error:type_name -> agent.JobResult.Error
	78,  // 48: agent.JobResult.mysql_backup:type_name -> agent.JobResult.MySQLBackup
	79,  // 49: agent.JobResult.mysql_restore_backup:type_name -> agent.JobResult.MySQLRestoreBackup
	77,  // 50: agent.JobResult.mongodb_backup:type_name -> agent.JobResult.MongoDBBackup
	80,  // 51: agent.JobResult.mongodb_restore_backup:type_name -> agent.JobResult.MongoDBRestoreBackup
	90,  // 52: agent.JobProgress.timestamp:type_name -> google.protobuf.Timestamp
	81,  // 53: agent.JobProgress.mysql_backup:type_name -> agent.JobProgress.MySQLBackup
	82,  // 54: agent.JobProgress.mysql_restore_backup:type_name -> agent.JobProgress.MySQLRestoreBackup
	83,  // 55: agent.JobProgress.logs:type_name -> agent.JobProgress.Logs
	88,  // 56: agent.GetVersionsRequest.softwares:type_name -> agent.GetVersionsRequest.Software
	89,  // 57: agent.GetVersionsResponse.versions:type_name -> agent.GetVersionsResponse.Version
	95,  // 58: agent.AgentMessage.status:type_name -> google.rpc.Status
	...
	30,  // 67: agent.AgentMessage.check_connection:type_name -> agent.CheckConnectionResponse
	35,  // 68: agent.AgentMessage.start_job:type_name -> agent.StartJobResponse
	37,  // 69: agent.AgentMessage.stop_job:type_name -> agent.StopJobResponse
	32,  // 70: agent.AgentMessage.job_status:type_name -> agent.JobStatusResponse
	38,  // 71: agent.AgentMessage.job_result:type_name -> agent.JobResult
	39,  // 72: agent.AgentMessage.job_progress:type_name -> agent.JobProgress
	41,  // 73: agent.AgentMessage.get_versions:type_name -> agent.GetVersionsResponse
	...
	96,  // 96: agent.SetStateRequest.AgentProcess.type:type_name -> inventory.AgentType
	...
	96,  // 99: agent.SetStateRequest.BuiltinAgent.type:type_name -> inventory.AgentType
	...
	97,  // 122: agent.StartJobRequest.MongoDBBackup.data_model:type_name -> backup.v1beta1.DataModel
	...
	33,  // 125: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	84,  // 126: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	85,  // 127: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	86,  // 128: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	87,  // 129: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	42,  // 130: agent.Agent.Connect:input_type -> agent.AgentMessage
	43,  // 131: agent.Agent.Connect:output_type -> agent.ServerMessage
