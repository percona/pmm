...
const (
	...
	ActionName_EXPLAIN             ActionName = 3
)
...
// StartActionResponse represents message with action results which agent send to server when action was finished.
...
func (m *StartActionResponse) GetName() ActionName {
	if m != nil {
		return m.Name
	}
	return ActionName_ACTION_NAME_INVALID
...
func (m *StartActionResponse) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func (m *StartActionResponse) GetOutput() []byte {
	if m != nil {
		return m.Output
	}
	return nil
...
func (m *StopActionRequest) GetName() ActionName {
	if m != nil {
		return m.Name
	}
	return ActionName_ACTION_NAME_INVALID
...
func (m *StopActionResponse) GetName() ActionName {
	if m != nil {
		return m.Name
	}
	return ActionName_ACTION_NAME_INVALID
...
var fileDescriptor_0e8f797f46bba6fc = []byte{
	...
	,
}
