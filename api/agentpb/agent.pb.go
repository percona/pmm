...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	73,  // 109: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	74,  // 110: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	75,  // 111: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	76,  // 112: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	33,  // 113: agent.Agent.Connect:input_type -> agent.AgentMessage
	34,  // 114: agent.Agent.Connect:output_type -> agent.ServerMessage
