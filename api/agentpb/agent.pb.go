...
var file_agentpb_agent_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0xc3, 0x10, 0x0a, 0x0f, 0x53, 0x74,
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	93,  // 130: agent.StartJobRequest.MongoDBRestoreBackup.pitr_timestamp:type_name -> google.protobuf.Timestamp
	32,  // 131: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	33,  // 132: agent.StartJobRequest.MongoDBRestoreBackup.filesystem_config:type_name -> agent.FilesystemLocationConfig
	102, // 133: agent.StartJobRequest.MongoDBRestoreBackup.pbm_metadata:type_name -> backup.v1.PbmMetadata
	2,   // 134: agent.StartJobRequest.MongoDBRestoreBackup.text_files:type_name -> agent.TextFiles
	103, // 135: agent.JobResult.MongoDBBackup.metadata:type_name -> backup.v1.Metadata
	103, // 136: agent.JobResult.MySQLBackup.metadata:type_name -> backup.v1.Metadata
	85,  // 137: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	86,  // 138: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	87,  // 139: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	88,  // 140: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	89,  // 141: agent.GetVersionsRequest.Software.mongod:type_name -> agent.GetVersionsRequest.MongoDB
	90,  // 142: agent.GetVersionsRequest.Software.pbm:type_name -> agent.GetVersionsRequest.PBM
	42,  // 143: agent.Agent.Connect:input_type -> agent.AgentMessage
	43,  // 144: agent.Agent.Connect:output_type -> agent.ServerMessage
