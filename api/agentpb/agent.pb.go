...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x80, 0x08, 0x0a, 0x0c, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x61, 0x64, 0x22, 0x8f, 0x07, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65, 0x73,
...
var file_agentpb_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 83)
var file_agentpb_agent_proto_goTypes = []interface{}{
	...
	(*StartActionRequest_MongoDBQueryReplSetGetStatusParams)(nil),  // 63: agent.StartActionRequest.MongoDBQueryReplSetGetStatusParams
	(*StartActionRequest_MongoDBQueryGetDiagnosticDataParams)(nil), // 64: agent.StartActionRequest.MongoDBQueryGetDiagnosticDataParams
	(*CheckConnectionResponse_Stats)(nil),                          // 65: agent.CheckConnectionResponse.Stats
	(*StartJobRequest_MySQLBackup)(nil),                            // 66: agent.StartJobRequest.MySQLBackup
	(*StartJobRequest_MySQLRestoreBackup)(nil),                     // 67: agent.StartJobRequest.MySQLRestoreBackup
	(*StartJobRequest_MongoDBBackup)(nil),                          // 68: agent.StartJobRequest.MongoDBBackup
	(*StartJobRequest_MongoDBRestoreBackup)(nil),                   // 69: agent.StartJobRequest.MongoDBRestoreBackup
	(*JobResult_Error)(nil),                                        // 70: agent.JobResult.Error
	(*JobResult_MongoDBBackup)(nil),                                // 71: agent.JobResult.MongoDBBackup
	(*JobResult_MySQLBackup)(nil),                                  // 72: agent.JobResult.MySQLBackup
	(*JobResult_MySQLRestoreBackup)(nil),                           // 73: agent.JobResult.MySQLRestoreBackup
	(*JobResult_MongoDBRestoreBackup)(nil),                         // 74: agent.JobResult.MongoDBRestoreBackup
	(*JobProgress_MySQLBackup)(nil),                                // 75: agent.JobProgress.MySQLBackup
	(*JobProgress_MySQLRestoreBackup)(nil),                         // 76: agent.JobProgress.MySQLRestoreBackup
	(*JobProgress_Logs)(nil),                                       // 77: agent.JobProgress.Logs
	(*GetVersionsRequest_MySQLd)(nil),                              // 78: agent.GetVersionsRequest.MySQLd
	(*GetVersionsRequest_Xtrabackup)(nil),                          // 79: agent.GetVersionsRequest.Xtrabackup
	(*GetVersionsRequest_Xbcloud)(nil),                             // 80: agent.GetVersionsRequest.Xbcloud
	(*GetVersionsRequest_Qpress)(nil),                              // 81: agent.GetVersionsRequest.Qpress
	(*GetVersionsRequest_Software)(nil),                            // 82: agent.GetVersionsRequest.Software
	(*GetVersionsResponse_Version)(nil),                            // 83: agent.GetVersionsResponse.Version
	(*timestamppb.Timestamp)(nil),                                  // 84: google.protobuf.Timestamp
	(*MetricsBucket)(nil),                                          // 85: agent.MetricsBucket
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	85,  // 2: agent.QANCollectRequest.metrics_bucket:type_name -> agent.MetricsBucket
	86,  // 3: agent.StateChangedRequest.status:type_name -> inventory.AgentStatus
	...
	84,  // 6: agent.QueryActionValue.timestamp:type_name -> google.protobuf.Timestamp
	...
	63,  // 32: agent.StartActionRequest.mongodb_query_replsetgetstatus_params:type_name -> agent.StartActionRequest.MongoDBQueryReplSetGetStatusParams
	64,  // 33: agent.StartActionRequest.mongodb_query_getdiagnosticdata_params:type_name -> agent.StartActionRequest.MongoDBQueryGetDiagnosticDataParams
	87,  // 34: agent.StartActionRequest.timeout:type_name -> google.protobuf.Duration
	1,   // 35: agent.PBMSwitchPITRRequest.text_files:type_name -> agent.TextFiles
	88,  // 36: agent.CheckConnectionRequest.type:type_name -> inventory.ServiceType
	87,  // 37: agent.CheckConnectionRequest.timeout:type_name -> google.protobuf.Duration
	1,   // 38: agent.CheckConnectionRequest.text_files:type_name -> agent.TextFiles
	65,  // 39: agent.CheckConnectionResponse.stats:type_name -> agent.CheckConnectionResponse.Stats
	87,  // 40: agent.StartJobRequest.timeout:type_name -> google.protobuf.Duration
	66,  // 41: agent.StartJobRequest.mysql_backup:type_name -> agent.StartJobRequest.MySQLBackup
	67,  // 42: agent.StartJobRequest.mysql_restore_backup:type_name -> agent.StartJobRequest.MySQLRestoreBackup
	68,  // 43: agent.StartJobRequest.mongodb_backup:type_name -> agent.StartJobRequest.MongoDBBackup
	69,  // 44: agent.StartJobRequest.mongodb_restore_backup:type_name -> agent.StartJobRequest.MongoDBRestoreBackup
	84,  // 45: agent.JobResult.timestamp:type_name -> google.protobuf.Timestamp
	70,  // 46: agent.JobResult.error:type_name -> agent.JobResult.Error
	72,  // 47: agent.JobResult.mysql_backup:type_name -> agent.JobResult.MySQLBackup
	73,  // 48: agent.JobResult.mysql_restore_backup:type_name -> agent.JobResult.MySQLRestoreBackup
	71,  // 49: agent.JobResult.mongodb_backup:type_name -> agent.JobResult.MongoDBBackup
	74,  // 50: agent.JobResult.mongodb_restore_backup:type_name -> agent.JobResult.MongoDBRestoreBackup
	84,  // 51: agent.JobProgress.timestamp:type_name -> google.protobuf.Timestamp
	75,  // 52: agent.JobProgress.mysql_backup:type_name -> agent.JobProgress.MySQLBackup
	76,  // 53: agent.JobProgress.mysql_restore_backup:type_name -> agent.JobProgress.MySQLRestoreBackup
	77,  // 54: agent.JobProgress.logs:type_name -> agent.JobProgress.Logs
	82,  // 55: agent.GetVersionsRequest.softwares:type_name -> agent.GetVersionsRequest.Software
	83,  // 56: agent.GetVersionsResponse.versions:type_name -> agent.GetVersionsResponse.Version
	89,  // 57: agent.AgentMessage.status:type_name -> google.rpc.Status
	...
	24,  // 66: agent.AgentMessage.check_connection:type_name -> agent.CheckConnectionResponse
	29,  // 67: agent.AgentMessage.start_job:type_name -> agent.StartJobResponse
	31,  // 68: agent.AgentMessage.stop_job:type_name -> agent.StopJobResponse
	26,  // 69: agent.AgentMessage.job_status:type_name -> agent.JobStatusResponse
	32,  // 70: agent.AgentMessage.job_result:type_name -> agent.JobResult
	33,  // 71: agent.AgentMessage.job_progress:type_name -> agent.JobProgress
	35,  // 72: agent.AgentMessage.get_versions:type_name -> agent.GetVersionsResponse
	22,  // 73: agent.AgentMessage.pbm_switch_pitr:type_name -> agent.PBMSwitchPITRResponse
	89,  // 74: agent.ServerMessage.status:type_name -> google.rpc.Status
	3,   // 75: agent.ServerMessage.pong:type_name -> agent.Pong
	7,   // 76: agent.ServerMessage.state_changed:type_name -> agent.StateChangedResponse
	5,   // 77: agent.ServerMessage.qan_collect:type_name -> agent.QANCollectResponse
	20,  // 78: agent.ServerMessage.action_result:type_name -> agent.ActionResultResponse
	2,   // 79: agent.ServerMessage.ping:type_name -> agent.Ping
	8,   // 80: agent.ServerMessage.set_state:type_name -> agent.SetStateRequest
	15,  // 81: agent.ServerMessage.start_action:type_name -> agent.StartActionRequest
	17,  // 82: agent.ServerMessage.stop_action:type_name -> agent.StopActionRequest
	23,  // 83: agent.ServerMessage.check_connection:type_name -> agent.CheckConnectionRequest
	28,  // 84: agent.ServerMessage.start_job:type_name -> agent.StartJobRequest
	30,  // 85: agent.ServerMessage.stop_job:type_name -> agent.StopJobRequest
	25,  // 86: agent.ServerMessage.job_status:type_name -> agent.JobStatusRequest
	34,  // 87: agent.ServerMessage.get_versions:type_name -> agent.GetVersionsRequest
	21,  // 88: agent.ServerMessage.pbm_switch_pitr:type_name -> agent.PBMSwitchPITRRequest
	90,  // 89: agent.SetStateRequest.AgentProcess.type:type_name -> inventory.AgentType
	43,  // 90: agent.SetStateRequest.AgentProcess.text_files:type_name -> agent.SetStateRequest.AgentProcess.TextFilesEntry
	39,  // 91: agent.SetStateRequest.AgentProcessesEntry.value:type_name -> agent.SetStateRequest.AgentProcess
	90,  // 92: agent.SetStateRequest.BuiltinAgent.type:type_name -> inventory.AgentType
	1,   // 93: agent.SetStateRequest.BuiltinAgent.text_files:type_name -> agent.TextFiles
	41,  // 94: agent.SetStateRequest.BuiltinAgentsEntry.value:type_name -> agent.SetStateRequest.BuiltinAgent
	10,  // 95: agent.QueryActionMap.MapEntry.value:type_name -> agent.QueryActionValue
	0,   // 96: agent.StartActionRequest.MySQLExplainParams.output_format:type_name -> agent.MysqlExplainOutputFormat
	1,   // 97: agent.StartActionRequest.MySQLExplainParams.tls_files:type_name -> agent.TextFiles
	1,   // 98: agent.StartActionRequest.MySQLShowCreateTableParams.tls_files:type_name -> agent.TextFiles
	1,   // 99: agent.StartActionRequest.MySQLShowTableStatusParams.tls_files:type_name -> agent.TextFiles
	1,   // 100: agent.StartActionRequest.MySQLShowIndexParams.tls_files:type_name -> agent.TextFiles
	1,   // 101: agent.StartActionRequest.PostgreSQLShowCreateTableParams.tls_files:type_name -> agent.TextFiles
	1,   // 102: agent.StartActionRequest.PostgreSQLShowIndexParams.tls_files:type_name -> agent.TextFiles
	1,   // 103: agent.StartActionRequest.MongoDBExplainParams.text_files:type_name -> agent.TextFiles
	1,   // 104: agent.StartActionRequest.MySQLQueryShowParams.tls_files:type_name -> agent.TextFiles
	1,   // 105: agent.StartActionRequest.MySQLQuerySelectParams.tls_files:type_name -> agent.TextFiles
	1,   // 106: agent.StartActionRequest.PostgreSQLQueryShowParams.tls_files:type_name -> agent.TextFiles
	1,   // 107: agent.StartActionRequest.PostgreSQLQuerySelectParams.tls_files:type_name -> agent.TextFiles
	1,   // 108: agent.StartActionRequest.MongoDBQueryGetParameterParams.text_files:type_name -> agent.TextFiles
	1,   // 109: agent.StartActionRequest.MongoDBQueryBuildInfoParams.text_files:type_name -> agent.TextFiles
	1,   // 110: agent.StartActionRequest.MongoDBQueryGetCmdLineOptsParams.text_files:type_name -> agent.TextFiles
	1,   // 111: agent.StartActionRequest.MongoDBQueryReplSetGetStatusParams.text_files:type_name -> agent.TextFiles
	1,   // 112: agent.StartActionRequest.MongoDBQueryGetDiagnosticDataParams.text_files:type_name -> agent.TextFiles
	27,  // 113: agent.StartJobRequest.MySQLBackup.s3_config:type_name -> agent.S3LocationConfig
	27,  // 114: agent.StartJobRequest.MySQLRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	27,  // 115: agent.StartJobRequest.MongoDBBackup.s3_config:type_name -> agent.S3LocationConfig
	84,  // 116: agent.StartJobRequest.MongoDBRestoreBackup.pitr_timestamp:type_name -> google.protobuf.Timestamp
	27,  // 117: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	78,  // 118: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	79,  // 119: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	80,  // 120: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	81,  // 121: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	36,  // 122: agent.Agent.Connect:input_type -> agent.AgentMessage
	37,  // 123: agent.Agent.Connect:output_type -> agent.ServerMessage
...
func file_agentpb_agent_proto_init() {
	...
	file_agentpb_agent_proto_msgTypes[81].OneofWrappers = []interface{}{
