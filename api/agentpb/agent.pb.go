...
// DataModel represents the data model used for the backup. Can be either of 'physical' or 'logical'.
type DataModel int32

const (
	DataModel_LOGICAL  DataModel = 0
...
type StartJobRequest_MongoDBBackup struct {
	...
	DataModel DataModel `protobuf:"varint,8,opt,name=data_model,json=dataModel,proto3,enum=agent.DataModel" json:"data_model,omitempty"`
	// Backup target location.
	//
	// Types that are assignable to LocationConfig:
...
func (x *StartJobRequest_MongoDBBackup) GetDataModel() DataModel {
	if x != nil {
		return x.DataModel
	}
	return DataModel_LOGICAL
}
...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x22, 0xa4, 0x0b, 0x0a, 0x0f, 0x53,
	...
	0x1a, 0xb6, 0x02, 0x0a, 0x0d, 0x4d, 0x6f, 0x6e, 0x67, 0x6f, 0x44, 0x42, 0x42, 0x61, 0x63, 0x6b,
	...
	0x08, 0x52, 0x0a, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x50, 0x69, 0x74, 0x72, 0x12, 0x2f, 0x0a,
	0x0a, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x10, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x6f,
	...
	0x22, 0xd4, 0x08, 0x0a, 0x0c, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xe2, 0x07, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76,
	...
	0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2a, 0xc4, 0x01, 0x0a,
	...
	0x4e, 0x10, 0x03, 0x2a, 0x26, 0x0a, 0x09, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	0x12, 0x0b, 0x0a, 0x07, 0x4c, 0x4f, 0x47, 0x49, 0x43, 0x41, 0x4c, 0x10, 0x00, 0x12, 0x0c, 0x0a,
	0x08, 0x50, 0x48, 0x59, 0x53, 0x49, 0x43, 0x41, 0x4c, 0x10, 0x01, 0x32, 0x41, 0x0a, 0x05, 0x41,
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	4,   // 63: agent.AgentMessage.pong:type_name -> agent.Pong
	10,  // 64: agent.AgentMessage.set_state:type_name -> agent.SetStateResponse
	17,  // 65: agent.AgentMessage.start_action:type_name -> agent.StartActionResponse
	19,  // 66: agent.AgentMessage.stop_action:type_name -> agent.StopActionResponse
	27,  // 67: agent.AgentMessage.check_connection:type_name -> agent.CheckConnectionResponse
	...
	29,  // 70: agent.AgentMessage.job_status:type_name -> agent.JobStatusResponse
	...
	25,  // 75: agent.AgentMessage.parse_defaults_file:type_name -> agent.ParseDefaultsFileResponse
	...
	24,  // 91: agent.ServerMessage.parse_defaults_file:type_name -> agent.ParseDefaultsFileRequest
	...
	30,  // 116: agent.StartJobRequest.MySQLBackup.s3_config:type_name -> agent.S3LocationConfig
	30,  // 117: agent.StartJobRequest.MySQLRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	1,   // 118: agent.StartJobRequest.MongoDBBackup.data_model:type_name -> agent.DataModel
	30,  // 119: agent.StartJobRequest.MongoDBBackup.s3_config:type_name -> agent.S3LocationConfig
	87,  // 120: agent.StartJobRequest.MongoDBRestoreBackup.pitr_timestamp:type_name -> google.protobuf.Timestamp
	30,  // 121: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	81,  // 122: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	82,  // 123: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	83,  // 124: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	84,  // 125: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	39,  // 126: agent.Agent.Connect:input_type -> agent.AgentMessage
	40,  // 127: agent.Agent.Connect:output_type -> agent.ServerMessage
