...
func (x *JobProgress_Logs) GetOut() []byte {
	if x != nil {
		return x.Out
	}
	return nil
...
func (x *JobProgress_Logs) GetErr() []byte {
	if x != nil {
		return x.Err
	}
	return nil
...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x42, 0x08, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xd7, 0x03, 0x0a, 0x0b, 0x4a,
	...
	0x73, 0x48, 0x00, 0x52, 0x04, 0x6c, 0x6f, 0x67, 0x73, 0x1a, 0x1e, 0x0a, 0x04, 0x45, 0x63, 0x68,
	...
	0x4c, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x1a, 0x2a,
	0x0a, 0x04, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x6f, 0x75, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x03, 0x6f, 0x75, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x72, 0x72, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x65, 0x72, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x72, 0x65,
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xb8, 0x07, 0x0a, 0x0c, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x4d,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	0x22, 0xc8, 0x06, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61,
...
var file_agentpb_agent_proto_depIdxs = []int32{
	...
	85,  // 31: agent.StartActionRequest.timeout:type_name -> google.protobuf.Duration
	86,  // 32: agent.CheckConnectionRequest.type:type_name -> inventory.ServiceType
	85,  // 33: agent.CheckConnectionRequest.timeout:type_name -> google.protobuf.Duration
	...
	85,  // 36: agent.StartJobRequest.timeout:type_name -> google.protobuf.Duration
	...
	82,  // 42: agent.JobResult.timestamp:type_name -> google.protobuf.Timestamp
	...
	75,  // 53: agent.JobProgress.logs:type_name -> agent.JobProgress.Logs
	...
	85,  // 108: agent.StartJobRequest.Echo.delay:type_name -> google.protobuf.Duration
	24,  // 109: agent.StartJobRequest.MySQLBackup.s3_config:type_name -> agent.S3LocationConfig
	24,  // 110: agent.StartJobRequest.MySQLRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	24,  // 111: agent.StartJobRequest.MongoDBBackup.s3_config:type_name -> agent.S3LocationConfig
	24,  // 112: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	76,  // 113: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	77,  // 114: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	78,  // 115: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	79,  // 116: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	33,  // 117: agent.Agent.Connect:input_type -> agent.AgentMessage
	34,  // 118: agent.Agent.Connect:output_type -> agent.ServerMessage
