...
var file_agentpb_agent_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0x17, 0x0a, 0x15, 0x50, 0x42,
	0x4d, 0x53, 0x77, 0x69, 0x74, 0x63, 0x68, 0x50, 0x49, 0x54, 0x52, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0xe4, 0x01, 0x0a, 0x16, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x43, 0x6f, 0x6e,
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xad, 0x02, 0x0a, 0x0b, 0x4a, 0x6f, 0x62, 0x50,
	...
	0x72, 0x65, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x1a, 0x0d, 0x0a, 0x0b, 0x4d, 0x79, 0x53, 0x51,
...
var file_agentpb_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 79)
var file_agentpb_agent_proto_goTypes = []interface{}{
	...
	(*GetVersionsRequest_MySQLd)(nil),                           // 74: agent.GetVersionsRequest.MySQLd
	(*GetVersionsRequest_Xtrabackup)(nil),                       // 75: agent.GetVersionsRequest.Xtrabackup
	(*GetVersionsRequest_Xbcloud)(nil),                          // 76: agent.GetVersionsRequest.Xbcloud
	(*GetVersionsRequest_Qpress)(nil),                           // 77: agent.GetVersionsRequest.Qpress
	(*GetVersionsRequest_Software)(nil),                         // 78: agent.GetVersionsRequest.Software
	(*GetVersionsResponse_Version)(nil),                         // 79: agent.GetVersionsResponse.Version
	(*timestamp.Timestamp)(nil),                                 // 80: google.protobuf.Timestamp
	(*MetricsBucket)(nil),                                       // 81: agent.MetricsBucket
	(inventorypb.AgentStatus)(0),                                // 82: inventory.AgentStatus
	(*duration.Duration)(nil),                                   // 83: google.protobuf.Duration
	(inventorypb.ServiceType)(0),                                // 84: inventory.ServiceType
	(*status.Status)(nil),                                       // 85: google.rpc.Status
	(inventorypb.AgentType)(0),                                  // 86: inventory.AgentType
}
var file_agentpb_agent_proto_depIdxs = []int32{
	37,  // 0: agent.TextFiles.files:type_name -> agent.TextFiles.FilesEntry
	80,  // 1: agent.Pong.current_time:type_name -> google.protobuf.Timestamp
	81,  // 2: agent.QANCollectRequest.metrics_bucket:type_name -> agent.MetricsBucket
	82,  // 3: agent.StateChangedRequest.status:type_name -> inventory.AgentStatus
	...
	80,  // 6: agent.QueryActionValue.timestamp:type_name -> google.protobuf.Timestamp
	...
	83,  // 31: agent.StartActionRequest.timeout:type_name -> google.protobuf.Duration
	1,   // 32: agent.PBMSwitchPITRRequest.text_files:type_name -> agent.TextFiles
	84,  // 33: agent.CheckConnectionRequest.type:type_name -> inventory.ServiceType
	83,  // 34: agent.CheckConnectionRequest.timeout:type_name -> google.protobuf.Duration
	...
	83,  // 37: agent.StartJobRequest.timeout:type_name -> google.protobuf.Duration
	...
	80,  // 42: agent.JobResult.timestamp:type_name -> google.protobuf.Timestamp
	...
	80,  // 48: agent.JobProgress.timestamp:type_name -> google.protobuf.Timestamp
	...
	78,  // 51: agent.GetVersionsRequest.softwares:type_name -> agent.GetVersionsRequest.Software
	79,  // 52: agent.GetVersionsResponse.versions:type_name -> agent.GetVersionsResponse.Version
	85,  // 53: agent.AgentMessage.status:type_name -> google.rpc.Status
	...
	23,  // 62: agent.AgentMessage.check_connection:type_name -> agent.CheckConnectionResponse
	28,  // 63: agent.AgentMessage.start_job:type_name -> agent.StartJobResponse
	30,  // 64: agent.AgentMessage.stop_job:type_name -> agent.StopJobResponse
	25,  // 65: agent.AgentMessage.job_status:type_name -> agent.JobStatusResponse
	31,  // 66: agent.AgentMessage.job_result:type_name -> agent.JobResult
	32,  // 67: agent.AgentMessage.job_progress:type_name -> agent.JobProgress
	34,  // 68: agent.AgentMessage.get_versions:type_name -> agent.GetVersionsResponse
	21,  // 69: agent.AgentMessage.pbm_switch_pitr:type_name -> agent.PBMSwitchPITRResponse
	85,  // 70: agent.ServerMessage.status:type_name -> google.rpc.Status
	...
	22,  // 79: agent.ServerMessage.check_connection:type_name -> agent.CheckConnectionRequest
	27,  // 80: agent.ServerMessage.start_job:type_name -> agent.StartJobRequest
	29,  // 81: agent.ServerMessage.stop_job:type_name -> agent.StopJobRequest
	24,  // 82: agent.ServerMessage.job_status:type_name -> agent.JobStatusRequest
	33,  // 83: agent.ServerMessage.get_versions:type_name -> agent.GetVersionsRequest
	20,  // 84: agent.ServerMessage.pbm_switch_pitr:type_name -> agent.PBMSwitchPITRRequest
	86,  // 85: agent.SetStateRequest.AgentProcess.type:type_name -> inventory.AgentType
	42,  // 86: agent.SetStateRequest.AgentProcess.text_files:type_name -> agent.SetStateRequest.AgentProcess.TextFilesEntry
	38,  // 87: agent.SetStateRequest.AgentProcessesEntry.value:type_name -> agent.SetStateRequest.AgentProcess
	86,  // 88: agent.SetStateRequest.BuiltinAgent.type:type_name -> inventory.AgentType
	1,   // 89: agent.SetStateRequest.BuiltinAgent.text_files:type_name -> agent.TextFiles
	40,  // 90: agent.SetStateRequest.BuiltinAgentsEntry.value:type_name -> agent.SetStateRequest.BuiltinAgent
	10,  // 91: agent.QueryActionMap.MapEntry.value:type_name -> agent.QueryActionValue
	0,   // 92: agent.StartActionRequest.MySQLExplainParams.output_format:type_name -> agent.MysqlExplainOutputFormat
	1,   // 93: agent.StartActionRequest.MySQLExplainParams.tls_files:type_name -> agent.TextFiles
	1,   // 94: agent.StartActionRequest.MySQLShowCreateTableParams.tls_files:type_name -> agent.TextFiles
	1,   // 95: agent.StartActionRequest.MySQLShowTableStatusParams.tls_files:type_name -> agent.TextFiles
	1,   // 96: agent.StartActionRequest.MySQLShowIndexParams.tls_files:type_name -> agent.TextFiles
	1,   // 97: agent.StartActionRequest.PostgreSQLShowCreateTableParams.tls_files:type_name -> agent.TextFiles
	1,   // 98: agent.StartActionRequest.PostgreSQLShowIndexParams.tls_files:type_name -> agent.TextFiles
	1,   // 99: agent.StartActionRequest.MongoDBExplainParams.text_files:type_name -> agent.TextFiles
	1,   // 100: agent.StartActionRequest.MySQLQueryShowParams.tls_files:type_name -> agent.TextFiles
	1,   // 101: agent.StartActionRequest.MySQLQuerySelectParams.tls_files:type_name -> agent.TextFiles
	1,   // 102: agent.StartActionRequest.PostgreSQLQueryShowParams.tls_files:type_name -> agent.TextFiles
	1,   // 103: agent.StartActionRequest.PostgreSQLQuerySelectParams.tls_files:type_name -> agent.TextFiles
	1,   // 104: agent.StartActionRequest.MongoDBQueryGetParameterParams.text_files:type_name -> agent.TextFiles
	1,   // 105: agent.StartActionRequest.MongoDBQueryBuildInfoParams.text_files:type_name -> agent.TextFiles
	1,   // 106: agent.StartActionRequest.MongoDBQueryGetCmdLineOptsParams.text_files:type_name -> agent.TextFiles
	26,  // 107: agent.StartJobRequest.MySQLBackup.s3_config:type_name -> agent.S3LocationConfig
	26,  // 108: agent.StartJobRequest.MySQLRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	26,  // 109: agent.StartJobRequest.MongoDBBackup.s3_config:type_name -> agent.S3LocationConfig
	80,  // 110: agent.StartJobRequest.MongoDBRestoreBackup.pitr_timestamp:type_name -> google.protobuf.Timestamp
	26,  // 111: agent.StartJobRequest.MongoDBRestoreBackup.s3_config:type_name -> agent.S3LocationConfig
	74,  // 112: agent.GetVersionsRequest.Software.mysqld:type_name -> agent.GetVersionsRequest.MySQLd
	75,  // 113: agent.GetVersionsRequest.Software.xtrabackup:type_name -> agent.GetVersionsRequest.Xtrabackup
	76,  // 114: agent.GetVersionsRequest.Software.xbcloud:type_name -> agent.GetVersionsRequest.Xbcloud
	77,  // 115: agent.GetVersionsRequest.Software.qpress:type_name -> agent.GetVersionsRequest.Qpress
	35,  // 116: agent.Agent.Connect:input_type -> agent.AgentMessage
	36,  // 117: agent.Agent.Connect:output_type -> agent.ServerMessage
...
func file_agentpb_agent_proto_init() {
	...
	file_agentpb_agent_proto_msgTypes[77].OneofWrappers = []interface{}{
