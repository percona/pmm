...
var file_agentpb_collector_proto_rawDesc = string([]byte{
...
var (
	...
	file_agentpb_collector_proto_rawDescData []byte
)

func file_agentpb_collector_proto_rawDescGZIP() []byte {
	file_agentpb_collector_proto_rawDescOnce.Do(func() {
		file_agentpb_collector_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agentpb_collector_proto_rawDesc), len(file_agentpb_collector_proto_rawDesc)))
	})
...
func file_agentpb_collector_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_agentpb_collector_proto_rawDesc), len(file_agentpb_collector_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
