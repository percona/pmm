...
func (*SettingsItem) Descriptor() ([]byte, []int) {
	return file_agentpb_collector_proto_rawDescGZIP(), []int{2}
}
...
type MetricsBucket_PostgreSQL struct {
	...
	SettingsItems   []*SettingsItem  `protobuf:"bytes,50,rep,name=settings_items,json=settingsItems,proto3" json:"settings_items,omitempty"`
}

func (x *MetricsBucket_PostgreSQL) Reset() {
	*x = MetricsBucket_PostgreSQL{}
	if protoimpl.UnsafeEnabled {
		mi := &file_agentpb_collector_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *MetricsBucket_PostgreSQL) GetSettingsItems() []*SettingsItem {
	if x != nil {
...
var file_agentpb_collector_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf6, 0x4b, 0x0a, 0x0d, 0x4d,
	...
	0x39, 0x39, 0x1a, 0xee, 0x11, 0x0a, 0x0a, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x53, 0x51,
	...
	0x61, 0x6d, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x3a, 0x0a, 0x0e, 0x73, 0x65, 0x74, 0x74, 0x69,
	0x6e, 0x67, 0x73, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x32, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x13, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73,
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x0d, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x49, 0x74,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x22, 0xe7, 0x01, 0x0a, 0x0c, 0x53, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	,
...
var file_agentpb_collector_proto_goTypes = []interface{}{
	...
	(*SettingsItem)(nil),             // 4: agent.SettingsItem
	(*MetricsBucket_Common)(nil),     // 5: agent.MetricsBucket.Common
	(*MetricsBucket_MySQL)(nil),      // 6: agent.MetricsBucket.MySQL
	(*MetricsBucket_MongoDB)(nil),    // 7: agent.MetricsBucket.MongoDB
	(*MetricsBucket_PostgreSQL)(nil), // 8: agent.MetricsBucket.PostgreSQL
...
var file_agentpb_collector_proto_depIdxs = []int32{
	5,  // 0: agent.MetricsBucket.common:type_name -> agent.MetricsBucket.Common
	6,  // 1: agent.MetricsBucket.mysql:type_name -> agent.MetricsBucket.MySQL
	7,  // 2: agent.MetricsBucket.mongodb:type_name -> agent.MetricsBucket.MongoDB
	8,  // 3: agent.MetricsBucket.postgresql:type_name -> agent.MetricsBucket.PostgreSQL
	10, // 4: agent.MetricsBucket.Common.agent_type:type_name -> inventory.AgentType
	...
	9,  // 7: agent.MetricsBucket.Common.errors:type_name -> agent.MetricsBucket.Common.ErrorsEntry
	3,  // 8: agent.MetricsBucket.PostgreSQL.histogram_items:type_name -> agent.HistogramItem
	4,  // 9: agent.MetricsBucket.PostgreSQL.settings_items:type_name -> agent.SettingsItem
...
func file_agentpb_collector_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agentpb_collector_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
