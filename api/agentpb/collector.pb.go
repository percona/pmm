...
type MetricsBucket_PostgreSQL struct {
	...
	//
	MRowRetrievedSum uint64 `protobuf:"varint,31,opt,name=m_row_retrieved_sum,json=mRowRetrievedSum,proto3" json:"m_row_retrieved_sum,omitempty"`
	// Total number of rows in result.
	MRowRetrievedCnt uint64 `protobuf:"varint,32,opt,name=m_row_retrieved_cnt,json=mRowRetrievedCnt,proto3" json:"m_row_retrieved_cnt,omitempty"`
	MPlansCallsSum   uint64 `protobuf:"varint,33,opt,name=m_plans_calls_sum,json=mPlansCallsSum,proto3" json:"m_plans_calls_sum,omitempty"`
	// Total number of planned calls.
	MPlansCallsCnt uint64 `protobuf:"varint,34,opt,name=m_plans_calls_cnt,json=mPlansCallsCnt,proto3" json:"m_plans_calls_cnt,omitempty"`
	MWalRecordsSum uint64 `protobuf:"varint,35,opt,name=m_wal_records_sum,json=mWalRecordsSum,proto3" json:"m_wal_records_sum,omitempty"`
	// Total number of WAL (Write-ahead logging) records.
	MWalRecordsCnt uint64 `protobuf:"varint,36,opt,name=m_wal_records_cnt,json=mWalRecordsCnt,proto3" json:"m_wal_records_cnt,omitempty"`
	MWalFpiSum     uint64 `protobuf:"varint,37,opt,name=m_wal_fpi_sum,json=mWalFpiSum,proto3" json:"m_wal_fpi_sum,omitempty"`
	// Total number of FPI (full page images) in WAL (Write-ahead logging) records.
	MWalFpiCnt uint64 `protobuf:"varint,38,opt,name=m_wal_fpi_cnt,json=mWalFpiCnt,proto3" json:"m_wal_fpi_cnt,omitempty"`
}
...
func (x *MetricsBucket_PostgreSQL) GetMRowRetrievedSum() uint64 {
	if x != nil {
...
func (x *MetricsBucket_PostgreSQL) GetMRowRetrievedCnt() uint64 {
	if x != nil {
...
func (x *MetricsBucket_PostgreSQL) GetMPlansCallsSum() uint64 {
	if x != nil {
...
func (x *MetricsBucket_PostgreSQL) GetMPlansCallsCnt() uint64 {
	if x != nil {
...
func (x *MetricsBucket_PostgreSQL) GetMWalRecordsSum() uint64 {
	if x != nil {
...
func (x *MetricsBucket_PostgreSQL) GetMWalRecordsCnt() uint64 {
	if x != nil {
...
func (x *MetricsBucket_PostgreSQL) GetMWalFpiSum() uint64 {
	if x != nil {
		return x.MWalFpiSum
	}
	return 0
...
func (x *MetricsBucket_PostgreSQL) GetMWalFpiCnt() uint64 {
	if x != nil {
		return x.MWalFpiCnt
	}
	return 0
...
var file_agentpb_collector_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb4, 0x48, 0x0a, 0x0d, 0x4d,
	...
	0x39, 0x39, 0x1a, 0xac, 0x0e, 0x0a, 0x0a, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x53, 0x51,
	...
	,
	...
	0x22, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x6d, 0x50, 0x6c, 0x61, 0x6e, 0x73, 0x43, 0x61, 0x6c,
	0x6c, 0x73, 0x43, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x11, 0x6d, 0x5f, 0x77, 0x61, 0x6c, 0x5f, 0x72,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x5f, 0x73, 0x75, 0x6d, 0x18, 0x23, 0x20, 0x01, 0x28, 0x04,
	...
	0x73, 0x5f, 0x63, 0x6e, 0x74, 0x18, 0x24, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x6d, 0x57, 0x61,
	0x6c, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x43, 0x6e, 0x74, 0x12, 0x21, 0x0a, 0x0d, 0x6d,
	0x5f, 0x77, 0x61, 0x6c, 0x5f, 0x66, 0x70, 0x69, 0x5f, 0x73, 0x75, 0x6d, 0x18, 0x25, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x0a, 0x6d, 0x57, 0x61, 0x6c, 0x46, 0x70, 0x69, 0x53, 0x75, 0x6d, 0x12, 0x21,
	0x0a, 0x0d, 0x6d, 0x5f, 0x77, 0x61, 0x6c, 0x5f, 0x66, 0x70, 0x69, 0x5f, 0x63, 0x6e, 0x74, 0x18,
	0x26, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x6d, 0x57, 0x61, 0x6c, 0x46, 0x70, 0x69, 0x43, 0x6e,
	0x74, 0x2a, 0x55, 0x0a, 0x0d, 0x45, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x46, 0x6f, 0x72, 0x6d,
