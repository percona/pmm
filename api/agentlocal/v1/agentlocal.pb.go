...
func file_agentlocal_v1_agentlocal_proto_rawDescGZIP() []byte {
	file_agentlocal_v1_agentlocal_proto_rawDescOnce.Do(func() {
		file_agentlocal_v1_agentlocal_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_agentlocal_v1_agentlocal_proto_rawDescData)))
	})
	return []byte(file_agentlocal_v1_agentlocal_proto_rawDescData)
}
