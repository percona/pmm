...
const (
	...
	// Status2OKBodyAgentsInfoItems0AgentTypeAGENTTYPECLICKHOUSEEXPORTER captures enum value "AGENT_TYPE_CLICKHOUSE_EXPORTER"
	Status2OKBodyAgentsInfoItems0AgentTypeAGENTTYPECLICKHOUSEEXPORTER string = "AGENT_TYPE_CLICKHOUSE_EXPORTER"

	// Status2OKBodyAgentsInfoItems0AgentTypeAGENTTYPEQANCLICKHOUSEQUERYLOGAGENT captures enum value "AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT"
	Status2OKBodyAgentsInfoItems0AgentTypeAGENTTYPEQANCLICKHOUSEQUERYLOGAGENT string = "AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT"
)
