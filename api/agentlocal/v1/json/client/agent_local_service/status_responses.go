...
const (
	...
	// StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPERTAPOSTGRESQLAGENT captures enum value "AGENT_TYPE_RTA_POSTGRESQL_AGENT"
	StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPERTAPOSTGRESQLAGENT string = "AGENT_TYPE_RTA_POSTGRESQL_AGENT"
)
