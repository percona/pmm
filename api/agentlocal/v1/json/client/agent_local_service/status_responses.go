...
const (
	...
	// StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPERTAMYSQLAGENT captures enum value "AGENT_TYPE_RTA_MYSQL_AGENT"
	StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPERTAMYSQLAGENT string = "AGENT_TYPE_RTA_MYSQL_AGENT"
)
