...
const (
	...
	// StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPECLICKHOUSEEXPORTER captures enum value "AGENT_TYPE_CLICKHOUSE_EXPORTER"
	StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPECLICKHOUSEEXPORTER string = "AGENT_TYPE_CLICKHOUSE_EXPORTER"

	// StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPEQANCLICKHOUSEQUERYLOGAGENT captures enum value "AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT"
	StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPEQANCLICKHOUSEQUERYLOGAGENT string = "AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT"
)
