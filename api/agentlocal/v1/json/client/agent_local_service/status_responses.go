...
const (
	...
	// StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPEDBLOGWATCHERAGENT captures enum value "AGENT_TYPE_DB_LOG_WATCHER_AGENT"
	StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPEDBLOGWATCHERAGENT string = "AGENT_TYPE_DB_LOG_WATCHER_AGENT"
)
