...
const (
	...
	// StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPEOTELCOLLECTOR captures enum value "AGENT_TYPE_OTEL_COLLECTOR"
	StatusOKBodyAgentsInfoItems0AgentTypeAGENTTYPEOTELCOLLECTOR string = "AGENT_TYPE_OTEL_COLLECTOR"
)
