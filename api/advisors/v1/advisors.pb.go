...
func file_advisors_v1_advisors_proto_rawDescGZIP() []byte {
	file_advisors_v1_advisors_proto_rawDescOnce.Do(func() {
		file_advisors_v1_advisors_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_advisors_v1_advisors_proto_rawDescData)))
	})
	return []byte(file_advisors_v1_advisors_proto_rawDescData)
}
