...
var file_agentlocalpb_agentlocal_proto_rawDesc = string([]byte{
...
var (
	...
	file_agentlocalpb_agentlocal_proto_rawDescData []byte
)

func file_agentlocalpb_agentlocal_proto_rawDescGZIP() []byte {
	file_agentlocalpb_agentlocal_proto_rawDescOnce.Do(func() {
		file_agentlocalpb_agentlocal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agentlocalpb_agentlocal_proto_rawDesc), len(file_agentlocalpb_agentlocal_proto_rawDesc)))
	})
...
func file_agentlocalpb_agentlocal_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_agentlocalpb_agentlocal_proto_rawDesc), len(file_agentlocalpb_agentlocal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
