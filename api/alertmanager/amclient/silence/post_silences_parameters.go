...
func (o *PostSilencesParams) WithSilence(silence *ammodels.PostableSilence) *PostSilencesParams {
	o.SetSilence(silence)
	return o
}

// SetSilence adds the silence to the post silences params
func (o *PostSilencesParams) SetSilence(silence *ammodels.PostableSilence) {
	o.Silence = silence
}
