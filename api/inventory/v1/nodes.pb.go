...
func file_inventory_v1_nodes_proto_rawDescGZIP() []byte {
	file_inventory_v1_nodes_proto_rawDescOnce.Do(func() {
		file_inventory_v1_nodes_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_inventory_v1_nodes_proto_rawDescData)))
	})
	return []byte(file_inventory_v1_nodes_proto_rawDescData)
}
