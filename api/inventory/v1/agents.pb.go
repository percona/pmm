...
const file_inventory_v1_agents_proto_rawDesc = "" +
	...
	"\x13metrics_resolutions\x18\f \x01(\v2\x1a.common.MetricsResolutionsR\x12metricsResolutions\x1a?\n" +
	"\x11CustomLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\a_enableB\x10\n" +
	"\x0e_custom_labelsB\x16\n" +
	"\x14_enable_push_metrics\"\xcf\x03\n" +
	...
	"\fpush_metrics\x18\v \x01(\bR\vpushMetrics\x1a?\n" +
	"\x11CustomLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xaf\x02\n" +
