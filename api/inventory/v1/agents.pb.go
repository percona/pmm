...
const (
	...
	AgentType_AGENT_TYPE_OTEL_COLLECTOR AgentType = 19
)
...
// LogSource represents a single log file to be collected by OTEL Collector.
...
func (x *LogSource) GetParserType() string {
	if x != nil {
		return x.ParserType
	}
	return ""
...
func (x *LogSource) GetAttributes() map[string]string {
	if x != nil {
		return x.Attributes
	}
	return nil
...
type OTELLogsConfig struct {
	...
	LogSources []*LogSource `protobuf:"bytes,2,rep,name=log_sources,json=logSources,proto3" json:"log_sources,omitempty"`
	// Enable syslog receiver.
	EnableSyslog bool `protobuf:"varint,3,opt,name=enable_syslog,json=enableSyslog,proto3" json:"enable_syslog,omitempty"`
	// Port for syslog receiver.
	SyslogPort uint32 `protobuf:"varint,4,opt,name=syslog_port,json=syslogPort,proto3" json:"syslog_port,omitempty"`
	// Enable journald receiver for systemd logs.
	EnableJournald bool `protobuf:"varint,5,opt,name=enable_journald,json=enableJournald,proto3" json:"enable_journald,omitempty"`
	// Systemd units to collect logs from.
	JournaldUnits []string `protobuf:"bytes,6,rep,name=journald_units,json=journaldUnits,proto3" json:"journald_units,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OTELLogsConfig) Reset() {
	*x = OTELLogsConfig{}
...
func (x *OTELLogsConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OTELLogsConfig) ProtoMessage() {}

func (x *OTELLogsConfig) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_agents_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OTELLogsConfig.ProtoReflect.Descriptor instead.
func (*OTELLogsConfig) Descriptor() ([]byte, []int) {
	return file_inventory_v1_agents_proto_rawDescGZIP(), []int{4}
}

func (x *OTELLogsConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *OTELLogsConfig) GetLogSources() []*LogSource {
	if x != nil {
		return x.LogSources
	}
	return nil
...
func (x *OTELLogsConfig) GetEnableSyslog() bool {
	if x != nil {
		return x.EnableSyslog
	}
	return false
}

func (x *OTELLogsConfig) GetSyslogPort() uint32 {
	if x != nil {
		return x.SyslogPort
	}
	return 0
...
func (x *OTELLogsConfig) GetEnableJournald() bool {
	if x != nil {
		return x.EnableJournald
	}
	return false
}

func (x *OTELLogsConfig) GetJournaldUnits() []string {
	if x != nil {
		return x.JournaldUnits
	}
	return nil
}

// OTELCollector runs on Generic or Container Node and collects logs, traces, profiles.
...
type OTELCollector struct {
	...
	LogsConfig *OTELLogsConfig `protobuf:"bytes,5,opt,name=logs_config,json=logsConfig,proto3" json:"logs_config,omitempty"`
	// Actual Agent status.
	...
	// Listen port for scraping metrics.
	ListenPort    uint32 `protobuf:"varint,22,opt,name=listen_port,json=listenPort,proto3" json:"listen_port,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OTELCollector) Reset() {
	*x = OTELCollector{}
...
func (x *OTELCollector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OTELCollector) ProtoMessage() {}

func (x *OTELCollector) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_agents_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OTELCollector.ProtoReflect.Descriptor instead.
func (*OTELCollector) Descriptor() ([]byte, []int) {
	return file_inventory_v1_agents_proto_rawDescGZIP(), []int{5}
}

func (x *OTELCollector) GetAgentId() string {
	if x != nil {
		return x.AgentId
	}
	return ""
...
func (x *OTELCollector) GetPmmAgentId() string {
	if x != nil {
		return x.PmmAgentId
	}
	return ""
...
func (x *OTELCollector) GetDisabled() bool {
	if x != nil {
		return x.Disabled
	}
	return false
...
func (x *OTELCollector) GetCustomLabels() map[string]string {
	if x != nil {
		return x.CustomLabels
	}
	return nil
...
func (x *OTELCollector) GetLogsConfig() *OTELLogsConfig {
	if x != nil {
		return x.LogsConfig
	}
	return nil
...
func (x *OTELCollector) GetStatus() AgentStatus {
	if x != nil {
		return x.Status
	}
	return AgentStatus_AGENT_STATUS_UNSPECIFIED
...
func (x *OTELCollector) GetProcessExecPath() string {
	if x != nil {
		return x.ProcessExecPath
	}
	return ""
...
func (x *OTELCollector) GetListenPort() uint32 {
	if x != nil {
		return x.ListenPort
	}
	return 0
...
type ListAgentsResponse struct {
	...
	OtelCollector                   []*OTELCollector                   `protobuf:"bytes,19,rep,name=otel_collector,json=otelCollector,proto3" json:"otel_collector,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *ListAgentsResponse) GetOtelCollector() []*OTELCollector {
	if x != nil {
...
type GetAgentResponse struct {
	...
	//	*GetAgentResponse_OtelCollector
...
func (x *GetAgentResponse) GetOtelCollector() *OTELCollector {
	if x != nil {
		if x, ok := x.Agent.(*GetAgentResponse_OtelCollector); ok {
			return x.OtelCollector
		}
	}
	return nil
...
type GetAgentResponse_OtelCollector struct {
	OtelCollector *OTELCollector `protobuf:"bytes,19,opt,name=otel_collector,json=otelCollector,proto3,oneof"`
}
...
func (*GetAgentResponse_OtelCollector) isGetAgentResponse_Agent() {}
...
func (x *AddAgentRequest) GetOtelCollector() *AddOTELCollectorParams {
	if x != nil {
		if x, ok := x.Agent.(*AddAgentRequest_OtelCollector); ok {
			return x.OtelCollector
		}
	}
	return nil
...
type AddAgentRequest_OtelCollector struct {
	OtelCollector *AddOTELCollectorParams `protobuf:"bytes,17,opt,name=otel_collector,json=otelCollector,proto3,oneof"`
}
...
func (*AddAgentRequest_OtelCollector) isAddAgentRequest_Agent() {}
...
type AddAgentResponse struct {
	...
	//	*AddAgentResponse_OtelCollector
...
func (x *AddAgentResponse) GetOtelCollector() *OTELCollector {
	if x != nil {
		if x, ok := x.Agent.(*AddAgentResponse_OtelCollector); ok {
			return x.OtelCollector
		}
	}
	return nil
...
type AddAgentResponse_OtelCollector struct {
	OtelCollector *OTELCollector `protobuf:"bytes,17,opt,name=otel_collector,json=otelCollector,proto3,oneof"`
}
...
func (*AddAgentResponse_OtelCollector) isAddAgentResponse_Agent() {}
...
type ChangeAgentRequest struct {
	...
	//	*ChangeAgentRequest_OtelCollector
...
func (x *ChangeAgentRequest) GetOtelCollector() *ChangeOTELCollectorParams {
	if x != nil {
		if x, ok := x.Agent.(*ChangeAgentRequest_OtelCollector); ok {
			return x.OtelCollector
		}
	}
	return nil
...
type ChangeAgentRequest_OtelCollector struct {
	OtelCollector *ChangeOTELCollectorParams `protobuf:"bytes,18,opt,name=otel_collector,json=otelCollector,proto3,oneof"`
}
...
func (*ChangeAgentRequest_OtelCollector) isChangeAgentRequest_Agent() {}
...
type ChangeAgentResponse struct {
	...
	//	*ChangeAgentResponse_OtelCollector
...
func (x *ChangeAgentResponse) GetOtelCollector() *OTELCollector {
	if x != nil {
		if x, ok := x.Agent.(*ChangeAgentResponse_OtelCollector); ok {
			return x.OtelCollector
		}
	}
	return nil
...
type ChangeAgentResponse_OtelCollector struct {
	OtelCollector *OTELCollector `protobuf:"bytes,18,opt,name=otel_collector,json=otelCollector,proto3,oneof"`
}
...
func (*ChangeAgentResponse_OtelCollector) isChangeAgentResponse_Agent() {}
...
type AddOTELCollectorParams struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The pmm-agent identifier which runs this instance.
	PmmAgentId string `protobuf:"bytes,1,opt,name=pmm_agent_id,json=pmmAgentId,proto3" json:"pmm_agent_id,omitempty"`
	// Custom user-assigned labels.
	CustomLabels map[string]string `protobuf:"bytes,2,rep,name=custom_labels,json=customLabels,proto3" json:"custom_labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Configuration for logs collection.
	LogsConfig    *OTELLogsConfig `protobuf:"bytes,3,opt,name=logs_config,json=logsConfig,proto3" json:"logs_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AddOTELCollectorParams) Reset() {
	*x = AddOTELCollectorParams{}
	mi := &file_inventory_v1_agents_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AddOTELCollectorParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddOTELCollectorParams) ProtoMessage() {}

func (x *AddOTELCollectorParams) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_agents_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddOTELCollectorParams.ProtoReflect.Descriptor instead.
func (*AddOTELCollectorParams) Descriptor() ([]byte, []int) {
	return file_inventory_v1_agents_proto_rawDescGZIP(), []int{64}
}

func (x *AddOTELCollectorParams) GetPmmAgentId() string {
	if x != nil {
		return x.PmmAgentId
	}
	return ""
...
func (x *AddOTELCollectorParams) GetCustomLabels() map[string]string {
	if x != nil {
		return x.CustomLabels
	}
	return nil
...
func (x *AddOTELCollectorParams) GetLogsConfig() *OTELLogsConfig {
	if x != nil {
		return x.LogsConfig
	}
	return nil
...
func (x *ChangeOTELCollectorParams) Reset() {
	*x = ChangeOTELCollectorParams{}
	mi := &file_inventory_v1_agents_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChangeOTELCollectorParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeOTELCollectorParams) ProtoMessage() {}

func (x *ChangeOTELCollectorParams) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_agents_proto_msgTypes[65]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeOTELCollectorParams.ProtoReflect.Descriptor instead.
func (*ChangeOTELCollectorParams) Descriptor() ([]byte, []int) {
	return file_inventory_v1_agents_proto_rawDescGZIP(), []int{65}
}

func (x *ChangeOTELCollectorParams) GetEnable() bool {
	if x != nil && x.Enable != nil {
		return *x.Enable
	}
	return false
...
func (x *ChangeOTELCollectorParams) GetCustomLabels() *common.StringMap {
	if x != nil {
		return x.CustomLabels
	}
	return nil
...
func (x *ChangeOTELCollectorParams) GetLogsConfig() *OTELLogsConfig {
	if x != nil {
		return x.LogsConfig
	}
	return nil
...
const file_inventory_v1_agents_proto_rawDesc = "" +
	...
	"\x11process_exec_path\x18\v \x01(\tR\x0fprocessExecPath\x12\x1f\n" +
	"\vlisten_port\x18\f \x01(\rR\n" +
	"listenPortJ\x04\b\x04\x10\x05\"\xeb\x01\n" +
	"\tLogSource\x12\x12\n" +
	...
	"parserType\x12G\n" +
	"\n" +
	"attributes\x18\x04 \x03(\v2'.inventory.v1.LogSource.AttributesEntryR\n" +
	"attributes\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xfa\x01\n" +
	"\x0eOTELLogsConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x128\n" +
	"\vlog_sources\x18\x02 \x03(\v2\x17.inventory.v1.LogSourceR\n" +
	"logSources\x12#\n" +
	"\renable_syslog\x18\x03 \x01(\bR\fenableSyslog\x12\x1f\n" +
	"\vsyslog_port\x18\x04 \x01(\rR\n" +
	"syslogPort\x12'\n" +
	"\x0fenable_journald\x18\x05 \x01(\bR\x0eenableJournald\x12%\n" +
	"\x0ejournald_units\x18\x06 \x03(\tR\rjournaldUnits\"\xbc\x03\n" +
	"\rOTELCollector\x12\x19\n" +
	"\bagent_id\x18\x01 \x01(\tR\aagentId\x12 \n" +
	"\fpmm_agent_id\x18\x02 \x01(\tR\n" +
	"pmmAgentId\x12\x1a\n" +
	"\bdisabled\x18\x03 \x01(\bR\bdisabled\x12R\n" +
	"\rcustom_labels\x18\x04 \x03(\v2-.inventory.v1.OTELCollector.CustomLabelsEntryR\fcustomLabels\x12=\n" +
	"\vlogs_config\x18\x05 \x01(\v2\x1c.inventory.v1.OTELLogsConfigR\n" +
	"logsConfig\x121\n" +
	"\x06status\x18\x14 \x01(\x0e2\x19.inventory.v1.AgentStatusR\x06status\x12*\n" +
	"\x11process_exec_path\x18\x15 \x01(\tR\x0fprocessExecPath\x12\x1f\n" +
	"\vlisten_port\x18\x16 \x01(\rR\n" +
	"listenPort\x1a?\n" +
	"\x11CustomLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\n" +
	"agent_type\x18\x04 \x01(\x0e2\x17.inventory.v1.AgentTypeR\tagentType\"\x91\f\n" +
	...
	"nomadAgent\x12E\n" +
	"\x0fvalkey_exporter\x18\x11 \x03(\v2\x1c.inventory.v1.ValkeyExporterR\x0evalkeyExporter\x12B\n" +
	"\x0eotel_collector\x18\x13 \x03(\v2\x1b.inventory.v1.OTELCollectorR\rotelCollector\"5\n" +
	"\x0fGetAgentRequest\x12\"\n" +
	"\bagent_id\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10$R\aagentId\"\xbd\f\n" +
	...
	"nomadAgent\x12G\n" +
	"\x0fvalkey_exporter\x18\x11 \x01(\v2\x1c.inventory.v1.ValkeyExporterH\x00R\x0evalkeyExporter\x12D\n" +
	...
	"\x1cagent_config_log_lines_count\x18\x02 \x01(\rR\x18agentConfigLogLinesCount\"\xe7\f\n" +
	...
	"\x0fvalkey_exporter\x18\x0f \x01(\v2%.inventory.v1.AddValkeyExporterParamsH\x00R\x0evalkeyExporter\x12M\n" +
	"\x0eotel_collector\x18\x11 \x01(\v2$.inventory.v1.AddOTELCollectorParamsH\x00R\rotelCollectorB\a\n" +
	"\x05agent\"\xcd\v\n" +
	...
	"\x0fvalkey_exporter\x18\x0f \x01(\v2\x1c.inventory.v1.ValkeyExporterH\x00R\x0evalkeyExporter\x12D\n" +
	"\x0eotel_collector\x18\x11 \x01(\v2\x1b.inventory.v1.OTELCollectorH\x00R\rotelCollectorB\a\n" +
	"\x05agent\"\xc7\r\n" +
	...
	"nomadAgent\x12S\n" +
	"\x0fvalkey_exporter\x18\x10 \x01(\v2(.inventory.v1.ChangeValkeyExporterParamsH\x00R\x0evalkeyExporter\x12P\n" +
	"\x0eotel_collector\x18\x12 \x01(\v2'.inventory.v1.ChangeOTELCollectorParamsH\x00R\rotelCollectorB\a\n" +
	"\x05agent\"\xd6\v\n" +
	...
	"nomadAgent\x12G\n" +
	"\x0fvalkey_exporter\x18\x10 \x01(\v2\x1c.inventory.v1.ValkeyExporterH\x00R\x0evalkeyExporter\x12D\n" +
	...
	"\a_enableB\x10\n" +
	"\x0e_custom_labelsB\x16\n" +
	"\x14_enable_push_metrics\"\xa0\x02\n" +
	...
	"\vlogs_config\x18\x03 \x01(\v2\x1c.inventory.v1.OTELLogsConfigR\n" +
	"logsConfig\x1a?\n" +
	"\x11CustomLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x06enable\x18\x01 \x01(\bH\x00R\x06enable\x88\x01\x01\x12;\n" +
	"\rcustom_labels\x18\x02 \x01(\v2\x11.common.StringMapH\x01R\fcustomLabels\x88\x01\x01\x12=\n" +
	"\vlogs_config\x18\x03 \x01(\v2\x1c.inventory.v1.OTELLogsConfigR\n" +
	"logsConfigB\t\n" +
	"\a_enableB\x10\n" +
	"\x0e_custom_labels\"N\n" +
	...
	"\x13RemoveAgentResponse*\xcd\x05\n" +
	"\tAgentType\x12\x1a\n" +
	...
	"\x16AGENT_TYPE_NOMAD_AGENT\x10\x10\x12\x1d\n" +
	"\x19AGENT_TYPE_OTEL_COLLECTOR\x10\x132\x83\t\n" +
...
var (
	...
	file_inventory_v1_agents_proto_msgTypes  = make([]protoimpl.MessageInfo, 109)
	file_inventory_v1_agents_proto_goTypes   = []any{
		...
		(*LogSource)(nil),                                   // 4: inventory.v1.LogSource
		(*OTELLogsConfig)(nil),                              // 5: inventory.v1.OTELLogsConfig
		(*OTELCollector)(nil),                               // 6: inventory.v1.OTELCollector
		(*NodeExporter)(nil),                                // 7: inventory.v1.NodeExporter
		(*MySQLdExporter)(nil),                              // 8: inventory.v1.MySQLdExporter
		(*MongoDBExporter)(nil),                             // 9: inventory.v1.MongoDBExporter
		(*PostgresExporter)(nil),                            // 10: inventory.v1.PostgresExporter
		(*ProxySQLExporter)(nil),                            // 11: inventory.v1.ProxySQLExporter
		(*ValkeyExporter)(nil),                              // 12: inventory.v1.ValkeyExporter
		(*QANMySQLPerfSchemaAgent)(nil),                     // 13: inventory.v1.QANMySQLPerfSchemaAgent
		(*QANMySQLSlowlogAgent)(nil),                        // 14: inventory.v1.QANMySQLSlowlogAgent
		(*QANMongoDBProfilerAgent)(nil),                     // 15: inventory.v1.QANMongoDBProfilerAgent
		(*QANMongoDBMongologAgent)(nil),                     // 16: inventory.v1.QANMongoDBMongologAgent
		...
		(*AddOTELCollectorParams)(nil),                      // 65: inventory.v1.AddOTELCollectorParams
		(*ChangeOTELCollectorParams)(nil),                   // 66: inventory.v1.ChangeOTELCollectorParams
		(*RemoveAgentRequest)(nil),                          // 67: inventory.v1.RemoveAgentRequest
		(*RemoveAgentResponse)(nil),                         // 68: inventory.v1.RemoveAgentResponse
		nil,                                                 // 69: inventory.v1.PMMAgent.CustomLabelsEntry
		nil,                                                 // 70: inventory.v1.LogSource.AttributesEntry
		nil,                                                 // 71: inventory.v1.OTELCollector.CustomLabelsEntry
		...
		nil,                                                 // 85: inventory.v1.QANPostgreSQLPgStatementsAgent.CustomLabelsEntry
		nil,                                                 // 86: inventory.v1.QANPostgreSQLPgStatMonitorAgent.CustomLabelsEntry
		nil,                                                 // 87: inventory.v1.RDSExporter.CustomLabelsEntry
		nil,                                                 // 88: inventory.v1.ExternalExporter.CustomLabelsEntry
		nil,                                                 // 89: inventory.v1.AzureDatabaseExporter.CustomLabelsEntry
		nil,                                                 // 90: inventory.v1.AddPMMAgentParams.CustomLabelsEntry
		nil,                                                 // 91: inventory.v1.AddNodeExporterParams.CustomLabelsEntry
		nil,                                                 // 92: inventory.v1.AddMySQLdExporterParams.CustomLabelsEntry
		nil,                                                 // 93: inventory.v1.AddMySQLdExporterParams.ExtraDsnParamsEntry
		nil,                                                 // 94: inventory.v1.AddMongoDBExporterParams.CustomLabelsEntry
		nil,                                                 // 95: inventory.v1.AddPostgresExporterParams.CustomLabelsEntry
		nil,                                                 // 96: inventory.v1.AddProxySQLExporterParams.CustomLabelsEntry
		nil,                                                 // 97: inventory.v1.AddQANMySQLPerfSchemaAgentParams.CustomLabelsEntry
		nil,                                                 // 98: inventory.v1.AddQANMySQLPerfSchemaAgentParams.ExtraDsnParamsEntry
		nil,                                                 // 99: inventory.v1.AddQANMySQLSlowlogAgentParams.CustomLabelsEntry
		nil,                                                 // 100: inventory.v1.AddQANMySQLSlowlogAgentParams.ExtraDsnParamsEntry
		nil,                                                 // 101: inventory.v1.AddQANMongoDBProfilerAgentParams.CustomLabelsEntry
		nil,                                                 // 102: inventory.v1.AddQANMongoDBMongologAgentParams.CustomLabelsEntry
		nil,                                                 // 103: inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.CustomLabelsEntry
		nil,                                                 // 104: inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.CustomLabelsEntry
		nil,                                                 // 105: inventory.v1.AddRDSExporterParams.CustomLabelsEntry
		nil,                                                 // 106: inventory.v1.AddExternalExporterParams.CustomLabelsEntry
		nil,                                                 // 107: inventory.v1.AddAzureDatabaseExporterParams.CustomLabelsEntry
		nil,                                                 // 108: inventory.v1.AddValkeyExporterParams.CustomLabelsEntry
		nil,                                                 // 109: inventory.v1.AddOTELCollectorParams.CustomLabelsEntry
		(AgentStatus)(0),                                    // 110: inventory.v1.AgentStatus
		(LogLevel)(0),                                       // 111: inventory.v1.LogLevel
		(*common.MetricsResolutions)(nil),                   // 112: common.MetricsResolutions
		(*common.StringMap)(nil),                            // 113: common.StringMap
	}
)

var file_inventory_v1_agents_proto_depIdxs = []int32{
	69,  // 0: inventory.v1.PMMAgent.custom_labels:type_name -> inventory.v1.PMMAgent.CustomLabelsEntry
	110, // 1: inventory.v1.VMAgent.status:type_name -> inventory.v1.AgentStatus
	110, // 2: inventory.v1.NomadAgent.status:type_name -> inventory.v1.AgentStatus
	70,  // 3: inventory.v1.LogSource.attributes:type_name -> inventory.v1.LogSource.AttributesEntry
	4,   // 4: inventory.v1.OTELLogsConfig.log_sources:type_name -> inventory.v1.LogSource
	71,  // 5: inventory.v1.OTELCollector.custom_labels:type_name -> inventory.v1.OTELCollector.CustomLabelsEntry
	5,   // 6: inventory.v1.OTELCollector.logs_config:type_name -> inventory.v1.OTELLogsConfig
	110, // 7: inventory.v1.OTELCollector.status:type_name -> inventory.v1.AgentStatus
	72,  // 8: inventory.v1.NodeExporter.custom_labels:type_name -> inventory.v1.NodeExporter.CustomLabelsEntry
	110, // 9: inventory.v1.NodeExporter.status:type_name -> inventory.v1.AgentStatus
	111, // 10: inventory.v1.NodeExporter.log_level:type_name -> inventory.v1.LogLevel
	112, // 11: inventory.v1.NodeExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	73,  // 12: inventory.v1.MySQLdExporter.custom_labels:type_name -> inventory.v1.MySQLdExporter.CustomLabelsEntry
	110, // 13: inventory.v1.MySQLdExporter.status:type_name -> inventory.v1.AgentStatus
	111, // 14: inventory.v1.MySQLdExporter.log_level:type_name -> inventory.v1.LogLevel
	112, // 15: inventory.v1.MySQLdExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	74,  // 16: inventory.v1.MySQLdExporter.extra_dsn_params:type_name -> inventory.v1.MySQLdExporter.ExtraDsnParamsEntry
	75,  // 17: inventory.v1.MongoDBExporter.custom_labels:type_name -> inventory.v1.MongoDBExporter.CustomLabelsEntry
	110, // 18: inventory.v1.MongoDBExporter.status:type_name -> inventory.v1.AgentStatus
	111, // 19: inventory.v1.MongoDBExporter.log_level:type_name -> inventory.v1.LogLevel
	112, // 20: inventory.v1.MongoDBExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	76,  // 21: inventory.v1.PostgresExporter.custom_labels:type_name -> inventory.v1.PostgresExporter.CustomLabelsEntry
	110, // 22: inventory.v1.PostgresExporter.status:type_name -> inventory.v1.AgentStatus
	111, // 23: inventory.v1.PostgresExporter.log_level:type_name -> inventory.v1.LogLevel
	112, // 24: inventory.v1.PostgresExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	77,  // 25: inventory.v1.ProxySQLExporter.custom_labels:type_name -> inventory.v1.ProxySQLExporter.CustomLabelsEntry
	110, // 26: inventory.v1.ProxySQLExporter.status:type_name -> inventory.v1.AgentStatus
	111, // 27: inventory.v1.ProxySQLExporter.log_level:type_name -> inventory.v1.LogLevel
	112, // 28: inventory.v1.ProxySQLExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	78,  // 29: inventory.v1.ValkeyExporter.custom_labels:type_name -> inventory.v1.ValkeyExporter.CustomLabelsEntry
	110, // 30: inventory.v1.ValkeyExporter.status:type_name -> inventory.v1.AgentStatus
	112, // 31: inventory.v1.ValkeyExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	...
	110, // 33: inventory.v1.QANMySQLPerfSchemaAgent.status:type_name -> inventory.v1.AgentStatus
	111, // 34: inventory.v1.QANMySQLPerfSchemaAgent.log_level:type_name -> inventory.v1.LogLevel
	...
	110, // 37: inventory.v1.QANMySQLSlowlogAgent.status:type_name -> inventory.v1.AgentStatus
	111, // 38: inventory.v1.QANMySQLSlowlogAgent.log_level:type_name -> inventory.v1.LogLevel
	...
	110, // 41: inventory.v1.QANMongoDBProfilerAgent.status:type_name -> inventory.v1.AgentStatus
	111, // 42: inventory.v1.QANMongoDBProfilerAgent.log_level:type_name -> inventory.v1.LogLevel
	...
	110, // 44: inventory.v1.QANMongoDBMongologAgent.status:type_name -> inventory.v1.AgentStatus
	111, // 45: inventory.v1.QANMongoDBMongologAgent.log_level:type_name -> inventory.v1.LogLevel
	85,  // 46: inventory.v1.QANPostgreSQLPgStatementsAgent.custom_labels:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent.CustomLabelsEntry
	110, // 47: inventory.v1.QANPostgreSQLPgStatementsAgent.status:type_name -> inventory.v1.AgentStatus
	111, // 48: inventory.v1.QANPostgreSQLPgStatementsAgent.log_level:type_name -> inventory.v1.LogLevel
	86,  // 49: inventory.v1.QANPostgreSQLPgStatMonitorAgent.custom_labels:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent.CustomLabelsEntry
	110, // 50: inventory.v1.QANPostgreSQLPgStatMonitorAgent.status:type_name -> inventory.v1.AgentStatus
	111, // 51: inventory.v1.QANPostgreSQLPgStatMonitorAgent.log_level:type_name -> inventory.v1.LogLevel
	87,  // 52: inventory.v1.RDSExporter.custom_labels:type_name -> inventory.v1.RDSExporter.CustomLabelsEntry
	110, // 53: inventory.v1.RDSExporter.status:type_name -> inventory.v1.AgentStatus
	111, // 54: inventory.v1.RDSExporter.log_level:type_name -> inventory.v1.LogLevel
	112, // 55: inventory.v1.RDSExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	88,  // 56: inventory.v1.ExternalExporter.custom_labels:type_name -> inventory.v1.ExternalExporter.CustomLabelsEntry
	112, // 57: inventory.v1.ExternalExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	89,  // 58: inventory.v1.AzureDatabaseExporter.custom_labels:type_name -> inventory.v1.AzureDatabaseExporter.CustomLabelsEntry
	110, // 59: inventory.v1.AzureDatabaseExporter.status:type_name -> inventory.v1.AgentStatus
	111, // 60: inventory.v1.AzureDatabaseExporter.log_level:type_name -> inventory.v1.LogLevel
	112, // 61: inventory.v1.AzureDatabaseExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	113, // 62: inventory.v1.ChangeCommonAgentParams.custom_labels:type_name -> common.StringMap
	112, // 63: inventory.v1.ChangeCommonAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	0,   // 64: inventory.v1.ListAgentsRequest.agent_type:type_name -> inventory.v1.AgentType
	1,   // 65: inventory.v1.ListAgentsResponse.pmm_agent:type_name -> inventory.v1.PMMAgent
	2,   // 66: inventory.v1.ListAgentsResponse.vm_agent:type_name -> inventory.v1.VMAgent
	7,   // 67: inventory.v1.ListAgentsResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	8,   // 68: inventory.v1.ListAgentsResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	9,   // 69: inventory.v1.ListAgentsResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	10,  // 70: inventory.v1.ListAgentsResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	11,  // 71: inventory.v1.ListAgentsResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	13,  // 72: inventory.v1.ListAgentsResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 73: inventory.v1.ListAgentsResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 74: inventory.v1.ListAgentsResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 75: inventory.v1.ListAgentsResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	17,  // 76: inventory.v1.ListAgentsResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	18,  // 77: inventory.v1.ListAgentsResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	20,  // 78: inventory.v1.ListAgentsResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	19,  // 79: inventory.v1.ListAgentsResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	21,  // 80: inventory.v1.ListAgentsResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	3,   // 81: inventory.v1.ListAgentsResponse.nomad_agent:type_name -> inventory.v1.NomadAgent
	12,  // 82: inventory.v1.ListAgentsResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	6,   // 83: inventory.v1.ListAgentsResponse.otel_collector:type_name -> inventory.v1.OTELCollector
	1,   // 84: inventory.v1.GetAgentResponse.pmm_agent:type_name -> inventory.v1.PMMAgent
	2,   // 85: inventory.v1.GetAgentResponse.vmagent:type_name -> inventory.v1.VMAgent
	7,   // 86: inventory.v1.GetAgentResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	8,   // 87: inventory.v1.GetAgentResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	9,   // 88: inventory.v1.GetAgentResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	10,  // 89: inventory.v1.GetAgentResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	11,  // 90: inventory.v1.GetAgentResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	13,  // 91: inventory.v1.GetAgentResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 92: inventory.v1.GetAgentResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 93: inventory.v1.GetAgentResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 94: inventory.v1.GetAgentResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	17,  // 95: inventory.v1.GetAgentResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	18,  // 96: inventory.v1.GetAgentResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	20,  // 97: inventory.v1.GetAgentResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	19,  // 98: inventory.v1.GetAgentResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	21,  // 99: inventory.v1.GetAgentResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	3,   // 100: inventory.v1.GetAgentResponse.nomad_agent:type_name -> inventory.v1.NomadAgent
	12,  // 101: inventory.v1.GetAgentResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	6,   // 102: inventory.v1.GetAgentResponse.otel_collector:type_name -> inventory.v1.OTELCollector
	33,  // 103: inventory.v1.AddAgentRequest.pmm_agent:type_name -> inventory.v1.AddPMMAgentParams
	34,  // 104: inventory.v1.AddAgentRequest.node_exporter:type_name -> inventory.v1.AddNodeExporterParams
	36,  // 105: inventory.v1.AddAgentRequest.mysqld_exporter:type_name -> inventory.v1.AddMySQLdExporterParams
	38,  // 106: inventory.v1.AddAgentRequest.mongodb_exporter:type_name -> inventory.v1.AddMongoDBExporterParams
	40,  // 107: inventory.v1.AddAgentRequest.postgres_exporter:type_name -> inventory.v1.AddPostgresExporterParams
	42,  // 108: inventory.v1.AddAgentRequest.proxysql_exporter:type_name -> inventory.v1.AddProxySQLExporterParams
	58,  // 109: inventory.v1.AddAgentRequest.external_exporter:type_name -> inventory.v1.AddExternalExporterParams
	56,  // 110: inventory.v1.AddAgentRequest.rds_exporter:type_name -> inventory.v1.AddRDSExporterParams
	60,  // 111: inventory.v1.AddAgentRequest.azure_database_exporter:type_name -> inventory.v1.AddAzureDatabaseExporterParams
	44,  // 112: inventory.v1.AddAgentRequest.qan_mysql_perfschema_agent:type_name -> inventory.v1.AddQANMySQLPerfSchemaAgentParams
	46,  // 113: inventory.v1.AddAgentRequest.qan_mysql_slowlog_agent:type_name -> inventory.v1.AddQANMySQLSlowlogAgentParams
	48,  // 114: inventory.v1.AddAgentRequest.qan_mongodb_profiler_agent:type_name -> inventory.v1.AddQANMongoDBProfilerAgentParams
	50,  // 115: inventory.v1.AddAgentRequest.qan_mongodb_mongolog_agent:type_name -> inventory.v1.AddQANMongoDBMongologAgentParams
	52,  // 116: inventory.v1.AddAgentRequest.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.AddQANPostgreSQLPgStatementsAgentParams
	54,  // 117: inventory.v1.AddAgentRequest.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams
	63,  // 118: inventory.v1.AddAgentRequest.valkey_exporter:type_name -> inventory.v1.AddValkeyExporterParams
	65,  // 119: inventory.v1.AddAgentRequest.otel_collector:type_name -> inventory.v1.AddOTELCollectorParams
	1,   // 120: inventory.v1.AddAgentResponse.pmm_agent:type_name -> inventory.v1.PMMAgent
	7,   // 121: inventory.v1.AddAgentResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	8,   // 122: inventory.v1.AddAgentResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	9,   // 123: inventory.v1.AddAgentResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	10,  // 124: inventory.v1.AddAgentResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	11,  // 125: inventory.v1.AddAgentResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	20,  // 126: inventory.v1.AddAgentResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	19,  // 127: inventory.v1.AddAgentResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	21,  // 128: inventory.v1.AddAgentResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	13,  // 129: inventory.v1.AddAgentResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 130: inventory.v1.AddAgentResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 131: inventory.v1.AddAgentResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 132: inventory.v1.AddAgentResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	17,  // 133: inventory.v1.AddAgentResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	18,  // 134: inventory.v1.AddAgentResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	12,  // 135: inventory.v1.AddAgentResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	6,   // 136: inventory.v1.AddAgentResponse.otel_collector:type_name -> inventory.v1.OTELCollector
	35,  // 137: inventory.v1.ChangeAgentRequest.node_exporter:type_name -> inventory.v1.ChangeNodeExporterParams
	37,  // 138: inventory.v1.ChangeAgentRequest.mysqld_exporter:type_name -> inventory.v1.ChangeMySQLdExporterParams
	39,  // 139: inventory.v1.ChangeAgentRequest.mongodb_exporter:type_name -> inventory.v1.ChangeMongoDBExporterParams
	41,  // 140: inventory.v1.ChangeAgentRequest.postgres_exporter:type_name -> inventory.v1.ChangePostgresExporterParams
	43,  // 141: inventory.v1.ChangeAgentRequest.proxysql_exporter:type_name -> inventory.v1.ChangeProxySQLExporterParams
	59,  // 142: inventory.v1.ChangeAgentRequest.external_exporter:type_name -> inventory.v1.ChangeExternalExporterParams
	57,  // 143: inventory.v1.ChangeAgentRequest.rds_exporter:type_name -> inventory.v1.ChangeRDSExporterParams
	61,  // 144: inventory.v1.ChangeAgentRequest.azure_database_exporter:type_name -> inventory.v1.ChangeAzureDatabaseExporterParams
	45,  // 145: inventory.v1.ChangeAgentRequest.qan_mysql_perfschema_agent:type_name -> inventory.v1.ChangeQANMySQLPerfSchemaAgentParams
	47,  // 146: inventory.v1.ChangeAgentRequest.qan_mysql_slowlog_agent:type_name -> inventory.v1.ChangeQANMySQLSlowlogAgentParams
	49,  // 147: inventory.v1.ChangeAgentRequest.qan_mongodb_profiler_agent:type_name -> inventory.v1.ChangeQANMongoDBProfilerAgentParams
	51,  // 148: inventory.v1.ChangeAgentRequest.qan_mongodb_mongolog_agent:type_name -> inventory.v1.ChangeQANMongoDBMongologAgentParams
	53,  // 149: inventory.v1.ChangeAgentRequest.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams
	55,  // 150: inventory.v1.ChangeAgentRequest.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams
	62,  // 151: inventory.v1.ChangeAgentRequest.nomad_agent:type_name -> inventory.v1.ChangeNomadAgentParams
	64,  // 152: inventory.v1.ChangeAgentRequest.valkey_exporter:type_name -> inventory.v1.ChangeValkeyExporterParams
	66,  // 153: inventory.v1.ChangeAgentRequest.otel_collector:type_name -> inventory.v1.ChangeOTELCollectorParams
	7,   // 154: inventory.v1.ChangeAgentResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	8,   // 155: inventory.v1.ChangeAgentResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	9,   // 156: inventory.v1.ChangeAgentResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	10,  // 157: inventory.v1.ChangeAgentResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	11,  // 158: inventory.v1.ChangeAgentResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	20,  // 159: inventory.v1.ChangeAgentResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	19,  // 160: inventory.v1.ChangeAgentResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	21,  // 161: inventory.v1.ChangeAgentResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	13,  // 162: inventory.v1.ChangeAgentResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 163: inventory.v1.ChangeAgentResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 164: inventory.v1.ChangeAgentResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 165: inventory.v1.ChangeAgentResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	17,  // 166: inventory.v1.ChangeAgentResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	18,  // 167: inventory.v1.ChangeAgentResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	3,   // 168: inventory.v1.ChangeAgentResponse.nomad_agent:type_name -> inventory.v1.NomadAgent
	12,  // 169: inventory.v1.ChangeAgentResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	6,   // 170: inventory.v1.ChangeAgentResponse.otel_collector:type_name -> inventory.v1.OTELCollector
	90,  // 171: inventory.v1.AddPMMAgentParams.custom_labels:type_name -> inventory.v1.AddPMMAgentParams.CustomLabelsEntry
	91,  // 172: inventory.v1.AddNodeExporterParams.custom_labels:type_name -> inventory.v1.AddNodeExporterParams.CustomLabelsEntry
	111, // 173: inventory.v1.AddNodeExporterParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 174: inventory.v1.ChangeNodeExporterParams.custom_labels:type_name -> common.StringMap
	112, // 175: inventory.v1.ChangeNodeExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	92,  // 176: inventory.v1.AddMySQLdExporterParams.custom_labels:type_name -> inventory.v1.AddMySQLdExporterParams.CustomLabelsEntry
	111, // 177: inventory.v1.AddMySQLdExporterParams.log_level:type_name -> inventory.v1.LogLevel
	93,  // 178: inventory.v1.AddMySQLdExporterParams.extra_dsn_params:type_name -> inventory.v1.AddMySQLdExporterParams.ExtraDsnParamsEntry
	113, // 179: inventory.v1.ChangeMySQLdExporterParams.custom_labels:type_name -> common.StringMap
	112, // 180: inventory.v1.ChangeMySQLdExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	94,  // 181: inventory.v1.AddMongoDBExporterParams.custom_labels:type_name -> inventory.v1.AddMongoDBExporterParams.CustomLabelsEntry
	111, // 182: inventory.v1.AddMongoDBExporterParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 183: inventory.v1.ChangeMongoDBExporterParams.custom_labels:type_name -> common.StringMap
	112, // 184: inventory.v1.ChangeMongoDBExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	95,  // 185: inventory.v1.AddPostgresExporterParams.custom_labels:type_name -> inventory.v1.AddPostgresExporterParams.CustomLabelsEntry
	111, // 186: inventory.v1.AddPostgresExporterParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 187: inventory.v1.ChangePostgresExporterParams.custom_labels:type_name -> common.StringMap
	112, // 188: inventory.v1.ChangePostgresExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	96,  // 189: inventory.v1.AddProxySQLExporterParams.custom_labels:type_name -> inventory.v1.AddProxySQLExporterParams.CustomLabelsEntry
	111, // 190: inventory.v1.AddProxySQLExporterParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 191: inventory.v1.ChangeProxySQLExporterParams.custom_labels:type_name -> common.StringMap
	112, // 192: inventory.v1.ChangeProxySQLExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	97,  // 193: inventory.v1.AddQANMySQLPerfSchemaAgentParams.custom_labels:type_name -> inventory.v1.AddQANMySQLPerfSchemaAgentParams.CustomLabelsEntry
	111, // 194: inventory.v1.AddQANMySQLPerfSchemaAgentParams.log_level:type_name -> inventory.v1.LogLevel
	98,  // 195: inventory.v1.AddQANMySQLPerfSchemaAgentParams.extra_dsn_params:type_name -> inventory.v1.AddQANMySQLPerfSchemaAgentParams.ExtraDsnParamsEntry
	113, // 196: inventory.v1.ChangeQANMySQLPerfSchemaAgentParams.custom_labels:type_name -> common.StringMap
	112, // 197: inventory.v1.ChangeQANMySQLPerfSchemaAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	99,  // 198: inventory.v1.AddQANMySQLSlowlogAgentParams.custom_labels:type_name -> inventory.v1.AddQANMySQLSlowlogAgentParams.CustomLabelsEntry
	111, // 199: inventory.v1.AddQANMySQLSlowlogAgentParams.log_level:type_name -> inventory.v1.LogLevel
	100, // 200: inventory.v1.AddQANMySQLSlowlogAgentParams.extra_dsn_params:type_name -> inventory.v1.AddQANMySQLSlowlogAgentParams.ExtraDsnParamsEntry
	113, // 201: inventory.v1.ChangeQANMySQLSlowlogAgentParams.custom_labels:type_name -> common.StringMap
	112, // 202: inventory.v1.ChangeQANMySQLSlowlogAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	101, // 203: inventory.v1.AddQANMongoDBProfilerAgentParams.custom_labels:type_name -> inventory.v1.AddQANMongoDBProfilerAgentParams.CustomLabelsEntry
	111, // 204: inventory.v1.AddQANMongoDBProfilerAgentParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 205: inventory.v1.ChangeQANMongoDBProfilerAgentParams.custom_labels:type_name -> common.StringMap
	112, // 206: inventory.v1.ChangeQANMongoDBProfilerAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	102, // 207: inventory.v1.AddQANMongoDBMongologAgentParams.custom_labels:type_name -> inventory.v1.AddQANMongoDBMongologAgentParams.CustomLabelsEntry
	111, // 208: inventory.v1.AddQANMongoDBMongologAgentParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 209: inventory.v1.ChangeQANMongoDBMongologAgentParams.custom_labels:type_name -> common.StringMap
	112, // 210: inventory.v1.ChangeQANMongoDBMongologAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	103, // 211: inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.custom_labels:type_name -> inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.CustomLabelsEntry
	111, // 212: inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 213: inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams.custom_labels:type_name -> common.StringMap
	112, // 214: inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	104, // 215: inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.custom_labels:type_name -> inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.CustomLabelsEntry
	111, // 216: inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 217: inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams.custom_labels:type_name -> common.StringMap
	112, // 218: inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	105, // 219: inventory.v1.AddRDSExporterParams.custom_labels:type_name -> inventory.v1.AddRDSExporterParams.CustomLabelsEntry
	111, // 220: inventory.v1.AddRDSExporterParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 221: inventory.v1.ChangeRDSExporterParams.custom_labels:type_name -> common.StringMap
	112, // 222: inventory.v1.ChangeRDSExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	106, // 223: inventory.v1.AddExternalExporterParams.custom_labels:type_name -> inventory.v1.AddExternalExporterParams.CustomLabelsEntry
	113, // 224: inventory.v1.ChangeExternalExporterParams.custom_labels:type_name -> common.StringMap
	112, // 225: inventory.v1.ChangeExternalExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	107, // 226: inventory.v1.AddAzureDatabaseExporterParams.custom_labels:type_name -> inventory.v1.AddAzureDatabaseExporterParams.CustomLabelsEntry
	111, // 227: inventory.v1.AddAzureDatabaseExporterParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 228: inventory.v1.ChangeAzureDatabaseExporterParams.custom_labels:type_name -> common.StringMap
	112, // 229: inventory.v1.ChangeAzureDatabaseExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	108, // 230: inventory.v1.AddValkeyExporterParams.custom_labels:type_name -> inventory.v1.AddValkeyExporterParams.CustomLabelsEntry
	113, // 231: inventory.v1.ChangeValkeyExporterParams.custom_labels:type_name -> common.StringMap
	112, // 232: inventory.v1.ChangeValkeyExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	109, // 233: inventory.v1.AddOTELCollectorParams.custom_labels:type_name -> inventory.v1.AddOTELCollectorParams.CustomLabelsEntry
	5,   // 234: inventory.v1.AddOTELCollectorParams.logs_config:type_name -> inventory.v1.OTELLogsConfig
	113, // 235: inventory.v1.ChangeOTELCollectorParams.custom_labels:type_name -> common.StringMap
	5,   // 236: inventory.v1.ChangeOTELCollectorParams.logs_config:type_name -> inventory.v1.OTELLogsConfig
	23,  // 237: inventory.v1.AgentsService.ListAgents:input_type -> inventory.v1.ListAgentsRequest
	25,  // 238: inventory.v1.AgentsService.GetAgent:input_type -> inventory.v1.GetAgentRequest
	27,  // 239: inventory.v1.AgentsService.GetAgentLogs:input_type -> inventory.v1.GetAgentLogsRequest
	29,  // 240: inventory.v1.AgentsService.AddAgent:input_type -> inventory.v1.AddAgentRequest
	31,  // 241: inventory.v1.AgentsService.ChangeAgent:input_type -> inventory.v1.ChangeAgentRequest
	67,  // 242: inventory.v1.AgentsService.RemoveAgent:input_type -> inventory.v1.RemoveAgentRequest
	24,  // 243: inventory.v1.AgentsService.ListAgents:output_type -> inventory.v1.ListAgentsResponse
	26,  // 244: inventory.v1.AgentsService.GetAgent:output_type -> inventory.v1.GetAgentResponse
	28,  // 245: inventory.v1.AgentsService.GetAgentLogs:output_type -> inventory.v1.GetAgentLogsResponse
	30,  // 246: inventory.v1.AgentsService.AddAgent:output_type -> inventory.v1.AddAgentResponse
	32,  // 247: inventory.v1.AgentsService.ChangeAgent:output_type -> inventory.v1.ChangeAgentResponse
	68,  // 248: inventory.v1.AgentsService.RemoveAgent:output_type -> inventory.v1.RemoveAgentResponse
...
func file_inventory_v1_agents_proto_init() {
	...
	file_inventory_v1_agents_proto_msgTypes[25].OneofWrappers = []any{
		...
		(*GetAgentResponse_OtelCollector)(nil),
	}
	file_inventory_v1_agents_proto_msgTypes[28].OneofWrappers = []any{
		...
		(*AddAgentRequest_OtelCollector)(nil),
	}
	file_inventory_v1_agents_proto_msgTypes[29].OneofWrappers = []any{
		...
		(*AddAgentResponse_OtelCollector)(nil),
	}
	file_inventory_v1_agents_proto_msgTypes[30].OneofWrappers = []any{
		...
		(*ChangeAgentRequest_OtelCollector)(nil),
	}
	file_inventory_v1_agents_proto_msgTypes[31].OneofWrappers = []any{
		...
		(*ChangeAgentResponse_OtelCollector)(nil),
	}
