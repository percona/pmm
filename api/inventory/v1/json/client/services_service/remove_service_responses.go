...
func (o *RemoveServiceOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /v1/inventory/services/{service_id}][%d] removeServiceOk %s", 200, payload)
}
...
func (o *RemoveServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/inventory/services/{service_id}][%d] RemoveService default %s", o._statusCode, payload)
}
