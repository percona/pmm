...
func file_common_metrics_resolutions_proto_rawDescGZIP() []byte {
	file_common_metrics_resolutions_proto_rawDescOnce.Do(func() {
		file_common_metrics_resolutions_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_common_metrics_resolutions_proto_rawDescData)))
	})
	return []byte(file_common_metrics_resolutions_proto_rawDescData)
}
