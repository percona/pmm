...
func file_actions_v1_actions_proto_rawDescGZIP() []byte {
	file_actions_v1_actions_proto_rawDescOnce.Do(func() {
		file_actions_v1_actions_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_actions_v1_actions_proto_rawDescData)))
	})
	return []byte(file_actions_v1_actions_proto_rawDescData)
}
