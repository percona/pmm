...
func file_alerting_v1_alerting_proto_rawDescGZIP() []byte {
	file_alerting_v1_alerting_proto_rawDescOnce.Do(func() {
		file_alerting_v1_alerting_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_alerting_v1_alerting_proto_rawDescData)))
	})
	return []byte(file_alerting_v1_alerting_proto_rawDescData)
}
