...
func (m *AnnotationsCreateRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AnnotationsCreateRequest.Marshal(b, m, deterministic)
}
func (dst *AnnotationsCreateRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AnnotationsCreateRequest.Merge(dst, src)
}
func (m *AnnotationsCreateRequest) XXX_Size() int {
	return xxx_messageInfo_AnnotationsCreateRequest.Size(m)
}
func (m *AnnotationsCreateRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AnnotationsCreateRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AnnotationsCreateRequest proto.InternalMessageInfo
...
func (m *AnnotationsCreateResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AnnotationsCreateResponse.Marshal(b, m, deterministic)
}
func (dst *AnnotationsCreateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AnnotationsCreateResponse.Merge(dst, src)
}
func (m *AnnotationsCreateResponse) XXX_Size() int {
	return xxx_messageInfo_AnnotationsCreateResponse.Size(m)
}
func (m *AnnotationsCreateResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AnnotationsCreateResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AnnotationsCreateResponse proto.InternalMessageInfo
...
func (c *annotationsClient) Create(ctx context.Context, in *AnnotationsCreateRequest, opts ...grpc.CallOption) (*AnnotationsCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.Annotations/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
