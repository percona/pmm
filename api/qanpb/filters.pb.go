...
func (*FiltersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_47b056565daffbb6, []int{0}
}
...
func (*FiltersReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_47b056565daffbb6, []int{1}
}
...
func (*ListLabels) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_47b056565daffbb6, []int{2}
}
...
func (*ValueAndCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_47b056565daffbb6, []int{3}
}
...
func (dst *ValueAndCount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValueAndCount.Merge(dst, src)
}
...
func init() { proto.RegisterFile("qanpb/filters.proto", fileDescriptor_filters_47b056565daffbb6) }

var fileDescriptor_filters_47b056565daffbb6 = []byte{
