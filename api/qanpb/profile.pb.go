...
func file_qanpb_profile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_qanpb_profile_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_qanpb_profile_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_qanpb_profile_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_qanpb_profile_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Row); i {
			case 0:
				return &v.state
			case 1:
		...
		file_qanpb_profile_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Metric); i {
			case 0:
				return &v.state
			case 1:
		...
		file_qanpb_profile_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Stat); i {
			case 0:
				return &v.state
			case 1:
