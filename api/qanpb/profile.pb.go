...
func (*ReportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_42f9660fe64976a2, []int{0}
}
...
func (*ReportMapFieldEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_42f9660fe64976a2, []int{1}
}
...
func (*ReportReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_42f9660fe64976a2, []int{2}
}
...
func (*Row) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_42f9660fe64976a2, []int{3}
}
...
func (*Metric) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_42f9660fe64976a2, []int{4}
}
...
func (*Stat) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_42f9660fe64976a2, []int{5}
}
...
func (*Point) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_42f9660fe64976a2, []int{6}
}
...
func init() { proto.RegisterFile("qanpb/profile.proto", fileDescriptor_profile_42f9660fe64976a2) }

var fileDescriptor_profile_42f9660fe64976a2 = []byte{
	// 648 bytes of a gzipped FileDescriptorProto
	,
}
