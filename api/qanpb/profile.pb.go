...
type Row struct {
	...
	Metrics       map[string]*Metric     `protobuf:"bytes,3,rep,name=metrics,proto3" json:"metrics,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_qanpb_profile_proto_rawDesc = string([]byte{
...
var (
	...
	file_qanpb_profile_proto_rawDescData []byte
)

func file_qanpb_profile_proto_rawDescGZIP() []byte {
	file_qanpb_profile_proto_rawDescOnce.Do(func() {
		file_qanpb_profile_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_qanpb_profile_proto_rawDesc), len(file_qanpb_profile_proto_rawDesc)))
	})
...
func file_qanpb_profile_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_qanpb_profile_proto_rawDesc), len(file_qanpb_profile_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
