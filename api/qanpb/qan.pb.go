...
type Point struct {
	...
	MPlansCallsSumPerSec uint64 `protobuf:"varint,58,opt,name=m_plans_calls_sum_per_sec,json=mPlansCallsSumPerSec,proto3" json:"m_plans_calls_sum_per_sec,omitempty"`
	// Total number of WAL (Write-ahead logging) records.
	MWalRecordsSumPerSec uint64 `protobuf:"varint,59,opt,name=m_wal_records_sum_per_sec,json=mWalRecordsSumPerSec,proto3" json:"m_wal_records_sum_per_sec,omitempty"`
	// Total number of FPI (full page images) in WAL (Write-ahead logging) records.
	MWalFpiSumPerSec uint64 `protobuf:"varint,60,opt,name=m_wal_fpi_sum_per_sec,json=mWalFpiSumPerSec,proto3" json:"m_wal_fpi_sum_per_sec,omitempty"`
}
...
func (x *Point) GetMPlansCallsSumPerSec() uint64 {
	if x != nil {
...
func (x *Point) GetMWalRecordsSumPerSec() uint64 {
	if x != nil {
...
func (x *Point) GetMWalFpiSumPerSec() uint64 {
	if x != nil {
...
var file_qanpb_qan_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x63, 0x18, 0x3a, 0x20, 0x01, 0x28, 0x04, 0x52, 0x14, 0x6d,
	...
	0x18, 0x3b, 0x20, 0x01, 0x28, 0x04, 0x52, 0x14, 0x6d, 0x57, 0x61, 0x6c, 0x52, 0x65, 0x63, 0x6f,
	...
	0x72, 0x5f, 0x73, 0x65, 0x63, 0x18, 0x3c, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x6d, 0x57, 0x61,
