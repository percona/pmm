...
// ObjectDetailsGetMetricsReader is a Reader for the ObjectDetailsGetMetrics structure.
type ObjectDetailsGetMetricsReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *ObjectDetailsGetMetricsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewObjectDetailsGetMetricsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewObjectDetailsGetMetricsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewObjectDetailsGetMetricsOK creates a ObjectDetailsGetMetricsOK with default headers values
func NewObjectDetailsGetMetricsOK() *ObjectDetailsGetMetricsOK {
	return &ObjectDetailsGetMetricsOK{}
}

/*ObjectDetailsGetMetricsOK handles this case with default header values.

A successful response.
*/
type ObjectDetailsGetMetricsOK struct {
	Payload *ObjectDetailsGetMetricsOKBody
}

func (o *ObjectDetailsGetMetricsOK) Error() string {
	return fmt.Sprintf("[POST /v0/qan/ObjectDetails/GetMetrics][%d] objectDetailsGetMetricsOk  %+v", 200, o.Payload)
}

func (o *ObjectDetailsGetMetricsOK) GetPayload() *ObjectDetailsGetMetricsOKBody {
	return o.Payload
}

func (o *ObjectDetailsGetMetricsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(ObjectDetailsGetMetricsOKBody)
...
// NewObjectDetailsGetMetricsDefault creates a ObjectDetailsGetMetricsDefault with default headers values
func NewObjectDetailsGetMetricsDefault(code int) *ObjectDetailsGetMetricsDefault {
	return &ObjectDetailsGetMetricsDefault{
		_statusCode: code,
	}
}

/*ObjectDetailsGetMetricsDefault handles this case with default header values.

An unexpected error response.
*/
type ObjectDetailsGetMetricsDefault struct {
	_statusCode int

	Payload *ObjectDetailsGetMetricsDefaultBody
}

// Code gets the status code for the object details get metrics default response
func (o *ObjectDetailsGetMetricsDefault) Code() int {
	return o._statusCode
}

func (o *ObjectDetailsGetMetricsDefault) Error() string {
	return fmt.Sprintf("[POST /v0/qan/ObjectDetails/GetMetrics][%d] ObjectDetails_GetMetrics default  %+v", o._statusCode, o.Payload)
}

func (o *ObjectDetailsGetMetricsDefault) GetPayload() *ObjectDetailsGetMetricsDefaultBody {
	return o.Payload
}

func (o *ObjectDetailsGetMetricsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(ObjectDetailsGetMetricsDefaultBody)
...
/*ObjectDetailsGetMetricsBody MetricsRequest defines filtering of metrics for specific value of dimension (ex.: host=hostname1 or queryid=1D410B4BE5060972.
swagger:model ObjectDetailsGetMetricsBody
*/
type ObjectDetailsGetMetricsBody struct {
...
// Validate validates this object details get metrics body
func (o *ObjectDetailsGetMetricsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ObjectDetailsGetMetricsBody) validatePeriodStartFrom(formats strfmt.Registry) error {
...
func (o *ObjectDetailsGetMetricsBody) validatePeriodStartTo(formats strfmt.Registry) error {
...
func (o *ObjectDetailsGetMetricsBody) validateLabels(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *ObjectDetailsGetMetricsBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ObjectDetailsGetMetricsBody) UnmarshalBinary(b []byte) error {
	var res ObjectDetailsGetMetricsBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*ObjectDetailsGetMetricsDefaultBody object details get metrics default body
swagger:model ObjectDetailsGetMetricsDefaultBody
*/
type ObjectDetailsGetMetricsDefaultBody struct {
...
// Validate validates this object details get metrics default body
func (o *ObjectDetailsGetMetricsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ObjectDetailsGetMetricsDefaultBody) validateDetails(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Details); i++ {
		...
		if o.Details[i] != nil {
			if err := o.Details[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("ObjectDetails_GetMetrics default" + "." + "details" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// MarshalBinary interface implementation
func (o *ObjectDetailsGetMetricsDefaultBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ObjectDetailsGetMetricsDefaultBody) UnmarshalBinary(b []byte) error {
	var res ObjectDetailsGetMetricsDefaultBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*ObjectDetailsGetMetricsOKBody MetricsReply defines metrics for specific value of dimension (ex.: host=hostname1 or queryid=1D410B4BE5060972.
swagger:model ObjectDetailsGetMetricsOKBody
*/
type ObjectDetailsGetMetricsOKBody struct {
...
// Validate validates this object details get metrics OK body
func (o *ObjectDetailsGetMetricsOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ObjectDetailsGetMetricsOKBody) validateMetrics(formats strfmt.Registry) error {
...
func (o *ObjectDetailsGetMetricsOKBody) validateSparkline(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Sparkline); i++ {
		...
		if o.Sparkline[i] != nil {
			if err := o.Sparkline[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("objectDetailsGetMetricsOk" + "." + "sparkline" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ObjectDetailsGetMetricsOKBody) validateTotals(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *ObjectDetailsGetMetricsOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ObjectDetailsGetMetricsOKBody) UnmarshalBinary(b []byte) error {
	var res ObjectDetailsGetMetricsOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
