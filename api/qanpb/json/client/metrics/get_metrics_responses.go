...
func (o *GetMetricsOK) Error() string {
	return fmt.Sprintf("[POST /v1/qan/Metrics/Get][%d] getMetricsOk  %+v", 200, o.Payload)
}
...
func (o *GetMetricsDefault) Error() string {
	return fmt.Sprintf("[POST /v1/qan/Metrics/Get][%d] GetMetrics default  %+v", o._statusCode, o.Payload)
}
...
type MetricsAnon struct {
	...
	// p total
	PTotal float32 `json:"p_total,omitempty"`
