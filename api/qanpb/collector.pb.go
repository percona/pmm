...
type MetricsBucket struct {
	...
	// Type of SQL command.
	CmdType int32 `protobuf:"varint,246,opt,name=cmd_type,json=cmdType,proto3" json:"cmd_type,omitempty"`
	//
...
func (x *MetricsBucket) GetCmdType() int32 {
	if x != nil {
		return x.CmdType
	}
	return 0
...
var file_qanpb_collector_proto_rawDesc = []byte{
	...
	0x18, 0xf6, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x63, 0x6d, 0x64, 0x54, 0x79, 0x70, 0x65,
