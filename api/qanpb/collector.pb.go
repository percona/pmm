...
type MetricsBucket struct {
	...
	HistogramItems  []*HistogramItem `protobuf:"bytes,251,rep,name=histogram_items,json=histogramItems,proto3" json:"histogram_items,omitempty"`
}
...
func (x *MetricsBucket) GetHistogramItems() []*HistogramItem {
	if x != nil {
...
var file_qanpb_collector_proto_rawDesc = []byte{
	...
	0x6e, 0x12, 0x44, 0x0a, 0x0f, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x5f, 0x69,
	0x74, 0x65, 0x6d, 0x73, 0x18, 0xfb, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x71, 0x61,
...
var file_qanpb_collector_proto_goTypes = []interface{}{
	...
	(*HistogramItem)(nil),      // 9: qan.v1beta1.HistogramItem
}
var file_qanpb_collector_proto_depIdxs = []int32{
	...
	9, // 7: qan.v1beta1.MetricsBucket.histogram_items:type_name -> qan.v1beta1.HistogramItem
