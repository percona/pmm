...
var file_managementpb_backup_artifacts_proto_rawDesc = string([]byte{
	...
	0x6f, 0x22, 0xeb, 0x04, 0x0a, 0x08, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x12, 0x1f,
	...
	0x61, 0x52, 0x0c, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x12,
	0x3e, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x0f,
...
var (
	...
	file_managementpb_backup_artifacts_proto_rawDescData []byte
)
...
func file_managementpb_backup_artifacts_proto_rawDescGZIP() []byte {
	file_managementpb_backup_artifacts_proto_rawDescOnce.Do(func() {
		file_managementpb_backup_artifacts_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_managementpb_backup_artifacts_proto_rawDesc), len(file_managementpb_backup_artifacts_proto_rawDesc)))
	})
...
var (
	...
	file_managementpb_backup_artifacts_proto_goTypes   = []any{
...
var file_managementpb_backup_artifacts_proto_depIdxs = []int32{
	...
	2,  // 10: backup.v1.Artifacts.ListArtifacts:input_type -> backup.v1.ListArtifactsRequest
	4,  // 11: backup.v1.Artifacts.DeleteArtifact:input_type -> backup.v1.DeleteArtifactRequest
	7,  // 12: backup.v1.Artifacts.ListPitrTimeranges:input_type -> backup.v1.ListPitrTimerangesRequest
	3,  // 13: backup.v1.Artifacts.ListArtifacts:output_type -> backup.v1.ListArtifactsResponse
	5,  // 14: backup.v1.Artifacts.DeleteArtifact:output_type -> backup.v1.DeleteArtifactResponse
	8,  // 15: backup.v1.Artifacts.ListPitrTimeranges:output_type -> backup.v1.ListPitrTimerangesResponse
...
func file_managementpb_backup_artifacts_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_managementpb_backup_artifacts_proto_rawDesc), len(file_managementpb_backup_artifacts_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
