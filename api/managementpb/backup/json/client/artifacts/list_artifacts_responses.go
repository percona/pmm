...
type ListArtifactsOKBodyArtifactsItems0 struct {
	...
	// Enum: [BACKUP_STATUS_INVALID BACKUP_STATUS_PENDING BACKUP_STATUS_IN_PROGRESS BACKUP_STATUS_PAUSED BACKUP_STATUS_SUCCESS BACKUP_STATUS_ERROR BACKUP_STATUS_DELETING BACKUP_STATUS_FAILED_TO_DELETE BACKUP_STATUS_FAILED_NOT_SUPPORTED_BY_AGENT]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["BACKUP_STATUS_INVALID","BACKUP_STATUS_PENDING","BACKUP_STATUS_IN_PROGRESS","BACKUP_STATUS_PAUSED","BACKUP_STATUS_SUCCESS","BACKUP_STATUS_ERROR","BACKUP_STATUS_DELETING","BACKUP_STATUS_FAILED_TO_DELETE","BACKUP_STATUS_FAILED_NOT_SUPPORTED_BY_AGENT"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// ListArtifactsOKBodyArtifactsItems0StatusBACKUPSTATUSFAILEDNOTSUPPORTEDBYAGENT captures enum value "BACKUP_STATUS_FAILED_NOT_SUPPORTED_BY_AGENT"
	ListArtifactsOKBodyArtifactsItems0StatusBACKUPSTATUSFAILEDNOTSUPPORTEDBYAGENT string = "BACKUP_STATUS_FAILED_NOT_SUPPORTED_BY_AGENT"
)
