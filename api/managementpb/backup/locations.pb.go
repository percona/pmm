...
// ServerLocationConfig represents file system config inside pmm-server.
...
func (x *ServerLocationConfig) Reset() {
	*x = ServerLocationConfig{}
...
func (x *ServerLocationConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServerLocationConfig) ProtoMessage() {}

func (x *ServerLocationConfig) ProtoReflect() protoreflect.Message {
	mi := &file_managementpb_backup_locations_proto_msgTypes[0]
...
// Deprecated: Use ServerLocationConfig.ProtoReflect.Descriptor instead.
func (*ServerLocationConfig) Descriptor() ([]byte, []int) {
	return file_managementpb_backup_locations_proto_rawDescGZIP(), []int{0}
}

func (x *ServerLocationConfig) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
// ClientLocationConfig represents file system config inside pmm-client.
type ClientLocationConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ClientLocationConfig) Reset() {
	*x = ClientLocationConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClientLocationConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClientLocationConfig) ProtoMessage() {}

func (x *ClientLocationConfig) ProtoReflect() protoreflect.Message {
	mi := &file_managementpb_backup_locations_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClientLocationConfig.ProtoReflect.Descriptor instead.
func (*ClientLocationConfig) Descriptor() ([]byte, []int) {
	return file_managementpb_backup_locations_proto_rawDescGZIP(), []int{1}
}

func (x *ClientLocationConfig) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
type Location struct {
	...
	//	*Location_ClientConfig
	//	*Location_ServerConfig
	//	*Location_S3Config
...
func (x *Location) GetClientConfig() *ClientLocationConfig {
	if x, ok := x.GetConfig().(*Location_ClientConfig); ok {
		return x.ClientConfig
	}
	return nil
}

func (x *Location) GetServerConfig() *ServerLocationConfig {
	if x, ok := x.GetConfig().(*Location_ServerConfig); ok {
...
type Location_ClientConfig struct {
	ClientConfig *ClientLocationConfig `protobuf:"bytes,4,opt,name=client_config,json=clientConfig,proto3,oneof"`
}

type Location_ServerConfig struct {
	ServerConfig *ServerLocationConfig `protobuf:"bytes,5,opt,name=server_config,json=serverConfig,proto3,oneof"`
}
...
func (*Location_ClientConfig) isLocation_Config() {}

func (*Location_ServerConfig) isLocation_Config() {}
...
type AddLocationRequest struct {
	...
	ClientConfig *ClientLocationConfig `protobuf:"bytes,3,opt,name=client_config,json=clientConfig,proto3" json:"client_config,omitempty"`
	// PMM-client file system configuration. Exactly one config should be set.
	ServerConfig *ServerLocationConfig `protobuf:"bytes,4,opt,name=server_config,json=serverConfig,proto3" json:"server_config,omitempty"`
...
func (x *AddLocationRequest) GetClientConfig() *ClientLocationConfig {
	if x != nil {
		return x.ClientConfig
	}
	return nil
...
func (x *AddLocationRequest) GetServerConfig() *ServerLocationConfig {
	if x != nil {
		return x.ServerConfig
	}
	return nil
...
var file_managementpb_backup_locations_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x32, 0x0a, 0x14, 0x53,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x12, 0x1a, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x06, 0xe2, 0xdf, 0x1f, 0x02, 0x58, 0x01, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22,
	0x32, 0x0a, 0x14, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f,
	...
	0x61, 0x74, 0x68, 0x22, 0x84, 0x01, 0x0a, 0x10, 0x53, 0x33, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69,
	...
	0x09, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x22, 0xc6, 0x02, 0x0a, 0x08, 0x4c,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4f, 0x0a, 0x15, 0x4c,
	0x69, 0x73, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x09, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6e, 0x52, 0x09, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xa7, 0x02, 0x0a,
	...
	,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x36, 0x0a, 0x13, 0x41, 0x64, 0x64, 0x4c, 0x6f, 0x63,
	...
	0x28, 0x09, 0x52, 0x0a, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x32, 0xa4,
	0x02, 0x0a, 0x09, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x8d, 0x01, 0x0a,
	0x0d, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x24,
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x4c, 0x69, 0x73, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x86, 0x01, 0x0a,
	0x0b, 0x41, 0x64, 0x64, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x22, 0x2e, 0x62,
	0x61, 0x63, 0x6b, 0x75, 0x70, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x41, 0x64,
	...
	0x63, 0x6b, 0x75, 0x70, 0x2f, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x41,
	0x64, 0x64, 0x3a, 0x01, 0x2a, 0x42, 0x27, 0x5a, 0x25, 0x61, 0x70, 0x69, 0x2f, 0x6d, 0x61, 0x6e,
...
var file_managementpb_backup_locations_proto_goTypes = []interface{}{
	(*ServerLocationConfig)(nil),  // 0: backup.v1beta1.ServerLocationConfig
	(*ClientLocationConfig)(nil),  // 1: backup.v1beta1.ClientLocationConfig
...
var file_managementpb_backup_locations_proto_depIdxs = []int32{
	1, // 0: backup.v1beta1.Location.client_config:type_name -> backup.v1beta1.ClientLocationConfig
	0, // 1: backup.v1beta1.Location.server_config:type_name -> backup.v1beta1.ServerLocationConfig
	...
	1, // 4: backup.v1beta1.AddLocationRequest.client_config:type_name -> backup.v1beta1.ClientLocationConfig
	0, // 5: backup.v1beta1.AddLocationRequest.server_config:type_name -> backup.v1beta1.ServerLocationConfig
...
func file_managementpb_backup_locations_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_managementpb_backup_locations_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServerLocationConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_managementpb_backup_locations_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClientLocationConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_managementpb_backup_locations_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*Location_ClientConfig)(nil),
		(*Location_ServerConfig)(nil),
