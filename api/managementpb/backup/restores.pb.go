...
var file_managementpb_backup_restores_proto_rawDesc = string([]byte{
	...
	0x22, 0xea, 0x04, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x48, 0x69, 0x73, 0x74,
	...
	0x70, 0x69, 0x74, 0x72, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x3e, 0x0a,
	0x0b, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x0e, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x42,
	0x61, 0x63, 0x6b, 0x75, 0x70, 0x43, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x1b, 0x0a,
...
var (
	...
	file_managementpb_backup_restores_proto_rawDescData []byte
)

func file_managementpb_backup_restores_proto_rawDescGZIP() []byte {
	file_managementpb_backup_restores_proto_rawDescOnce.Do(func() {
		file_managementpb_backup_restores_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_managementpb_backup_restores_proto_rawDesc), len(file_managementpb_backup_restores_proto_rawDesc)))
	})
...
var (
	...
	file_managementpb_backup_restores_proto_goTypes   = []any{
		...
		(BackupCompression)(0),             // 6: backup.v1.BackupCompression
	}
)
...
var file_managementpb_backup_restores_proto_depIdxs = []int32{
	...
	6, // 5: backup.v1.RestoreHistoryItem.compression:type_name -> backup.v1.BackupCompression
	1, // 6: backup.v1.ListRestoreHistoryResponse.items:type_name -> backup.v1.RestoreHistoryItem
	2, // 7: backup.v1.RestoreHistory.ListRestoreHistory:input_type -> backup.v1.ListRestoreHistoryRequest
	3, // 8: backup.v1.RestoreHistory.ListRestoreHistory:output_type -> backup.v1.ListRestoreHistoryResponse
...
func file_managementpb_backup_restores_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_managementpb_backup_restores_proto_rawDesc), len(file_managementpb_backup_restores_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
