...
// WithBody adds the body to the delete role params
func (o *DeleteRoleParams) WithBody(body DeleteRoleBody) *DeleteRoleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete role params
func (o *DeleteRoleParams) SetBody(body DeleteRoleBody) {
	o.Body = body
}
