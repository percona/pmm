...
var (
	pattern_AzureDatabase_DiscoverAzureDatabase_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "management", "AzureDatabase", "Discover"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AzureDatabase_AddAzureDatabase_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "management", "AzureDatabase", "Add"}, "", runtime.AssumeColonVerbOpt(true)))
)
