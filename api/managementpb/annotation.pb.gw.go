...
func RegisterAnnotationHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AnnotationServer) error {
	mux.Handle(http.MethodPost, pattern_Annotation_AddAnnotation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
// "AnnotationClient" to call the correct interceptors. This client ignores the HTTP middlewares.
