...
// TemplatesListTemplatesReader is a Reader for the TemplatesListTemplates structure.
type TemplatesListTemplatesReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *TemplatesListTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewTemplatesListTemplatesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewTemplatesListTemplatesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewTemplatesListTemplatesOK creates a TemplatesListTemplatesOK with default headers values
func NewTemplatesListTemplatesOK() *TemplatesListTemplatesOK {
	return &TemplatesListTemplatesOK{}
}

/*TemplatesListTemplatesOK handles this case with default header values.

A successful response.
*/
type TemplatesListTemplatesOK struct {
	Payload *TemplatesListTemplatesOKBody
}

func (o *TemplatesListTemplatesOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Templates/List][%d] templatesListTemplatesOk  %+v", 200, o.Payload)
}

func (o *TemplatesListTemplatesOK) GetPayload() *TemplatesListTemplatesOKBody {
	return o.Payload
}

func (o *TemplatesListTemplatesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(TemplatesListTemplatesOKBody)
...
// NewTemplatesListTemplatesDefault creates a TemplatesListTemplatesDefault with default headers values
func NewTemplatesListTemplatesDefault(code int) *TemplatesListTemplatesDefault {
	return &TemplatesListTemplatesDefault{
		_statusCode: code,
	}
}

/*TemplatesListTemplatesDefault handles this case with default header values.

An unexpected error response.
*/
type TemplatesListTemplatesDefault struct {
	_statusCode int

	Payload *TemplatesListTemplatesDefaultBody
}

// Code gets the status code for the templates list templates default response
func (o *TemplatesListTemplatesDefault) Code() int {
	return o._statusCode
}

func (o *TemplatesListTemplatesDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Templates/List][%d] Templates_ListTemplates default  %+v", o._statusCode, o.Payload)
}

func (o *TemplatesListTemplatesDefault) GetPayload() *TemplatesListTemplatesDefaultBody {
	return o.Payload
}

func (o *TemplatesListTemplatesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(TemplatesListTemplatesDefaultBody)
...
/*TemplatesListTemplatesBody templates list templates body
swagger:model TemplatesListTemplatesBody
*/
type TemplatesListTemplatesBody struct {

	// If true, template files will be re-read from disk.
	Reload bool `json:"reload,omitempty"`

	// page params
	PageParams *TemplatesListTemplatesParamsBodyPageParams `json:"page_params,omitempty"`
}

// Validate validates this templates list templates body
func (o *TemplatesListTemplatesBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *TemplatesListTemplatesBody) validatePageParams(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *TemplatesListTemplatesBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *TemplatesListTemplatesBody) UnmarshalBinary(b []byte) error {
	var res TemplatesListTemplatesBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*TemplatesListTemplatesDefaultBody templates list templates default body
swagger:model TemplatesListTemplatesDefaultBody
*/
type TemplatesListTemplatesDefaultBody struct {
...
// Validate validates this templates list templates default body
func (o *TemplatesListTemplatesDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *TemplatesListTemplatesDefaultBody) validateDetails(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Details); i++ {
		...
		if o.Details[i] != nil {
			if err := o.Details[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("Templates_ListTemplates default" + "." + "details" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// MarshalBinary interface implementation
func (o *TemplatesListTemplatesDefaultBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *TemplatesListTemplatesDefaultBody) UnmarshalBinary(b []byte) error {
	var res TemplatesListTemplatesDefaultBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*TemplatesListTemplatesOKBody templates list templates OK body
swagger:model TemplatesListTemplatesOKBody
*/
type TemplatesListTemplatesOKBody struct {

	// templates
	Templates []*TemplatesItems0 `json:"templates"`

	// totals
	Totals *TemplatesListTemplatesOKBodyTotals `json:"totals,omitempty"`
}

// Validate validates this templates list templates OK body
func (o *TemplatesListTemplatesOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *TemplatesListTemplatesOKBody) validateTemplates(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Templates); i++ {
		...
		if o.Templates[i] != nil {
			if err := o.Templates[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("templatesListTemplatesOk" + "." + "templates" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *TemplatesListTemplatesOKBody) validateTotals(formats strfmt.Registry) error {
	...
	if o.Totals != nil {
		if err := o.Totals.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("templatesListTemplatesOk" + "." + "totals")
			}
			return err
		}
	}
...
// MarshalBinary interface implementation
func (o *TemplatesListTemplatesOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *TemplatesListTemplatesOKBody) UnmarshalBinary(b []byte) error {
	var res TemplatesListTemplatesOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*TemplatesListTemplatesOKBodyTotals PageTotals represents total values for pagination.
swagger:model TemplatesListTemplatesOKBodyTotals
*/
type TemplatesListTemplatesOKBodyTotals struct {
...
// Validate validates this templates list templates OK body totals
func (o *TemplatesListTemplatesOKBodyTotals) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *TemplatesListTemplatesOKBodyTotals) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *TemplatesListTemplatesOKBodyTotals) UnmarshalBinary(b []byte) error {
	var res TemplatesListTemplatesOKBodyTotals
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*TemplatesListTemplatesParamsBodyPageParams PageParams represents page request parameters for pagination.
swagger:model TemplatesListTemplatesParamsBodyPageParams
*/
type TemplatesListTemplatesParamsBodyPageParams struct {
...
// Validate validates this templates list templates params body page params
func (o *TemplatesListTemplatesParamsBodyPageParams) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *TemplatesListTemplatesParamsBodyPageParams) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *TemplatesListTemplatesParamsBodyPageParams) UnmarshalBinary(b []byte) error {
	var res TemplatesListTemplatesParamsBodyPageParams
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
