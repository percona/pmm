...
// RulesListAlertRulesReader is a Reader for the RulesListAlertRules structure.
type RulesListAlertRulesReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *RulesListAlertRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewRulesListAlertRulesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewRulesListAlertRulesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewRulesListAlertRulesOK creates a RulesListAlertRulesOK with default headers values
func NewRulesListAlertRulesOK() *RulesListAlertRulesOK {
	return &RulesListAlertRulesOK{}
}

/*RulesListAlertRulesOK handles this case with default header values.

A successful response.
*/
type RulesListAlertRulesOK struct {
	Payload *RulesListAlertRulesOKBody
}

func (o *RulesListAlertRulesOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Rules/List][%d] rulesListAlertRulesOk  %+v", 200, o.Payload)
}

func (o *RulesListAlertRulesOK) GetPayload() *RulesListAlertRulesOKBody {
	return o.Payload
}

func (o *RulesListAlertRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(RulesListAlertRulesOKBody)
...
// NewRulesListAlertRulesDefault creates a RulesListAlertRulesDefault with default headers values
func NewRulesListAlertRulesDefault(code int) *RulesListAlertRulesDefault {
	return &RulesListAlertRulesDefault{
		_statusCode: code,
	}
}

/*RulesListAlertRulesDefault handles this case with default header values.

An unexpected error response.
*/
type RulesListAlertRulesDefault struct {
	_statusCode int

	Payload *RulesListAlertRulesDefaultBody
}

// Code gets the status code for the rules list alert rules default response
func (o *RulesListAlertRulesDefault) Code() int {
	return o._statusCode
}

func (o *RulesListAlertRulesDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Rules/List][%d] Rules_ListAlertRules default  %+v", o._statusCode, o.Payload)
}

func (o *RulesListAlertRulesDefault) GetPayload() *RulesListAlertRulesDefaultBody {
	return o.Payload
}

func (o *RulesListAlertRulesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(RulesListAlertRulesDefaultBody)
...
/*RulesListAlertRulesBody rules list alert rules body
swagger:model RulesListAlertRulesBody
*/
type RulesListAlertRulesBody struct {

	// page params
	PageParams *RulesListAlertRulesParamsBodyPageParams `json:"page_params,omitempty"`
}

// Validate validates this rules list alert rules body
func (o *RulesListAlertRulesBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RulesListAlertRulesBody) validatePageParams(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *RulesListAlertRulesBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RulesListAlertRulesBody) UnmarshalBinary(b []byte) error {
	var res RulesListAlertRulesBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*RulesListAlertRulesDefaultBody rules list alert rules default body
swagger:model RulesListAlertRulesDefaultBody
*/
type RulesListAlertRulesDefaultBody struct {
...
// Validate validates this rules list alert rules default body
func (o *RulesListAlertRulesDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RulesListAlertRulesDefaultBody) validateDetails(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Details); i++ {
		...
		if o.Details[i] != nil {
			if err := o.Details[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("Rules_ListAlertRules default" + "." + "details" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// MarshalBinary interface implementation
func (o *RulesListAlertRulesDefaultBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RulesListAlertRulesDefaultBody) UnmarshalBinary(b []byte) error {
	var res RulesListAlertRulesDefaultBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*RulesListAlertRulesOKBody rules list alert rules OK body
swagger:model RulesListAlertRulesOKBody
*/
type RulesListAlertRulesOKBody struct {

	// rules
	Rules []*RulesItems0 `json:"rules"`

	// totals
	Totals *RulesListAlertRulesOKBodyTotals `json:"totals,omitempty"`
}

// Validate validates this rules list alert rules OK body
func (o *RulesListAlertRulesOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RulesListAlertRulesOKBody) validateRules(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Rules); i++ {
		...
		if o.Rules[i] != nil {
			if err := o.Rules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("rulesListAlertRulesOk" + "." + "rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *RulesListAlertRulesOKBody) validateTotals(formats strfmt.Registry) error {
	...
	if o.Totals != nil {
		if err := o.Totals.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("rulesListAlertRulesOk" + "." + "totals")
			}
			return err
		}
	}
...
// MarshalBinary interface implementation
func (o *RulesListAlertRulesOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RulesListAlertRulesOKBody) UnmarshalBinary(b []byte) error {
	var res RulesListAlertRulesOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*RulesListAlertRulesOKBodyTotals PageTotals represents total values for pagination.
swagger:model RulesListAlertRulesOKBodyTotals
*/
type RulesListAlertRulesOKBodyTotals struct {
...
// Validate validates this rules list alert rules OK body totals
func (o *RulesListAlertRulesOKBodyTotals) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *RulesListAlertRulesOKBodyTotals) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RulesListAlertRulesOKBodyTotals) UnmarshalBinary(b []byte) error {
	var res RulesListAlertRulesOKBodyTotals
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*RulesListAlertRulesParamsBodyPageParams PageParams represents page request parameters for pagination.
swagger:model RulesListAlertRulesParamsBodyPageParams
*/
type RulesListAlertRulesParamsBodyPageParams struct {
...
// Validate validates this rules list alert rules params body page params
func (o *RulesListAlertRulesParamsBodyPageParams) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *RulesListAlertRulesParamsBodyPageParams) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *RulesListAlertRulesParamsBodyPageParams) UnmarshalBinary(b []byte) error {
	var res RulesListAlertRulesParamsBodyPageParams
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
