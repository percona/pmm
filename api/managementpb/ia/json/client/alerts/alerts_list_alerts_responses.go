...
// AlertsListAlertsReader is a Reader for the AlertsListAlerts structure.
type AlertsListAlertsReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *AlertsListAlertsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewAlertsListAlertsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewAlertsListAlertsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewAlertsListAlertsOK creates a AlertsListAlertsOK with default headers values
func NewAlertsListAlertsOK() *AlertsListAlertsOK {
	return &AlertsListAlertsOK{}
}

/*AlertsListAlertsOK handles this case with default header values.

A successful response.
*/
type AlertsListAlertsOK struct {
	Payload *AlertsListAlertsOKBody
}

func (o *AlertsListAlertsOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Alerts/List][%d] alertsListAlertsOk  %+v", 200, o.Payload)
}

func (o *AlertsListAlertsOK) GetPayload() *AlertsListAlertsOKBody {
	return o.Payload
}

func (o *AlertsListAlertsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(AlertsListAlertsOKBody)
...
// NewAlertsListAlertsDefault creates a AlertsListAlertsDefault with default headers values
func NewAlertsListAlertsDefault(code int) *AlertsListAlertsDefault {
	return &AlertsListAlertsDefault{
		_statusCode: code,
	}
}

/*AlertsListAlertsDefault handles this case with default header values.

An unexpected error response.
*/
type AlertsListAlertsDefault struct {
	_statusCode int

	Payload *AlertsListAlertsDefaultBody
}

// Code gets the status code for the alerts list alerts default response
func (o *AlertsListAlertsDefault) Code() int {
	return o._statusCode
}

func (o *AlertsListAlertsDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Alerts/List][%d] Alerts_ListAlerts default  %+v", o._statusCode, o.Payload)
}

func (o *AlertsListAlertsDefault) GetPayload() *AlertsListAlertsDefaultBody {
	return o.Payload
}

func (o *AlertsListAlertsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(AlertsListAlertsDefaultBody)
...
/*AlertsListAlertsBody alerts list alerts body
swagger:model AlertsListAlertsBody
*/
type AlertsListAlertsBody struct {

	// page params
	PageParams *AlertsListAlertsParamsBodyPageParams `json:"page_params,omitempty"`
}

// Validate validates this alerts list alerts body
func (o *AlertsListAlertsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *AlertsListAlertsBody) validatePageParams(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *AlertsListAlertsBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AlertsListAlertsBody) UnmarshalBinary(b []byte) error {
	var res AlertsListAlertsBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*AlertsListAlertsDefaultBody alerts list alerts default body
swagger:model AlertsListAlertsDefaultBody
*/
type AlertsListAlertsDefaultBody struct {
...
// Validate validates this alerts list alerts default body
func (o *AlertsListAlertsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *AlertsListAlertsDefaultBody) validateDetails(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Details); i++ {
		...
		if o.Details[i] != nil {
			if err := o.Details[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("Alerts_ListAlerts default" + "." + "details" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// MarshalBinary interface implementation
func (o *AlertsListAlertsDefaultBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AlertsListAlertsDefaultBody) UnmarshalBinary(b []byte) error {
	var res AlertsListAlertsDefaultBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*AlertsListAlertsOKBody alerts list alerts OK body
swagger:model AlertsListAlertsOKBody
*/
type AlertsListAlertsOKBody struct {

	// alerts
	Alerts []*AlertsItems0 `json:"alerts"`

	// totals
	Totals *AlertsListAlertsOKBodyTotals `json:"totals,omitempty"`
}

// Validate validates this alerts list alerts OK body
func (o *AlertsListAlertsOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *AlertsListAlertsOKBody) validateAlerts(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Alerts); i++ {
		...
		if o.Alerts[i] != nil {
			if err := o.Alerts[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("alertsListAlertsOk" + "." + "alerts" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *AlertsListAlertsOKBody) validateTotals(formats strfmt.Registry) error {
	...
	if o.Totals != nil {
		if err := o.Totals.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("alertsListAlertsOk" + "." + "totals")
			}
			return err
		}
	}
...
// MarshalBinary interface implementation
func (o *AlertsListAlertsOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AlertsListAlertsOKBody) UnmarshalBinary(b []byte) error {
	var res AlertsListAlertsOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*AlertsListAlertsOKBodyTotals PageTotals represents total values for pagination.
swagger:model AlertsListAlertsOKBodyTotals
*/
type AlertsListAlertsOKBodyTotals struct {
...
// Validate validates this alerts list alerts OK body totals
func (o *AlertsListAlertsOKBodyTotals) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *AlertsListAlertsOKBodyTotals) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AlertsListAlertsOKBodyTotals) UnmarshalBinary(b []byte) error {
	var res AlertsListAlertsOKBodyTotals
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*AlertsListAlertsParamsBodyPageParams PageParams represents page request parameters for pagination.
swagger:model AlertsListAlertsParamsBodyPageParams
*/
type AlertsListAlertsParamsBodyPageParams struct {
...
// Validate validates this alerts list alerts params body page params
func (o *AlertsListAlertsParamsBodyPageParams) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *AlertsListAlertsParamsBodyPageParams) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *AlertsListAlertsParamsBodyPageParams) UnmarshalBinary(b []byte) error {
	var res AlertsListAlertsParamsBodyPageParams
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
