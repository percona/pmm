...
func (o *ToggleAlertsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ToggleAlertsOK) GetPayload() any {
	return o.Payload
}
...
var toggleAlertsBodyTypeSilencedPropEnum []any
