...
// ChannelsListChannelsReader is a Reader for the ChannelsListChannels structure.
type ChannelsListChannelsReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *ChannelsListChannelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewChannelsListChannelsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewChannelsListChannelsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewChannelsListChannelsOK creates a ChannelsListChannelsOK with default headers values
func NewChannelsListChannelsOK() *ChannelsListChannelsOK {
	return &ChannelsListChannelsOK{}
}

/*ChannelsListChannelsOK handles this case with default header values.

A successful response.
*/
type ChannelsListChannelsOK struct {
	Payload *ChannelsListChannelsOKBody
}

func (o *ChannelsListChannelsOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Channels/List][%d] channelsListChannelsOk  %+v", 200, o.Payload)
}

func (o *ChannelsListChannelsOK) GetPayload() *ChannelsListChannelsOKBody {
	return o.Payload
}

func (o *ChannelsListChannelsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(ChannelsListChannelsOKBody)
...
// NewChannelsListChannelsDefault creates a ChannelsListChannelsDefault with default headers values
func NewChannelsListChannelsDefault(code int) *ChannelsListChannelsDefault {
	return &ChannelsListChannelsDefault{
		_statusCode: code,
	}
}

/*ChannelsListChannelsDefault handles this case with default header values.

An unexpected error response.
*/
type ChannelsListChannelsDefault struct {
	_statusCode int

	Payload *ChannelsListChannelsDefaultBody
}

// Code gets the status code for the channels list channels default response
func (o *ChannelsListChannelsDefault) Code() int {
	return o._statusCode
}

func (o *ChannelsListChannelsDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/ia/Channels/List][%d] Channels_ListChannels default  %+v", o._statusCode, o.Payload)
}

func (o *ChannelsListChannelsDefault) GetPayload() *ChannelsListChannelsDefaultBody {
	return o.Payload
}

func (o *ChannelsListChannelsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(ChannelsListChannelsDefaultBody)
...
/*ChannelsListChannelsBody channels list channels body
swagger:model ChannelsListChannelsBody
*/
type ChannelsListChannelsBody struct {

	// page params
	PageParams *ChannelsListChannelsParamsBodyPageParams `json:"page_params,omitempty"`
}

// Validate validates this channels list channels body
func (o *ChannelsListChannelsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ChannelsListChannelsBody) validatePageParams(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *ChannelsListChannelsBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ChannelsListChannelsBody) UnmarshalBinary(b []byte) error {
	var res ChannelsListChannelsBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*ChannelsListChannelsDefaultBody channels list channels default body
swagger:model ChannelsListChannelsDefaultBody
*/
type ChannelsListChannelsDefaultBody struct {
...
// Validate validates this channels list channels default body
func (o *ChannelsListChannelsDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ChannelsListChannelsDefaultBody) validateDetails(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Details); i++ {
		...
		if o.Details[i] != nil {
			if err := o.Details[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("Channels_ListChannels default" + "." + "details" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// MarshalBinary interface implementation
func (o *ChannelsListChannelsDefaultBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ChannelsListChannelsDefaultBody) UnmarshalBinary(b []byte) error {
	var res ChannelsListChannelsDefaultBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*ChannelsListChannelsOKBody channels list channels OK body
swagger:model ChannelsListChannelsOKBody
*/
type ChannelsListChannelsOKBody struct {

	// channels
	Channels []*ChannelsItems0 `json:"channels"`

	// totals
	Totals *ChannelsListChannelsOKBodyTotals `json:"totals,omitempty"`
}

// Validate validates this channels list channels OK body
func (o *ChannelsListChannelsOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ChannelsListChannelsOKBody) validateChannels(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.Channels); i++ {
		...
		if o.Channels[i] != nil {
			if err := o.Channels[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("channelsListChannelsOk" + "." + "channels" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ChannelsListChannelsOKBody) validateTotals(formats strfmt.Registry) error {
	...
	if o.Totals != nil {
		if err := o.Totals.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("channelsListChannelsOk" + "." + "totals")
			}
			return err
		}
	}
...
// MarshalBinary interface implementation
func (o *ChannelsListChannelsOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ChannelsListChannelsOKBody) UnmarshalBinary(b []byte) error {
	var res ChannelsListChannelsOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*ChannelsListChannelsOKBodyTotals PageTotals represents total values for pagination.
swagger:model ChannelsListChannelsOKBodyTotals
*/
type ChannelsListChannelsOKBodyTotals struct {
...
// Validate validates this channels list channels OK body totals
func (o *ChannelsListChannelsOKBodyTotals) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ChannelsListChannelsOKBodyTotals) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ChannelsListChannelsOKBodyTotals) UnmarshalBinary(b []byte) error {
	var res ChannelsListChannelsOKBodyTotals
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*ChannelsListChannelsParamsBodyPageParams PageParams represents page request parameters for pagination.
swagger:model ChannelsListChannelsParamsBodyPageParams
*/
type ChannelsListChannelsParamsBodyPageParams struct {
...
// Validate validates this channels list channels params body page params
func (o *ChannelsListChannelsParamsBodyPageParams) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ChannelsListChannelsParamsBodyPageParams) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ChannelsListChannelsParamsBodyPageParams) UnmarshalBinary(b []byte) error {
	var res ChannelsListChannelsParamsBodyPageParams
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
