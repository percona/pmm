...
func (x *Channel) GetEmailConfig() *EmailConfig {
	if x != nil {
		if x, ok := x.Channel.(*Channel_EmailConfig); ok {
...
func (x *Channel) GetPagerdutyConfig() *PagerDutyConfig {
	if x != nil {
		if x, ok := x.Channel.(*Channel_PagerdutyConfig); ok {
...
func (x *Channel) GetSlackConfig() *SlackConfig {
	if x != nil {
		if x, ok := x.Channel.(*Channel_SlackConfig); ok {
...
func (x *Channel) GetWebhookConfig() *WebhookConfig {
	if x != nil {
		if x, ok := x.Channel.(*Channel_WebhookConfig); ok {
...
var file_managementpb_ia_channels_proto_rawDesc = string([]byte{
...
var (
	...
	file_managementpb_ia_channels_proto_rawDescData []byte
)

func file_managementpb_ia_channels_proto_rawDescGZIP() []byte {
	file_managementpb_ia_channels_proto_rawDescOnce.Do(func() {
		file_managementpb_ia_channels_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_managementpb_ia_channels_proto_rawDesc), len(file_managementpb_ia_channels_proto_rawDesc)))
	})
...
func file_managementpb_ia_channels_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_managementpb_ia_channels_proto_rawDesc), len(file_managementpb_ia_channels_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
