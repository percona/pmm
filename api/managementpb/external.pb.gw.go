...
var (
	pattern_External_AddExternal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "management", "External", "Add"}, "", runtime.AssumeColonVerbOpt(true)))
)
