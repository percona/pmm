...
type AddMySQLRequest struct {
	...
	//	*AddMySQLRequest_NodeId
	//	*AddMySQLRequest_NodeName
	//	*AddMySQLRequest_AddNode
	Node isAddMySQLRequest_Node `protobuf_oneof:"node"`
...
type isAddMySQLRequest_Node interface {
	isAddMySQLRequest_Node()
}

type AddMySQLRequest_NodeId struct {
	NodeId string `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3,oneof"`
}

type AddMySQLRequest_NodeName struct {
	NodeName string `protobuf:"bytes,21,opt,name=node_name,json=nodeName,proto3,oneof"`
}

type AddMySQLRequest_AddNode struct {
	AddNode *inventorypb.AddRemoteNodeRequest `protobuf:"bytes,22,opt,name=add_node,json=addNode,proto3,oneof"`
}

func (*AddMySQLRequest_NodeId) isAddMySQLRequest_Node() {}

func (*AddMySQLRequest_NodeName) isAddMySQLRequest_Node() {}

func (*AddMySQLRequest_AddNode) isAddMySQLRequest_Node() {}

func (m *AddMySQLRequest) GetNode() isAddMySQLRequest_Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (m *AddMySQLRequest) GetNodeId() string {
	if x, ok := m.GetNode().(*AddMySQLRequest_NodeId); ok {
		return x.NodeId
	}
	return ""
}
...
func (m *AddMySQLRequest) GetNodeName() string {
	if x, ok := m.GetNode().(*AddMySQLRequest_NodeName); ok {
		return x.NodeName
	}
	return ""
}

func (m *AddMySQLRequest) GetAddNode() *inventorypb.AddRemoteNodeRequest {
	if x, ok := m.GetNode().(*AddMySQLRequest_AddNode); ok {
		return x.AddNode
	}
	return nil
}
...
func (*AddMySQLRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AddMySQLRequest_NodeId)(nil),
		(*AddMySQLRequest_NodeName)(nil),
		(*AddMySQLRequest_AddNode)(nil),
	}
}
...
var fileDescriptor_ab81470951176953 = []byte{
	...
	,
}
