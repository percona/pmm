...
type OperatorUpdateStatus int32

const (
	OperatorUpdateStatus_OPERATOR_UPDATE_STATUS_INVALID OperatorUpdateStatus = 0
	// An update of the operator is available for the installed version of PMM server.
	OperatorUpdateStatus_UPDATE_AVAILABLE OperatorUpdateStatus = 1
	// An update of the operator is not available for the installed version of PMM server.
	OperatorUpdateStatus_UPDATE_NOT_AVAILABLE OperatorUpdateStatus = 2
	// An update of the operator is available but for more up to date version of
	// PMM server than is currently installed.
	OperatorUpdateStatus_UPDATE_AVAILABLE_BUT_NOT_COMPATIBLE OperatorUpdateStatus = 3
)

// Enum value maps for OperatorUpdateStatus.
var (
	OperatorUpdateStatus_name = map[int32]string{
		0: "OPERATOR_UPDATE_STATUS_INVALID",
		1: "UPDATE_AVAILABLE",
		2: "UPDATE_NOT_AVAILABLE",
		3: "UPDATE_AVAILABLE_BUT_NOT_COMPATIBLE",
	}
	OperatorUpdateStatus_value = map[string]int32{
		"OPERATOR_UPDATE_STATUS_INVALID":      0,
		"UPDATE_AVAILABLE":                    1,
		"UPDATE_NOT_AVAILABLE":                2,
		"UPDATE_AVAILABLE_BUT_NOT_COMPATIBLE": 3,
	}
)

func (x OperatorUpdateStatus) Enum() *OperatorUpdateStatus {
	p := new(OperatorUpdateStatus)
	*p = x
	return p
}

func (x OperatorUpdateStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OperatorUpdateStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_managementpb_dbaas_components_proto_enumTypes[0].Descriptor()
}

func (OperatorUpdateStatus) Type() protoreflect.EnumType {
	return &file_managementpb_dbaas_components_proto_enumTypes[0]
}

func (x OperatorUpdateStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OperatorUpdateStatus.Descriptor instead.
func (OperatorUpdateStatus) EnumDescriptor() ([]byte, []int) {
...
// OperatorUpdateInformation indicates if operator update is available. It includes what version of operator we can update to.
...
type OperatorUpdateInformation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The status indicates operator status availablility.
	Status OperatorUpdateStatus `protobuf:"varint,1,opt,name=status,proto3,enum=dbaas.v1beta1.OperatorUpdateStatus" json:"status,omitempty"`
	// available_operator_version is not empty if there is an update available,
	// for both compatible and incompatible one.
	AvailableOperatorVersion string `protobuf:"bytes,2,opt,name=available_operator_version,json=availableOperatorVersion,proto3" json:"available_operator_version,omitempty"`
	...
	AvailablePmmServerVersion string `protobuf:"bytes,3,opt,name=available_pmm_server_version,json=availablePmmServerVersion,proto3" json:"available_pmm_server_version,omitempty"`
}

func (x *OperatorUpdateInformation) Reset() {
	*x = OperatorUpdateInformation{}
	if protoimpl.UnsafeEnabled {
...
func (x *OperatorUpdateInformation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OperatorUpdateInformation) ProtoMessage() {}

func (x *OperatorUpdateInformation) ProtoReflect() protoreflect.Message {
	mi := &file_managementpb_dbaas_components_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OperatorUpdateInformation.ProtoReflect.Descriptor instead.
func (*OperatorUpdateInformation) Descriptor() ([]byte, []int) {
	return file_managementpb_dbaas_components_proto_rawDescGZIP(), []int{13}
}

func (x *OperatorUpdateInformation) GetStatus() OperatorUpdateStatus {
	if x != nil {
		return x.Status
	}
	return OperatorUpdateStatus_OPERATOR_UPDATE_STATUS_INVALID
}

func (x *OperatorUpdateInformation) GetAvailableOperatorVersion() string {
	if x != nil {
		return x.AvailableOperatorVersion
	}
	return ""
}

func (x *OperatorUpdateInformation) GetAvailablePmmServerVersion() string {
	if x != nil {
		return x.AvailablePmmServerVersion
	}
	return ""
}

// OperatorsUpdateInformation is just a container for update information for PXC and PSMDB operators.
type OperatorsUpdateInformation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PxcOperator   *OperatorUpdateInformation `protobuf:"bytes,1,opt,name=pxc_operator,json=pxcOperator,proto3" json:"pxc_operator,omitempty"`
	PsmdbOperator *OperatorUpdateInformation `protobuf:"bytes,2,opt,name=psmdb_operator,json=psmdbOperator,proto3" json:"psmdb_operator,omitempty"`
}

func (x *OperatorsUpdateInformation) Reset() {
	*x = OperatorsUpdateInformation{}
	if protoimpl.UnsafeEnabled {
...
func (x *OperatorsUpdateInformation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OperatorsUpdateInformation) ProtoMessage() {}

func (x *OperatorsUpdateInformation) ProtoReflect() protoreflect.Message {
	mi := &file_managementpb_dbaas_components_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OperatorsUpdateInformation.ProtoReflect.Descriptor instead.
func (*OperatorsUpdateInformation) Descriptor() ([]byte, []int) {
	return file_managementpb_dbaas_components_proto_rawDescGZIP(), []int{14}
}

func (x *OperatorsUpdateInformation) GetPxcOperator() *OperatorUpdateInformation {
	if x != nil {
...
func (x *OperatorsUpdateInformation) GetPsmdbOperator() *OperatorUpdateInformation {
	if x != nil {
...
type CheckForOperatorUpdateResponse struct {
	...
	UpdateInformation map[string]*OperatorsUpdateInformation `protobuf:"bytes,1,rep,name=update_information,json=updateInformation,proto3" json:"update_information,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *CheckForOperatorUpdateResponse) GetUpdateInformation() map[string]*OperatorsUpdateInformation {
	if x != nil {
		return x.UpdateInformation
	}
	return nil
}
...
func (x *ChangeComponent_ComponentVersion) Reset() {
	*x = ChangeComponent_ComponentVersion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_managementpb_dbaas_components_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_managementpb_dbaas_components_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb3, 0x01, 0x0a, 0x09, 0x43,
	...
	,
	...
	0x12, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x44, 0x2e, 0x64, 0x62, 0x61, 0x61,
	0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x46,
	...
	0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	0x11, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x1a, 0x6f, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f,
	...
	,
	...
	0x74, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x3a, 0x01, 0x2a, 0x12, 0x96, 0x01, 0x0a, 0x10, 0x47, 0x65,
	0x74, 0x50, 0x58, 0x43, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x26,
	0x2e, 0x64, 0x62, 0x61, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x47,
	0x65, 0x74, 0x50, 0x58, 0x43, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e, 0x64, 0x62, 0x61, 0x61, 0x73, 0x2e, 0x76,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x58, 0x43, 0x43, 0x6f, 0x6d,
	...
	0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x47, 0x65, 0x74, 0x50, 0x58, 0x43, 0x3a,
	0x01, 0x2a, 0x12, 0xaa, 0x01, 0x0a, 0x15, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x53, 0x4d,
	0x44, 0x42, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x2b, 0x2e, 0x64,
	...
	0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x64, 0x62, 0x61, 0x61,
	...
	0x2f, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x3a, 0x01, 0x2a, 0x12,
	0xa2, 0x01, 0x0a, 0x13, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x58, 0x43, 0x43, 0x6f, 0x6d,
	0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x29, 0x2e, 0x64, 0x62, 0x61, 0x61, 0x73, 0x2e,
	0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x58,
	...
	0x61, 0x31, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x58, 0x43, 0x43, 0x6f, 0x6d, 0x70,
	0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x34,
	...
	0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x58,
	0x43, 0x3a, 0x01, 0x2a, 0x12, 0xb8, 0x01, 0x0a, 0x16, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x46, 0x6f,
	0x72, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12,
	...
	0xe4, 0x93, 0x02, 0x3b, 0x22, 0x36, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	...
	0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x42,
...
var file_managementpb_dbaas_components_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_managementpb_dbaas_components_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_managementpb_dbaas_components_proto_goTypes = []interface{}{
	(OperatorUpdateStatus)(0),                // 0: dbaas.v1beta1.OperatorUpdateStatus
	(*Component)(nil),                        // 1: dbaas.v1beta1.Component
	(*Matrix)(nil),                           // 2: dbaas.v1beta1.Matrix
	(*OperatorVersion)(nil),                  // 3: dbaas.v1beta1.OperatorVersion
	(*GetPSMDBComponentsRequest)(nil),        // 4: dbaas.v1beta1.GetPSMDBComponentsRequest
	(*GetPSMDBComponentsResponse)(nil),       // 5: dbaas.v1beta1.GetPSMDBComponentsResponse
	(*GetPXCComponentsRequest)(nil),          // 6: dbaas.v1beta1.GetPXCComponentsRequest
	(*GetPXCComponentsResponse)(nil),         // 7: dbaas.v1beta1.GetPXCComponentsResponse
	(*ChangeComponent)(nil),                  // 8: dbaas.v1beta1.ChangeComponent
	(*ChangePSMDBComponentsRequest)(nil),     // 9: dbaas.v1beta1.ChangePSMDBComponentsRequest
	(*ChangePSMDBComponentsResponse)(nil),    // 10: dbaas.v1beta1.ChangePSMDBComponentsResponse
	(*ChangePXCComponentsRequest)(nil),       // 11: dbaas.v1beta1.ChangePXCComponentsRequest
	(*ChangePXCComponentsResponse)(nil),      // 12: dbaas.v1beta1.ChangePXCComponentsResponse
	(*CheckForOperatorUpdateRequest)(nil),    // 13: dbaas.v1beta1.CheckForOperatorUpdateRequest
	(*OperatorUpdateInformation)(nil),        // 14: dbaas.v1beta1.OperatorUpdateInformation
	(*OperatorsUpdateInformation)(nil),       // 15: dbaas.v1beta1.OperatorsUpdateInformation
	(*CheckForOperatorUpdateResponse)(nil),   // 16: dbaas.v1beta1.CheckForOperatorUpdateResponse
	nil,                                      // 17: dbaas.v1beta1.Matrix.MongodEntry
	nil,                                      // 18: dbaas.v1beta1.Matrix.PxcEntry
	nil,                                      // 19: dbaas.v1beta1.Matrix.PmmEntry
	nil,                                      // 20: dbaas.v1beta1.Matrix.ProxysqlEntry
	nil,                                      // 21: dbaas.v1beta1.Matrix.HaproxyEntry
	nil,                                      // 22: dbaas.v1beta1.Matrix.BackupEntry
	nil,                                      // 23: dbaas.v1beta1.Matrix.OperatorEntry
	nil,                                      // 24: dbaas.v1beta1.Matrix.LogCollectorEntry
	(*ChangeComponent_ComponentVersion)(nil), // 25: dbaas.v1beta1.ChangeComponent.ComponentVersion
	nil,                                      // 26: dbaas.v1beta1.CheckForOperatorUpdateResponse.UpdateInformationEntry
}
var file_managementpb_dbaas_components_proto_depIdxs = []int32{
	17, // 0: dbaas.v1beta1.Matrix.mongod:type_name -> dbaas.v1beta1.Matrix.MongodEntry
	18, // 1: dbaas.v1beta1.Matrix.pxc:type_name -> dbaas.v1beta1.Matrix.PxcEntry
	19, // 2: dbaas.v1beta1.Matrix.pmm:type_name -> dbaas.v1beta1.Matrix.PmmEntry
	20, // 3: dbaas.v1beta1.Matrix.proxysql:type_name -> dbaas.v1beta1.Matrix.ProxysqlEntry
	21, // 4: dbaas.v1beta1.Matrix.haproxy:type_name -> dbaas.v1beta1.Matrix.HaproxyEntry
	22, // 5: dbaas.v1beta1.Matrix.backup:type_name -> dbaas.v1beta1.Matrix.BackupEntry
	23, // 6: dbaas.v1beta1.Matrix.operator:type_name -> dbaas.v1beta1.Matrix.OperatorEntry
	24, // 7: dbaas.v1beta1.Matrix.log_collector:type_name -> dbaas.v1beta1.Matrix.LogCollectorEntry
	2,  // 8: dbaas.v1beta1.OperatorVersion.matrix:type_name -> dbaas.v1beta1.Matrix
	3,  // 9: dbaas.v1beta1.GetPSMDBComponentsResponse.versions:type_name -> dbaas.v1beta1.OperatorVersion
	3,  // 10: dbaas.v1beta1.GetPXCComponentsResponse.versions:type_name -> dbaas.v1beta1.OperatorVersion
	25, // 11: dbaas.v1beta1.ChangeComponent.versions:type_name -> dbaas.v1beta1.ChangeComponent.ComponentVersion
	8,  // 12: dbaas.v1beta1.ChangePSMDBComponentsRequest.mongod:type_name -> dbaas.v1beta1.ChangeComponent
	8,  // 13: dbaas.v1beta1.ChangePXCComponentsRequest.pxc:type_name -> dbaas.v1beta1.ChangeComponent
	8,  // 14: dbaas.v1beta1.ChangePXCComponentsRequest.proxysql:type_name -> dbaas.v1beta1.ChangeComponent
	8,  // 15: dbaas.v1beta1.ChangePXCComponentsRequest.haproxy:type_name -> dbaas.v1beta1.ChangeComponent
	0,  // 16: dbaas.v1beta1.OperatorUpdateInformation.status:type_name -> dbaas.v1beta1.OperatorUpdateStatus
	14, // 17: dbaas.v1beta1.OperatorsUpdateInformation.pxc_operator:type_name -> dbaas.v1beta1.OperatorUpdateInformation
	14, // 18: dbaas.v1beta1.OperatorsUpdateInformation.psmdb_operator:type_name -> dbaas.v1beta1.OperatorUpdateInformation
	26, // 19: dbaas.v1beta1.CheckForOperatorUpdateResponse.update_information:type_name -> dbaas.v1beta1.CheckForOperatorUpdateResponse.UpdateInformationEntry
	1,  // 20: dbaas.v1beta1.Matrix.MongodEntry.value:type_name -> dbaas.v1beta1.Component
	1,  // 21: dbaas.v1beta1.Matrix.PxcEntry.value:type_name -> dbaas.v1beta1.Component
	1,  // 22: dbaas.v1beta1.Matrix.PmmEntry.value:type_name -> dbaas.v1beta1.Component
	1,  // 23: dbaas.v1beta1.Matrix.ProxysqlEntry.value:type_name -> dbaas.v1beta1.Component
	1,  // 24: dbaas.v1beta1.Matrix.HaproxyEntry.value:type_name -> dbaas.v1beta1.Component
	1,  // 25: dbaas.v1beta1.Matrix.BackupEntry.value:type_name -> dbaas.v1beta1.Component
	1,  // 26: dbaas.v1beta1.Matrix.OperatorEntry.value:type_name -> dbaas.v1beta1.Component
	1,  // 27: dbaas.v1beta1.Matrix.LogCollectorEntry.value:type_name -> dbaas.v1beta1.Component
	15, // 28: dbaas.v1beta1.CheckForOperatorUpdateResponse.UpdateInformationEntry.value:type_name -> dbaas.v1beta1.OperatorsUpdateInformation
	4,  // 29: dbaas.v1beta1.Components.GetPSMDBComponents:input_type -> dbaas.v1beta1.GetPSMDBComponentsRequest
	6,  // 30: dbaas.v1beta1.Components.GetPXCComponents:input_type -> dbaas.v1beta1.GetPXCComponentsRequest
	9,  // 31: dbaas.v1beta1.Components.ChangePSMDBComponents:input_type -> dbaas.v1beta1.ChangePSMDBComponentsRequest
	11, // 32: dbaas.v1beta1.Components.ChangePXCComponents:input_type -> dbaas.v1beta1.ChangePXCComponentsRequest
	13, // 33: dbaas.v1beta1.Components.CheckForOperatorUpdate:input_type -> dbaas.v1beta1.CheckForOperatorUpdateRequest
	5,  // 34: dbaas.v1beta1.Components.GetPSMDBComponents:output_type -> dbaas.v1beta1.GetPSMDBComponentsResponse
	7,  // 35: dbaas.v1beta1.Components.GetPXCComponents:output_type -> dbaas.v1beta1.GetPXCComponentsResponse
	10, // 36: dbaas.v1beta1.Components.ChangePSMDBComponents:output_type -> dbaas.v1beta1.ChangePSMDBComponentsResponse
	12, // 37: dbaas.v1beta1.Components.ChangePXCComponents:output_type -> dbaas.v1beta1.ChangePXCComponentsResponse
	16, // 38: dbaas.v1beta1.Components.CheckForOperatorUpdate:output_type -> dbaas.v1beta1.CheckForOperatorUpdateResponse
...
func file_managementpb_dbaas_components_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_managementpb_dbaas_components_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OperatorUpdateInformation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_managementpb_dbaas_components_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OperatorsUpdateInformation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_managementpb_dbaas_components_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_managementpb_dbaas_components_proto_enumTypes,
