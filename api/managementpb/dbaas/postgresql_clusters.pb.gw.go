...
var pattern_PostgresqlClusters_CreatePostgresqlCluster_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"v1", "management", "DBaaS", "PostgresqlCluster", "Create"}, ""))

var forward_PostgresqlClusters_CreatePostgresqlCluster_0 = runtime.ForwardResponseMessage
