...
// Validate checks the field values on PostgresqlCluster with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *PostgresqlCluster) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PostgresqlCluster with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PostgresqlClusterMultiError, or nil if none found.
func (m *PostgresqlCluster) ValidateAll() error {
	return m.validate(true)
}

func (m *PostgresqlCluster) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, PostgresqlClusterValidationError{
					field:  "Operation",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return PostgresqlClusterValidationError{
				field:  "Operation",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return PostgresqlClusterMultiError(errors)
	}

	return nil
}

// PostgresqlClusterMultiError is an error wrapping multiple validation errors
// returned by PostgresqlCluster.ValidateAll() if the designated constraints
// aren't met.
type PostgresqlClusterMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PostgresqlClusterMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PostgresqlClusterMultiError) AllErrors() []error { return m }

// PostgresqlClusterValidationError is the validation error returned by
// PostgresqlCluster.Validate if the designated constraints aren't met.
type PostgresqlClusterValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PostgresqlClusterValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PostgresqlClusterValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PostgresqlClusterValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PostgresqlClusterValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PostgresqlClusterValidationError) ErrorName() string {
	return "PostgresqlClusterValidationError"
}

// Error satisfies the builtin error interface
func (e PostgresqlClusterValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPostgresqlCluster.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PostgresqlClusterValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PostgresqlClusterValidationError{}
...
func (m *ListDBClustersResponse) validate(all bool) error {
	...
	for idx, item := range m.GetPostgresqlClusters() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ListDBClustersResponseValidationError{
						field:  fmt.Sprintf("PostgresqlClusters[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
...
func (m *GetDBClusterResponse) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetPostgresqlCluster()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetDBClusterResponseValidationError{
					field:  "PostgresqlCluster",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetPostgresqlCluster()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return GetDBClusterResponseValidationError{
				field:  "PostgresqlCluster",
				reason: "embedded message failed validation",
