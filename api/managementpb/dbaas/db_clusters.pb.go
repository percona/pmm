...
var file_managementpb_dbaas_db_clusters_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x17, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74,
	...
	0x44, 0x49, 0x4e, 0x47, 0x10, 0x06, 0x32, 0xe2, 0x05, 0x0a, 0x0a, 0x44, 0x42, 0x43, 0x6c, 0x75,
	...
	,
	...
	0xa2, 0x02, 0x03, 0x44, 0x58, 0x58, 0xaa, 0x02, 0x0d, 0x44, 0x62, 0x61, 0x61, 0x73, 0x2e, 0x56,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xca, 0x02, 0x0d, 0x44, 0x62, 0x61, 0x61, 0x73, 0x5c, 0x56,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xe2, 0x02, 0x19, 0x44, 0x62, 0x61, 0x61, 0x73, 0x5c, 0x56,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0xea, 0x02, 0x0e, 0x44, 0x62, 0x61, 0x61, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x65,
...
var (
	...
	file_managementpb_dbaas_db_clusters_proto_msgTypes  = make([]protoimpl.MessageInfo, 13)
	file_managementpb_dbaas_db_clusters_proto_goTypes   = []interface{}{
		...
		(*Backup)(nil),                   // 16: dbaas.v1beta1.Backup
		(*Restore)(nil),                  // 17: dbaas.v1beta1.Restore
		(*PXCClusterParams)(nil),         // 18: dbaas.v1beta1.PXCClusterParams
		(DBClusterType)(0),               // 19: dbaas.v1beta1.DBClusterType
	}
)
...
var file_managementpb_dbaas_db_clusters_proto_depIdxs = []int32{
	...
	14, // 1: dbaas.v1beta1.PSMDBCluster.operation:type_name -> dbaas.v1beta1.RunningOperation
	15, // 2: dbaas.v1beta1.PSMDBCluster.params:type_name -> dbaas.v1beta1.PSMDBClusterParams
	16, // 3: dbaas.v1beta1.PSMDBCluster.backup:type_name -> dbaas.v1beta1.Backup
	17, // 4: dbaas.v1beta1.PSMDBCluster.restore:type_name -> dbaas.v1beta1.Restore
	0,  // 5: dbaas.v1beta1.PXCCluster.state:type_name -> dbaas.v1beta1.DBClusterState
	14, // 6: dbaas.v1beta1.PXCCluster.operation:type_name -> dbaas.v1beta1.RunningOperation
	18, // 7: dbaas.v1beta1.PXCCluster.params:type_name -> dbaas.v1beta1.PXCClusterParams
	16, // 8: dbaas.v1beta1.PXCCluster.backup:type_name -> dbaas.v1beta1.Backup
	17, // 9: dbaas.v1beta1.PXCCluster.restore:type_name -> dbaas.v1beta1.Restore
	...
	19, // 12: dbaas.v1beta1.RestartDBClusterRequest.cluster_type:type_name -> dbaas.v1beta1.DBClusterType
	...
	19, // 15: dbaas.v1beta1.DeleteDBClusterRequest.cluster_type:type_name -> dbaas.v1beta1.DBClusterType
	3,  // 16: dbaas.v1beta1.DBClusters.ListDBClusters:input_type -> dbaas.v1beta1.ListDBClustersRequest
	7,  // 17: dbaas.v1beta1.DBClusters.GetDBCluster:input_type -> dbaas.v1beta1.GetDBClusterRequest
	5,  // 18: dbaas.v1beta1.DBClusters.RestartDBCluster:input_type -> dbaas.v1beta1.RestartDBClusterRequest
	9,  // 19: dbaas.v1beta1.DBClusters.DeleteDBCluster:input_type -> dbaas.v1beta1.DeleteDBClusterRequest
	12, // 20: dbaas.v1beta1.DBClusters.ListS3Backups:input_type -> dbaas.v1beta1.ListS3BackupsRequest
	4,  // 21: dbaas.v1beta1.DBClusters.ListDBClusters:output_type -> dbaas.v1beta1.ListDBClustersResponse
	8,  // 22: dbaas.v1beta1.DBClusters.GetDBCluster:output_type -> dbaas.v1beta1.GetDBClusterResponse
	6,  // 23: dbaas.v1beta1.DBClusters.RestartDBCluster:output_type -> dbaas.v1beta1.RestartDBClusterResponse
	10, // 24: dbaas.v1beta1.DBClusters.DeleteDBCluster:output_type -> dbaas.v1beta1.DeleteDBClusterResponse
	13, // 25: dbaas.v1beta1.DBClusters.ListS3Backups:output_type -> dbaas.v1beta1.ListS3BackupsResponse
