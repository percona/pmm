...
var file_managementpb_dbaas_psmdb_cluster_proto_rawDesc = []byte{
	...
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x50, 0x41, 0x55, 0x53, 0x45, 0x44, 0x10, 0x05, 0x32, 0xea, 0x07,
	...
	0x65, 0x72, 0x73, 0x2f, 0x4c, 0x69, 0x73, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0xb4, 0x01, 0x0a, 0x0f,
	...
	0x74, 0x1a, 0x31, 0x2e, 0x64, 0x62, 0x61, 0x61, 0x73, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	...
	0x01, 0x2a, 0x12, 0x9e, 0x01, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x53, 0x4d,
	...
	0x3a, 0x01, 0x2a, 0x12, 0x9e, 0x01, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x53,
	...
	0x4d, 0x44, 0x42, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x2f, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x3a, 0x01, 0x2a, 0x12, 0x9e, 0x01, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50,
	...
	0x53, 0x4d, 0x44, 0x42, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x2f, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0xa2, 0x01, 0x0a, 0x13, 0x52, 0x65, 0x73, 0x74, 0x61, 0x72,
	0x74, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x12, 0x29, 0x2e,
	...
	0x52, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x3a, 0x01, 0x2a, 0x42, 0x25, 0x5a, 0x23, 0x61, 0x70,
...
var file_managementpb_dbaas_psmdb_cluster_proto_depIdxs = []int32{
	...
	4,  // 11: dbaas.v1beta1.PSMDBCluster.GetPSMDBCluster:input_type -> dbaas.v1beta1.GetPSMDBClusterCredentialsRequest
	...
	5,  // 17: dbaas.v1beta1.PSMDBCluster.GetPSMDBCluster:output_type -> dbaas.v1beta1.GetPSMDBClusterCredentialsResponse
...
type PSMDBClusterClient interface {
	...
	GetPSMDBCluster(ctx context.Context, in *GetPSMDBClusterCredentialsRequest, opts ...grpc.CallOption) (*GetPSMDBClusterCredentialsResponse, error)
...
func (c *pSMDBClusterClient) GetPSMDBCluster(ctx context.Context, in *GetPSMDBClusterCredentialsRequest, opts ...grpc.CallOption) (*GetPSMDBClusterCredentialsResponse, error) {
...
type PSMDBClusterServer interface {
	...
	// GetPSMDBCluster returns a PSMDB cluster by name.
	GetPSMDBCluster(context.Context, *GetPSMDBClusterCredentialsRequest) (*GetPSMDBClusterCredentialsResponse, error)
	// CreatePSMDBCluster creates a new PSMDB cluster.
...
func (*UnimplementedPSMDBClusterServer) GetPSMDBCluster(context.Context, *GetPSMDBClusterCredentialsRequest) (*GetPSMDBClusterCredentialsResponse, error) {
...
func _PSMDBCluster_GetPSMDBCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PSMDBClusterServer).GetPSMDBCluster(ctx, req.(*GetPSMDBClusterCredentialsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
