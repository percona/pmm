...
var file_managementpb_dbaas_dbaas_proto_rawDesc = string([]byte{
...
var (
	...
	file_managementpb_dbaas_dbaas_proto_rawDescData []byte
)

func file_managementpb_dbaas_dbaas_proto_rawDescGZIP() []byte {
	file_managementpb_dbaas_dbaas_proto_rawDescOnce.Do(func() {
		file_managementpb_dbaas_dbaas_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_managementpb_dbaas_dbaas_proto_rawDesc), len(file_managementpb_dbaas_dbaas_proto_rawDesc)))
	})
...
func file_managementpb_dbaas_dbaas_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_managementpb_dbaas_dbaas_proto_rawDesc), len(file_managementpb_dbaas_dbaas_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
