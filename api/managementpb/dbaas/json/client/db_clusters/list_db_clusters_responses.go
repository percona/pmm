...
type ListDBClustersOKBody struct {
	...
	PostgresqlClusters []*ListDBClustersOKBodyPostgresqlClustersItems0 `json:"postgresql_clusters"`
}
...
func (o *ListDBClustersOKBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validatePostgresqlClusters(formats); err != nil {
		res = append(res, err)
	}
...
func (o *ListDBClustersOKBody) validatePostgresqlClusters(formats strfmt.Registry) error {
	if swag.IsZero(o.PostgresqlClusters) { // not required
		return nil
	}

	for i := 0; i < len(o.PostgresqlClusters); i++ {
		if swag.IsZero(o.PostgresqlClusters[i]) { // not required
			continue
		}

		if o.PostgresqlClusters[i] != nil {
			if err := o.PostgresqlClusters[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("listDbClustersOk" + "." + "postgresql_clusters" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("listDbClustersOk" + "." + "postgresql_clusters" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ListDBClustersOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidatePostgresqlClusters(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *ListDBClustersOKBody) contextValidatePostgresqlClusters(ctx context.Context, formats strfmt.Registry) error {
	for i := 0; i < len(o.PostgresqlClusters); i++ {
		if o.PostgresqlClusters[i] != nil {
			if err := o.PostgresqlClusters[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("listDbClustersOk" + "." + "postgresql_clusters" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("listDbClustersOk" + "." + "postgresql_clusters" + "." + strconv.Itoa(i))
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0 PostgresqlCluster represents Postgresql cluster information.
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0
*/
type ListDBClustersOKBodyPostgresqlClustersItems0 struct {
	// Cluster name.
	Name string `json:"name,omitempty"`
	...
	// backup
	Backup *ListDBClustersOKBodyPostgresqlClustersItems0Backup `json:"backup,omitempty"`

	// operation
	Operation *ListDBClustersOKBodyPostgresqlClustersItems0Operation `json:"operation,omitempty"`

	// params
	Params *ListDBClustersOKBodyPostgresqlClustersItems0Params `json:"params,omitempty"`

	// restore
	Restore *ListDBClustersOKBodyPostgresqlClustersItems0Restore `json:"restore,omitempty"`

	// template
	Template *ListDBClustersOKBodyPostgresqlClustersItems0Template `json:"template,omitempty"`
}

// Validate validates this list DB clusters OK body postgresql clusters items0
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
var listDbClustersOkBodyPostgresqlClustersItems0TypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		listDbClustersOkBodyPostgresqlClustersItems0TypeStatePropEnum = append(listDbClustersOkBodyPostgresqlClustersItems0TypeStatePropEnum, v)
	}
}

const (

	// ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEINVALID captures enum value "DB_CLUSTER_STATE_INVALID"
	ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEINVALID string = "DB_CLUSTER_STATE_INVALID"

	// ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATECHANGING captures enum value "DB_CLUSTER_STATE_CHANGING"
	ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATECHANGING string = "DB_CLUSTER_STATE_CHANGING"

	// ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEREADY captures enum value "DB_CLUSTER_STATE_READY"
	ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEREADY string = "DB_CLUSTER_STATE_READY"

	// ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEFAILED captures enum value "DB_CLUSTER_STATE_FAILED"
	ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEFAILED string = "DB_CLUSTER_STATE_FAILED"

	// ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEDELETING captures enum value "DB_CLUSTER_STATE_DELETING"
	ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEDELETING string = "DB_CLUSTER_STATE_DELETING"

	// ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEPAUSED captures enum value "DB_CLUSTER_STATE_PAUSED"
	ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEPAUSED string = "DB_CLUSTER_STATE_PAUSED"

	// ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEUPGRADING captures enum value "DB_CLUSTER_STATE_UPGRADING"
	ListDBClustersOKBodyPostgresqlClustersItems0StateDBCLUSTERSTATEUPGRADING string = "DB_CLUSTER_STATE_UPGRADING"
)

// prop value enum
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, listDbClustersOkBodyPostgresqlClustersItems0TypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *ListDBClustersOKBodyPostgresqlClustersItems0) validateState(formats strfmt.Registry) error {
	if swag.IsZero(o.State) { // not required
		return nil
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) validateBackup(formats strfmt.Registry) error {
	if swag.IsZero(o.Backup) { // not required
		return nil
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) validateOperation(formats strfmt.Registry) error {
	if swag.IsZero(o.Operation) { // not required
		return nil
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) validateParams(formats strfmt.Registry) error {
	if swag.IsZero(o.Params) { // not required
		return nil
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) validateRestore(formats strfmt.Registry) error {
	if swag.IsZero(o.Restore) { // not required
		return nil
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) validateTemplate(formats strfmt.Registry) error {
	if swag.IsZero(o.Template) { // not required
		return nil
	}
...
// ContextValidate validate this list DB clusters OK body postgresql clusters items0 based on the context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) contextValidateBackup(ctx context.Context, formats strfmt.Registry) error {
	if o.Backup != nil {
		if err := o.Backup.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("backup")
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
	if o.Operation != nil {
		if err := o.Operation.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("operation")
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) contextValidateParams(ctx context.Context, formats strfmt.Registry) error {
	if o.Params != nil {
		if err := o.Params.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params")
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) contextValidateRestore(ctx context.Context, formats strfmt.Registry) error {
	if o.Restore != nil {
		if err := o.Restore.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("restore")
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) contextValidateTemplate(ctx context.Context, formats strfmt.Registry) error {
	if o.Template != nil {
		if err := o.Template.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("template")
...
// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0Backup Backup configuration for a database cluster
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0Backup
*/
type ListDBClustersOKBodyPostgresqlClustersItems0Backup struct {
	// Backup Location id of stored backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 backup
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Backup) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 backup based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Backup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Backup) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Backup) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0Backup
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0Operation RunningOperation respresents a long-running operation.
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0Operation
*/
type ListDBClustersOKBodyPostgresqlClustersItems0Operation struct {
	// Finished steps of the operaion; can decrease or increase compared to the previous value.
	FinishedSteps int32 `json:"finished_steps,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 operation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Operation) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 operation based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Operation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Operation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Operation) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0Operation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0Params PostgresqlClusterParams represents Postgresql cluster parameters that can be updated.
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0Params
*/
type ListDBClustersOKBodyPostgresqlClustersItems0Params struct {
	// Cluster size.
	ClusterSize int32 `json:"cluster_size,omitempty"`

	// backup
	Backup *ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup `json:"backup,omitempty"`

	// instance
	Instance *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance `json:"instance,omitempty"`

	// pgbouncer
	Pgbouncer *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer `json:"pgbouncer,omitempty"`

	// restore
	Restore *ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore `json:"restore,omitempty"`
}

// Validate validates this list DB clusters OK body postgresql clusters items0 params
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) validateBackup(formats strfmt.Registry) error {
	if swag.IsZero(o.Backup) { // not required
		return nil
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) validateInstance(formats strfmt.Registry) error {
	...
	if o.Instance != nil {
		if err := o.Instance.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "instance")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("params" + "." + "instance")
			}
			return err
		}
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) validatePgbouncer(formats strfmt.Registry) error {
	...
	if o.Pgbouncer != nil {
		if err := o.Pgbouncer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "pgbouncer")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("params" + "." + "pgbouncer")
			}
			return err
		}
	}
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) validateRestore(formats strfmt.Registry) error {
	if swag.IsZero(o.Restore) { // not required
		return nil
	}
...
// ContextValidate validate this list DB clusters OK body postgresql clusters items0 params based on the context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) contextValidateBackup(ctx context.Context, formats strfmt.Registry) error {
	if o.Backup != nil {
		if err := o.Backup.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "backup")
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) contextValidateInstance(ctx context.Context, formats strfmt.Registry) error {
	if o.Instance != nil {
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) contextValidatePgbouncer(ctx context.Context, formats strfmt.Registry) error {
	if o.Pgbouncer != nil {
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) contextValidateRestore(ctx context.Context, formats strfmt.Registry) error {
	if o.Restore != nil {
		if err := o.Restore.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "restore")
...
// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Params) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0Params
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup Backup configuration for a database cluster
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup
*/
type ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup struct {
	// Backup Location id of stored backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 params backup
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 params backup based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0ParamsBackup
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance Instance container parameters.
// TODO Do not use inner messages in all public APIs (for consistency).
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance
*/
type ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance struct {
	...
	// compute resources
	ComputeResources *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources `json:"compute_resources,omitempty"`
}

// Validate validates this list DB clusters OK body postgresql clusters items0 params instance
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance) validateComputeResources(formats strfmt.Registry) error {
	if swag.IsZero(o.ComputeResources) { // not required
		return nil
	}
	...
	if o.ComputeResources != nil {
		if err := o.ComputeResources.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "instance" + "." + "compute_resources")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("params" + "." + "instance" + "." + "compute_resources")
			}
			return err
		}
	}
...
// ContextValidate validate this list DB clusters OK body postgresql clusters items0 params instance based on the context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance) contextValidateComputeResources(ctx context.Context, formats strfmt.Registry) error {
	if o.ComputeResources != nil {
		if err := o.ComputeResources.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "instance" + "." + "compute_resources")
...
// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstance
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources ComputeResources represents container computer resources requests or limits.
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources
*/
type ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources struct {
	// CPUs in milliCPUs; 1000m = 1 vCPU.
	CPUm int32 `json:"cpu_m,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 params instance compute resources
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 params instance compute resources based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0ParamsInstanceComputeResources
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer PGBouncer container parameters.
// TODO Do not use inner messages in all public APIs (for consistency).
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer
*/
type ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer struct {
	...
	// compute resources
	ComputeResources *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources `json:"compute_resources,omitempty"`
}

// Validate validates this list DB clusters OK body postgresql clusters items0 params pgbouncer
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer) validateComputeResources(formats strfmt.Registry) error {
	if swag.IsZero(o.ComputeResources) { // not required
		return nil
	}
	...
	if o.ComputeResources != nil {
		if err := o.ComputeResources.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "pgbouncer" + "." + "compute_resources")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("params" + "." + "pgbouncer" + "." + "compute_resources")
			}
			return err
		}
	}
...
// ContextValidate validate this list DB clusters OK body postgresql clusters items0 params pgbouncer based on the context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer) contextValidateComputeResources(ctx context.Context, formats strfmt.Registry) error {
	if o.ComputeResources != nil {
		if err := o.ComputeResources.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("params" + "." + "pgbouncer" + "." + "compute_resources")
...
// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncer
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources ComputeResources represents container computer resources requests or limits.
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources
*/
type ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources struct {
	// CPUs in milliCPUs; 1000m = 1 vCPU.
	CPUm int32 `json:"cpu_m,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 params pgbouncer compute resources
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 params pgbouncer compute resources based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0ParamsPgbouncerComputeResources
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore Restore represents restoration payload to restore a database cluster from backup
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore
*/
type ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore struct {
	// Backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 params restore
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 params restore based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0ParamsRestore
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0Restore Restore represents restoration payload to restore a database cluster from backup
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0Restore
*/
type ListDBClustersOKBodyPostgresqlClustersItems0Restore struct {
	// Backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 restore
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Restore) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 restore based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Restore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Restore) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Restore) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0Restore
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ListDBClustersOKBodyPostgresqlClustersItems0Template list DB clusters OK body postgresql clusters items0 template
swagger:model ListDBClustersOKBodyPostgresqlClustersItems0Template
*/
type ListDBClustersOKBodyPostgresqlClustersItems0Template struct {
	// Template CR name.
	Name string `json:"name,omitempty"`
...
// Validate validates this list DB clusters OK body postgresql clusters items0 template
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Template) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list DB clusters OK body postgresql clusters items0 template based on context it is used
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Template) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Template) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListDBClustersOKBodyPostgresqlClustersItems0Template) UnmarshalBinary(b []byte) error {
	var res ListDBClustersOKBodyPostgresqlClustersItems0Template
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
