...
// DBClustersListDBClustersReader is a Reader for the DBClustersListDBClusters structure.
type DBClustersListDBClustersReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *DBClustersListDBClustersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewDBClustersListDBClustersOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDBClustersListDBClustersDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewDBClustersListDBClustersOK creates a DBClustersListDBClustersOK with default headers values
func NewDBClustersListDBClustersOK() *DBClustersListDBClustersOK {
	return &DBClustersListDBClustersOK{}
}

/*DBClustersListDBClustersOK handles this case with default header values.

A successful response.
*/
type DBClustersListDBClustersOK struct {
	Payload *DBClustersListDBClustersOKBody
}

func (o *DBClustersListDBClustersOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/DBaaS/DBClusters/List][%d] dbClustersListDbClustersOk  %+v", 200, o.Payload)
}

func (o *DBClustersListDBClustersOK) GetPayload() *DBClustersListDBClustersOKBody {
	return o.Payload
}

func (o *DBClustersListDBClustersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(DBClustersListDBClustersOKBody)
...
// NewDBClustersListDBClustersDefault creates a DBClustersListDBClustersDefault with default headers values
func NewDBClustersListDBClustersDefault(code int) *DBClustersListDBClustersDefault {
	return &DBClustersListDBClustersDefault{
		_statusCode: code,
	}
}

/*DBClustersListDBClustersDefault handles this case with default header values.

An unexpected error response.
*/
type DBClustersListDBClustersDefault struct {
	_statusCode int

	Payload *DBClustersListDBClustersDefaultBody
}

// Code gets the status code for the DB clusters list DB clusters default response
func (o *DBClustersListDBClustersDefault) Code() int {
	return o._statusCode
}

func (o *DBClustersListDBClustersDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/DBaaS/DBClusters/List][%d] DBClusters_ListDBClusters default  %+v", o._statusCode, o.Payload)
}

func (o *DBClustersListDBClustersDefault) GetPayload() *DBClustersListDBClustersDefaultBody {
	return o.Payload
}

func (o *DBClustersListDBClustersDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(DBClustersListDBClustersDefaultBody)
...
/*DBClustersListDBClustersBody DB clusters list DB clusters body
swagger:model DBClustersListDBClustersBody
*/
type DBClustersListDBClustersBody struct {

	// Kubernetes cluster name.
	KubernetesClusterName string `json:"kubernetes_cluster_name,omitempty"`
}

// Validate validates this DB clusters list DB clusters body
func (o *DBClustersListDBClustersBody) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *DBClustersListDBClustersBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *DBClustersListDBClustersBody) UnmarshalBinary(b []byte) error {
	var res DBClustersListDBClustersBody
...
/*DBClustersListDBClustersDefaultBody DB clusters list DB clusters default body
swagger:model DBClustersListDBClustersDefaultBody
*/
type DBClustersListDBClustersDefaultBody struct {
...
// Validate validates this DB clusters list DB clusters default body
func (o *DBClustersListDBClustersDefaultBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DBClustersListDBClustersDefaultBody) validateDetails(formats strfmt.Registry) error {
		...
		if o.Details[i] != nil {
			if err := o.Details[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("DBClusters_ListDBClusters default" + "." + "details" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// MarshalBinary interface implementation
func (o *DBClustersListDBClustersDefaultBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *DBClustersListDBClustersDefaultBody) UnmarshalBinary(b []byte) error {
	var res DBClustersListDBClustersDefaultBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*DBClustersListDBClustersOKBody DB clusters list DB clusters OK body
swagger:model DBClustersListDBClustersOKBody
*/
type DBClustersListDBClustersOKBody struct {
...
// Validate validates this DB clusters list DB clusters OK body
func (o *DBClustersListDBClustersOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DBClustersListDBClustersOKBody) validatePXCClusters(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.PXCClusters); i++ {
		...
		if o.PXCClusters[i] != nil {
			if err := o.PXCClusters[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("dbClustersListDbClustersOk" + "." + "pxc_clusters" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *DBClustersListDBClustersOKBody) validatePSMDBClusters(formats strfmt.Registry) error {
	...
	for i := 0; i < len(o.PSMDBClusters); i++ {
		...
		if o.PSMDBClusters[i] != nil {
			if err := o.PSMDBClusters[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("dbClustersListDbClustersOk" + "." + "psmdb_clusters" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// MarshalBinary interface implementation
func (o *DBClustersListDBClustersOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *DBClustersListDBClustersOKBody) UnmarshalBinary(b []byte) error {
	var res DBClustersListDBClustersOKBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
