...
type GetDBClusterOKBody struct {
	// postgresql cluster
	PostgresqlCluster *GetDBClusterOKBodyPostgresqlCluster `json:"postgresql_cluster,omitempty"`
...
func (o *GetDBClusterOKBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validatePostgresqlCluster(formats); err != nil {
		res = append(res, err)
	}
...
func (o *GetDBClusterOKBody) validatePostgresqlCluster(formats strfmt.Registry) error {
	if swag.IsZero(o.PostgresqlCluster) { // not required
		return nil
	}

	if o.PostgresqlCluster != nil {
		if err := o.PostgresqlCluster.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidatePostgresqlCluster(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *GetDBClusterOKBody) contextValidatePostgresqlCluster(ctx context.Context, formats strfmt.Registry) error {
	if o.PostgresqlCluster != nil {
		if err := o.PostgresqlCluster.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster")
...
/*
GetDBClusterOKBodyPostgresqlCluster PostgresqlCluster represents Postgresql cluster information.
swagger:model GetDBClusterOKBodyPostgresqlCluster
*/
type GetDBClusterOKBodyPostgresqlCluster struct {
	// Cluster name.
	Name string `json:"name,omitempty"`
	...
	// backup
	Backup *GetDBClusterOKBodyPostgresqlClusterBackup `json:"backup,omitempty"`

	// operation
	Operation *GetDBClusterOKBodyPostgresqlClusterOperation `json:"operation,omitempty"`

	// params
	Params *GetDBClusterOKBodyPostgresqlClusterParams `json:"params,omitempty"`

	// restore
	Restore *GetDBClusterOKBodyPostgresqlClusterRestore `json:"restore,omitempty"`

	// template
	Template *GetDBClusterOKBodyPostgresqlClusterTemplate `json:"template,omitempty"`
}

// Validate validates this get DB cluster OK body postgresql cluster
func (o *GetDBClusterOKBodyPostgresqlCluster) Validate(formats strfmt.Registry) error {
	var res []error
...
var getDbClusterOkBodyPostgresqlClusterTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		getDbClusterOkBodyPostgresqlClusterTypeStatePropEnum = append(getDbClusterOkBodyPostgresqlClusterTypeStatePropEnum, v)
	}
}

const (

	// GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEINVALID captures enum value "DB_CLUSTER_STATE_INVALID"
	GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEINVALID string = "DB_CLUSTER_STATE_INVALID"

	// GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATECHANGING captures enum value "DB_CLUSTER_STATE_CHANGING"
	GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATECHANGING string = "DB_CLUSTER_STATE_CHANGING"

	// GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEREADY captures enum value "DB_CLUSTER_STATE_READY"
	GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEREADY string = "DB_CLUSTER_STATE_READY"

	// GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEFAILED captures enum value "DB_CLUSTER_STATE_FAILED"
	GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEFAILED string = "DB_CLUSTER_STATE_FAILED"

	// GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEDELETING captures enum value "DB_CLUSTER_STATE_DELETING"
	GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEDELETING string = "DB_CLUSTER_STATE_DELETING"

	// GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEPAUSED captures enum value "DB_CLUSTER_STATE_PAUSED"
	GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEPAUSED string = "DB_CLUSTER_STATE_PAUSED"

	// GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEUPGRADING captures enum value "DB_CLUSTER_STATE_UPGRADING"
	GetDBClusterOKBodyPostgresqlClusterStateDBCLUSTERSTATEUPGRADING string = "DB_CLUSTER_STATE_UPGRADING"
)

// prop value enum
func (o *GetDBClusterOKBodyPostgresqlCluster) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, getDbClusterOkBodyPostgresqlClusterTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *GetDBClusterOKBodyPostgresqlCluster) validateState(formats strfmt.Registry) error {
	if swag.IsZero(o.State) { // not required
		return nil
	}

	// value enum
	if err := o.validateStateEnum("getDbClusterOk"+"."+"postgresql_cluster"+"."+"state", "body", *o.State); err != nil {
		return err
	}
...
func (o *GetDBClusterOKBodyPostgresqlCluster) validateBackup(formats strfmt.Registry) error {
	if swag.IsZero(o.Backup) { // not required
		return nil
	}
	...
	if o.Backup != nil {
		if err := o.Backup.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "backup")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "backup")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBodyPostgresqlCluster) validateOperation(formats strfmt.Registry) error {
	if swag.IsZero(o.Operation) { // not required
		return nil
	}
	...
	if o.Operation != nil {
		if err := o.Operation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "operation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "operation")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBodyPostgresqlCluster) validateParams(formats strfmt.Registry) error {
	if swag.IsZero(o.Params) { // not required
		return nil
	}
	...
	if o.Params != nil {
		if err := o.Params.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBodyPostgresqlCluster) validateRestore(formats strfmt.Registry) error {
	if swag.IsZero(o.Restore) { // not required
		return nil
	}
	...
	if o.Restore != nil {
		if err := o.Restore.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "restore")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "restore")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBodyPostgresqlCluster) validateTemplate(formats strfmt.Registry) error {
	if swag.IsZero(o.Template) { // not required
		return nil
	}
	...
	if o.Template != nil {
		if err := o.Template.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "template")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "template")
			}
			return err
		}
	}
...
// ContextValidate validate this get DB cluster OK body postgresql cluster based on the context it is used
func (o *GetDBClusterOKBodyPostgresqlCluster) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetDBClusterOKBodyPostgresqlCluster) contextValidateBackup(ctx context.Context, formats strfmt.Registry) error {
	if o.Backup != nil {
		if err := o.Backup.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "backup")
...
func (o *GetDBClusterOKBodyPostgresqlCluster) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
	if o.Operation != nil {
		if err := o.Operation.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "operation")
...
func (o *GetDBClusterOKBodyPostgresqlCluster) contextValidateParams(ctx context.Context, formats strfmt.Registry) error {
	if o.Params != nil {
		if err := o.Params.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params")
...
func (o *GetDBClusterOKBodyPostgresqlCluster) contextValidateRestore(ctx context.Context, formats strfmt.Registry) error {
	if o.Restore != nil {
		if err := o.Restore.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "restore")
...
func (o *GetDBClusterOKBodyPostgresqlCluster) contextValidateTemplate(ctx context.Context, formats strfmt.Registry) error {
	if o.Template != nil {
		if err := o.Template.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "template")
...
// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlCluster) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlCluster) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlCluster
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterBackup Backup configuration for a database cluster
swagger:model GetDBClusterOKBodyPostgresqlClusterBackup
*/
type GetDBClusterOKBodyPostgresqlClusterBackup struct {
	// Backup Location id of stored backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster backup
func (o *GetDBClusterOKBodyPostgresqlClusterBackup) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster backup based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterBackup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterBackup) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterBackup) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterBackup
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterOperation RunningOperation respresents a long-running operation.
swagger:model GetDBClusterOKBodyPostgresqlClusterOperation
*/
type GetDBClusterOKBodyPostgresqlClusterOperation struct {
	// Finished steps of the operaion; can decrease or increase compared to the previous value.
	FinishedSteps int32 `json:"finished_steps,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster operation
func (o *GetDBClusterOKBodyPostgresqlClusterOperation) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster operation based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterOperation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterOperation) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterOperation) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterOperation
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterParams PostgresqlClusterParams represents Postgresql cluster parameters that can be updated.
swagger:model GetDBClusterOKBodyPostgresqlClusterParams
*/
type GetDBClusterOKBodyPostgresqlClusterParams struct {
	// Cluster size.
	ClusterSize int32 `json:"cluster_size,omitempty"`

	// backup
	Backup *GetDBClusterOKBodyPostgresqlClusterParamsBackup `json:"backup,omitempty"`

	// instance
	Instance *GetDBClusterOKBodyPostgresqlClusterParamsInstance `json:"instance,omitempty"`

	// pgbouncer
	Pgbouncer *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer `json:"pgbouncer,omitempty"`

	// restore
	Restore *GetDBClusterOKBodyPostgresqlClusterParamsRestore `json:"restore,omitempty"`
}

// Validate validates this get DB cluster OK body postgresql cluster params
func (o *GetDBClusterOKBodyPostgresqlClusterParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) validateBackup(formats strfmt.Registry) error {
	if swag.IsZero(o.Backup) { // not required
		return nil
	}
	...
	if o.Backup != nil {
		if err := o.Backup.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "backup")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "backup")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) validateInstance(formats strfmt.Registry) error {
	...
	if o.Instance != nil {
		if err := o.Instance.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "instance")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "instance")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) validatePgbouncer(formats strfmt.Registry) error {
	...
	if o.Pgbouncer != nil {
		if err := o.Pgbouncer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "pgbouncer")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "pgbouncer")
			}
			return err
		}
	}
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) validateRestore(formats strfmt.Registry) error {
	if swag.IsZero(o.Restore) { // not required
		return nil
	}
	...
	if o.Restore != nil {
		if err := o.Restore.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "restore")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "restore")
			}
			return err
		}
	}
...
// ContextValidate validate this get DB cluster OK body postgresql cluster params based on the context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) contextValidateBackup(ctx context.Context, formats strfmt.Registry) error {
	if o.Backup != nil {
		if err := o.Backup.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "backup")
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) contextValidateInstance(ctx context.Context, formats strfmt.Registry) error {
	if o.Instance != nil {
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) contextValidatePgbouncer(ctx context.Context, formats strfmt.Registry) error {
	if o.Pgbouncer != nil {
...
func (o *GetDBClusterOKBodyPostgresqlClusterParams) contextValidateRestore(ctx context.Context, formats strfmt.Registry) error {
	if o.Restore != nil {
		if err := o.Restore.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "restore")
...
// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParams) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParams) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterParams
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterParamsBackup Backup configuration for a database cluster
swagger:model GetDBClusterOKBodyPostgresqlClusterParamsBackup
*/
type GetDBClusterOKBodyPostgresqlClusterParamsBackup struct {
	// Backup Location id of stored backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster params backup
func (o *GetDBClusterOKBodyPostgresqlClusterParamsBackup) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster params backup based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterParamsBackup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsBackup) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsBackup) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterParamsBackup
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterParamsInstance Instance container parameters.
// TODO Do not use inner messages in all public APIs (for consistency).
swagger:model GetDBClusterOKBodyPostgresqlClusterParamsInstance
*/
type GetDBClusterOKBodyPostgresqlClusterParamsInstance struct {
	...
	// compute resources
	ComputeResources *GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources `json:"compute_resources,omitempty"`
}

// Validate validates this get DB cluster OK body postgresql cluster params instance
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstance) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstance) validateComputeResources(formats strfmt.Registry) error {
	if swag.IsZero(o.ComputeResources) { // not required
		return nil
	}
	...
	if o.ComputeResources != nil {
		if err := o.ComputeResources.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "instance" + "." + "compute_resources")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "instance" + "." + "compute_resources")
			}
			return err
		}
	}
...
// ContextValidate validate this get DB cluster OK body postgresql cluster params instance based on the context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstance) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstance) contextValidateComputeResources(ctx context.Context, formats strfmt.Registry) error {
	if o.ComputeResources != nil {
		if err := o.ComputeResources.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "instance" + "." + "compute_resources")
...
// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstance) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstance) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterParamsInstance
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources ComputeResources represents container computer resources requests or limits.
swagger:model GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources
*/
type GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources struct {
	// CPUs in milliCPUs; 1000m = 1 vCPU.
	CPUm int32 `json:"cpu_m,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster params instance compute resources
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster params instance compute resources based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterParamsInstanceComputeResources
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer PGBouncer container parameters.
// TODO Do not use inner messages in all public APIs (for consistency).
swagger:model GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer
*/
type GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer struct {
	...
	// compute resources
	ComputeResources *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources `json:"compute_resources,omitempty"`
}

// Validate validates this get DB cluster OK body postgresql cluster params pgbouncer
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer) validateComputeResources(formats strfmt.Registry) error {
	if swag.IsZero(o.ComputeResources) { // not required
		return nil
	}
	...
	if o.ComputeResources != nil {
		if err := o.ComputeResources.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "pgbouncer" + "." + "compute_resources")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "pgbouncer" + "." + "compute_resources")
			}
			return err
		}
	}
...
// ContextValidate validate this get DB cluster OK body postgresql cluster params pgbouncer based on the context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer) contextValidateComputeResources(ctx context.Context, formats strfmt.Registry) error {
	if o.ComputeResources != nil {
		if err := o.ComputeResources.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getDbClusterOk" + "." + "postgresql_cluster" + "." + "params" + "." + "pgbouncer" + "." + "compute_resources")
...
// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterParamsPgbouncer
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources ComputeResources represents container computer resources requests or limits.
swagger:model GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources
*/
type GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources struct {
	// CPUs in milliCPUs; 1000m = 1 vCPU.
	CPUm int32 `json:"cpu_m,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster params pgbouncer compute resources
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster params pgbouncer compute resources based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterParamsPgbouncerComputeResources
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterParamsRestore Restore represents restoration payload to restore a database cluster from backup
swagger:model GetDBClusterOKBodyPostgresqlClusterParamsRestore
*/
type GetDBClusterOKBodyPostgresqlClusterParamsRestore struct {
	// Backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster params restore
func (o *GetDBClusterOKBodyPostgresqlClusterParamsRestore) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster params restore based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterParamsRestore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsRestore) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterParamsRestore) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterParamsRestore
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterRestore Restore represents restoration payload to restore a database cluster from backup
swagger:model GetDBClusterOKBodyPostgresqlClusterRestore
*/
type GetDBClusterOKBodyPostgresqlClusterRestore struct {
	// Backup location in PMM.
	LocationID string `json:"location_id,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster restore
func (o *GetDBClusterOKBodyPostgresqlClusterRestore) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster restore based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterRestore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterRestore) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterRestore) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterRestore
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetDBClusterOKBodyPostgresqlClusterTemplate get DB cluster OK body postgresql cluster template
swagger:model GetDBClusterOKBodyPostgresqlClusterTemplate
*/
type GetDBClusterOKBodyPostgresqlClusterTemplate struct {
	// Template CR name.
	Name string `json:"name,omitempty"`
...
// Validate validates this get DB cluster OK body postgresql cluster template
func (o *GetDBClusterOKBodyPostgresqlClusterTemplate) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get DB cluster OK body postgresql cluster template based on context it is used
func (o *GetDBClusterOKBodyPostgresqlClusterTemplate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterTemplate) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetDBClusterOKBodyPostgresqlClusterTemplate) UnmarshalBinary(b []byte) error {
	var res GetDBClusterOKBodyPostgresqlClusterTemplate
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
