...
const (
	...
	// PSMDBClustersItems0StatePSMDBCLUSTERSTATEINVALID captures enum value "PSMDB_CLUSTER_STATE_INVALID"
	PSMDBClustersItems0StatePSMDBCLUSTERSTATEINVALID string = "PSMDB_CLUSTER_STATE_INVALID"

	// PSMDBClustersItems0StatePSMDBCLUSTERSTATECHANGING captures enum value "PSMDB_CLUSTER_STATE_CHANGING"
	PSMDBClustersItems0StatePSMDBCLUSTERSTATECHANGING string = "PSMDB_CLUSTER_STATE_CHANGING"

	// PSMDBClustersItems0StatePSMDBCLUSTERSTATEREADY captures enum value "PSMDB_CLUSTER_STATE_READY"
	PSMDBClustersItems0StatePSMDBCLUSTERSTATEREADY string = "PSMDB_CLUSTER_STATE_READY"

	// PSMDBClustersItems0StatePSMDBCLUSTERSTATEFAILED captures enum value "PSMDB_CLUSTER_STATE_FAILED"
	PSMDBClustersItems0StatePSMDBCLUSTERSTATEFAILED string = "PSMDB_CLUSTER_STATE_FAILED"

	// PSMDBClustersItems0StatePSMDBCLUSTERSTATEDELETING captures enum value "PSMDB_CLUSTER_STATE_DELETING"
	PSMDBClustersItems0StatePSMDBCLUSTERSTATEDELETING string = "PSMDB_CLUSTER_STATE_DELETING"
...
type PXCClustersItems0 struct {
	...
	//
	//  - PXC_CLUSTER_STATE_INVALID: PXC_CLUSTER_STATE_INVALID represents unknown state.
	//  - PXC_CLUSTER_STATE_CHANGING: PXC_CLUSTER_STATE_CHANGING represents a cluster being changed.
	//  - PXC_CLUSTER_STATE_READY: PXC_CLUSTER_STATE_READY represents a cluster without pending changes.
...
const (
	...
	// PXCClustersItems0StatePXCCLUSTERSTATEINVALID captures enum value "PXC_CLUSTER_STATE_INVALID"
	PXCClustersItems0StatePXCCLUSTERSTATEINVALID string = "PXC_CLUSTER_STATE_INVALID"

	// PXCClustersItems0StatePXCCLUSTERSTATECHANGING captures enum value "PXC_CLUSTER_STATE_CHANGING"
	PXCClustersItems0StatePXCCLUSTERSTATECHANGING string = "PXC_CLUSTER_STATE_CHANGING"

	// PXCClustersItems0StatePXCCLUSTERSTATEREADY captures enum value "PXC_CLUSTER_STATE_READY"
	PXCClustersItems0StatePXCCLUSTERSTATEREADY string = "PXC_CLUSTER_STATE_READY"

	// PXCClustersItems0StatePXCCLUSTERSTATEFAILED captures enum value "PXC_CLUSTER_STATE_FAILED"
	PXCClustersItems0StatePXCCLUSTERSTATEFAILED string = "PXC_CLUSTER_STATE_FAILED"

	// PXCClustersItems0StatePXCCLUSTERSTATEDELETING captures enum value "PXC_CLUSTER_STATE_DELETING"
	PXCClustersItems0StatePXCCLUSTERSTATEDELETING string = "PXC_CLUSTER_STATE_DELETING"
