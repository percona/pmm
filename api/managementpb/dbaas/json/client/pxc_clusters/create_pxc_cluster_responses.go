...
func (o *CreatePXCClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreatePXCClusterOK) GetPayload() any {
	return o.Payload
}
