...
// IsSuccess returns true when this get Pxc components Ok response has a 2xx status code
func (o *GetPXCComponentsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get Pxc components Ok response has a 3xx status code
func (o *GetPXCComponentsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get Pxc components Ok response has a 4xx status code
func (o *GetPXCComponentsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get Pxc components Ok response has a 5xx status code
func (o *GetPXCComponentsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get Pxc components Ok response a status code equal to that given
func (o *GetPXCComponentsOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *GetPXCComponentsOK) String() string {
	return fmt.Sprintf("[POST /v1/management/DBaaS/Components/GetPXC][%d] getPxcComponentsOk  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this get PXC components default response has a 2xx status code
func (o *GetPXCComponentsDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this get PXC components default response has a 3xx status code
func (o *GetPXCComponentsDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this get PXC components default response has a 4xx status code
func (o *GetPXCComponentsDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this get PXC components default response has a 5xx status code
func (o *GetPXCComponentsDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this get PXC components default response a status code equal to that given
func (o *GetPXCComponentsDefault) IsCode(code int) bool {
...
func (o *GetPXCComponentsDefault) String() string {
	return fmt.Sprintf("[POST /v1/management/DBaaS/Components/GetPXC][%d] GetPXCComponents default  %+v", o._statusCode, o.Payload)
}
