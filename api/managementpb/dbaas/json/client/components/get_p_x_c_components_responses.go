...
/*GetPXCComponentsBody get p x c components body
...
/*GetPXCComponentsDefaultBody get p x c components default body
...
/*GetPXCComponentsOKBody get p x c components OK body
