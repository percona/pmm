...
import (
	...
	"github.com/percona/pmm/api/managementpb/dbaas/json/client/p_s_m_db_cluster"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *PMMDBaaS {
	...
	cli.PsmDBCluster = p_s_m_db_cluster.New(transport, formats)
...
type PMMDBaaS struct {
	...
	PsmDBCluster p_s_m_db_cluster.ClientService
