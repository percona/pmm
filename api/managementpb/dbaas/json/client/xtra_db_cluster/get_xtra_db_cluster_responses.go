...
const (
	...
	// GetXtraDBClusterOKBodyStateXTRADBCLUSTERSTATEPAUSED captures enum value "XTRA_DB_CLUSTER_STATE_PAUSED"
	GetXtraDBClusterOKBodyStateXTRADBCLUSTERSTATEPAUSED string = "XTRA_DB_CLUSTER_STATE_PAUSED"
)
