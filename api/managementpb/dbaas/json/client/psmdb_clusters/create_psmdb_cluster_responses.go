...
func (o *CreatePSMDBClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreatePSMDBClusterOK) GetPayload() any {
	return o.Payload
}
