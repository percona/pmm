...
func (o *DeleteXtraDBClusterOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/DBaaS/XtraDB/Delete][%d] deleteXtraDbClusterOk  %+v", 200, o.Payload)
}
...
func (o *DeleteXtraDBClusterDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/DBaaS/XtraDB/Delete][%d] DeleteXtraDBCluster default  %+v", o._statusCode, o.Payload)
}
