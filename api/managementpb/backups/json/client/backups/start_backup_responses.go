...
func (o *StartBackupOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/Backups/Start][%d] startBackupOk  %+v", 200, o.Payload)
}

func (o *StartBackupOK) GetPayload() interface{} {
	return o.Payload
}
...
func (o *StartBackupDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/Backups/Start][%d] StartBackup default  %+v", o._statusCode, o.Payload)
}
