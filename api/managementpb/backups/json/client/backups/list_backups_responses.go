...
func (o *ListBackupsOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/Backups/List][%d] listBackupsOk  %+v", 200, o.Payload)
}

func (o *ListBackupsOK) GetPayload() interface{} {
	return o.Payload
}
...
func (o *ListBackupsDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/Backups/List][%d] ListBackups default  %+v", o._statusCode, o.Payload)
}
