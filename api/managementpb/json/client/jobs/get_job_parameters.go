...
// WithBody adds the body to the get job params
func (o *GetJobParams) WithBody(body GetJobBody) *GetJobParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get job params
func (o *GetJobParams) SetBody(body GetJobBody) {
	o.Body = body
}
