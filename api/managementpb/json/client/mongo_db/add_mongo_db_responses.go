...
func (o *AddMongoDBOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/MongoDB/AddMongoDB][%d] addMongoDbOk  %+v", 200, o.Payload)
}
...
func (o *AddMongoDBDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/MongoDB/AddMongoDB][%d] AddMongoDB default  %+v", o._statusCode, o.Payload)
}
