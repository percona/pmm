...
func (o *ListRolesOK) Error() string {
	return fmt.Sprintf("[GET /v1/management/Role/List][%d] listRolesOk  %+v", 200, o.Payload)
}
...
func (o *ListRolesDefault) Error() string {
	return fmt.Sprintf("[GET /v1/management/Role/List][%d] ListRoles default  %+v", o._statusCode, o.Payload)
}
