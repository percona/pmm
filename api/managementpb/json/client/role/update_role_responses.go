...
func (o *UpdateRoleOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/Role][%d] updateRoleOk  %+v", 200, o.Payload)
}
...
func (o *UpdateRoleDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/Role][%d] UpdateRole default  %+v", o._statusCode, o.Payload)
}
