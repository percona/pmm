...
// IsSuccess returns true when this start Pt my Sql summary action Ok response has a 2xx status code
func (o *StartPTMySQLSummaryActionOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this start Pt my Sql summary action Ok response has a 3xx status code
func (o *StartPTMySQLSummaryActionOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this start Pt my Sql summary action Ok response has a 4xx status code
func (o *StartPTMySQLSummaryActionOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this start Pt my Sql summary action Ok response has a 5xx status code
func (o *StartPTMySQLSummaryActionOK) IsServerError() bool {
	return false
}

// IsCode returns true when this start Pt my Sql summary action Ok response a status code equal to that given
func (o *StartPTMySQLSummaryActionOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *StartPTMySQLSummaryActionOK) String() string {
	return fmt.Sprintf("[POST /v1/management/Actions/StartPTMySQLSummary][%d] startPtMySqlSummaryActionOk  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this start PT my SQL summary action default response has a 2xx status code
func (o *StartPTMySQLSummaryActionDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this start PT my SQL summary action default response has a 3xx status code
func (o *StartPTMySQLSummaryActionDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this start PT my SQL summary action default response has a 4xx status code
func (o *StartPTMySQLSummaryActionDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this start PT my SQL summary action default response has a 5xx status code
func (o *StartPTMySQLSummaryActionDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this start PT my SQL summary action default response a status code equal to that given
func (o *StartPTMySQLSummaryActionDefault) IsCode(code int) bool {
...
func (o *StartPTMySQLSummaryActionDefault) String() string {
	return fmt.Sprintf("[POST /v1/management/Actions/StartPTMySQLSummary][%d] StartPTMySQLSummaryAction default  %+v", o._statusCode, o.Payload)
}
