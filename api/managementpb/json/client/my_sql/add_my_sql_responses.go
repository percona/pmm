...
func (o *AddMySQLOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/MySQL/AddMySQL][%d] addMySqlOk  %+v", 200, o.Payload)
}
...
func (o *AddMySQLDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/MySQL/AddMySQL][%d] AddMySQL default  %+v", o._statusCode, o.Payload)
}
