...
var (
	pattern_Node_Register_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v0", "management", "Node", "Register"}, "", runtime.AssumeColonVerbOpt(true)))
)
