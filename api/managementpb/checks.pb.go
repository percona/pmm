...
type Advisor struct {
	...
	// Advisor checks.
	Check []*SecurityCheck `protobuf:"bytes,6,rep,name=check,proto3" json:"check,omitempty"`
}
...
func (x *Advisor) GetDisabled() bool {
	if x != nil {
		return x.Disabled
	}
	return false
...
func (x *Advisor) GetCheck() []*SecurityCheck {
	if x != nil {
		return x.Check
	}
	return nil
...
var file_managementpb_checks_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x72, 0x79, 0x12, 0x2f, 0x0a, 0x05, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x06, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74,
	0x2e, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x05,
	0x63, 0x68, 0x65, 0x63, 0x6b, 0x22, 0xa0, 0x01, 0x0a, 0x19, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
...
var file_managementpb_checks_proto_depIdxs = []int32{
	...
	4,  // 5: management.Advisor.check:type_name -> management.SecurityCheck
