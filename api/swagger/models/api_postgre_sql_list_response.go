...
// APIPostgreSQLListResponse api postgre SQL list response
// swagger:model apiPostgreSQLListResponse
...
func (m *APIPostgreSQLListResponse) validateInstances(formats strfmt.Registry) error {
...
func (m *APIPostgreSQLListResponse) UnmarshalBinary(b []byte) error {
	var res APIPostgreSQLListResponse
