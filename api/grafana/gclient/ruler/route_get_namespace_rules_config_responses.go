...
// RouteGetNamespaceRulesConfigReader is a Reader for the RouteGetNamespaceRulesConfig structure.
type RouteGetNamespaceRulesConfigReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *RouteGetNamespaceRulesConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 202:
		result := NewRouteGetNamespaceRulesConfigAccepted()
...
// NewRouteGetNamespaceRulesConfigAccepted creates a RouteGetNamespaceRulesConfigAccepted with default headers values
...
/* RouteGetNamespaceRulesConfigAccepted describes a response with status code 202, with default header values.
