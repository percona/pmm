...
func (m *PostableExtendedRuleNode) validateFor(formats strfmt.Registry) error {
...
func (m *PostableExtendedRuleNode) contextValidateFor(ctx context.Context, formats strfmt.Registry) error {
