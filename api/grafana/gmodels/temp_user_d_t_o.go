...
type TempUserDTO struct {
	...
	// created
	// Format: date-time
	Created strfmt.DateTime `json:"createdOn,omitempty"`
...
func (m *TempUserDTO) validateCreated(formats strfmt.Registry) error {
	if swag.IsZero(m.Created) { // not required
		return nil
	}

	if err := validate.FormatOf("createdOn", "body", "date-time", m.Created.String(), formats); err != nil {
		return err
	}
