...
// TestReceiversConfigBodyParams test receivers config body params
//
...
// Validate validates this test receivers config body params
func (m *TestReceiversConfigBodyParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TestReceiversConfigBodyParams) validateReceivers(formats strfmt.Registry) error {
...
func (m *TestReceiversConfigBodyParams) validateAlert(formats strfmt.Registry) error {
...
// ContextValidate validate this test receivers config body params based on the context it is used
func (m *TestReceiversConfigBodyParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TestReceiversConfigBodyParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TestReceiversConfigBodyParams) UnmarshalBinary(b []byte) error {
	var res TestReceiversConfigBodyParams
