...
func file_management_v1_service_proto_rawDescGZIP() []byte {
	file_management_v1_service_proto_rawDescOnce.Do(func() {
		file_management_v1_service_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_management_v1_service_proto_rawDescData)))
	})
	return []byte(file_management_v1_service_proto_rawDescData)
}
