...
var file_management_v1_agent_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x42, 0xab, 0x01, 0x0a,
...
var (
	file_management_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
	file_management_v1_agent_proto_goTypes  = []interface{}{
		(*UniversalAgent)(nil),                   // 0: management.v1.UniversalAgent
		(*ListAgentsRequest)(nil),                // 1: management.v1.ListAgentsRequest
		(*ListAgentsResponse)(nil),               // 2: management.v1.ListAgentsResponse
		(*UniversalAgent_MySQLOptions)(nil),      // 3: management.v1.UniversalAgent.MySQLOptions
		(*UniversalAgent_AzureOptions)(nil),      // 4: management.v1.UniversalAgent.AzureOptions
		(*UniversalAgent_MongoDBOptions)(nil),    // 5: management.v1.UniversalAgent.MongoDBOptions
		(*UniversalAgent_PostgreSQLOptions)(nil), // 6: management.v1.UniversalAgent.PostgreSQLOptions
		nil,                                      // 7: management.v1.UniversalAgent.CustomLabelsEntry
		(*timestamppb.Timestamp)(nil),            // 8: google.protobuf.Timestamp
	}
)

var file_management_v1_agent_proto_depIdxs = []int32{
	4, // 0: management.v1.UniversalAgent.azure_options:type_name -> management.v1.UniversalAgent.AzureOptions
	8, // 1: management.v1.UniversalAgent.created_at:type_name -> google.protobuf.Timestamp
	7, // 2: management.v1.UniversalAgent.custom_labels:type_name -> management.v1.UniversalAgent.CustomLabelsEntry
	5, // 3: management.v1.UniversalAgent.mongo_db_options:type_name -> management.v1.UniversalAgent.MongoDBOptions
	3, // 4: management.v1.UniversalAgent.mysql_options:type_name -> management.v1.UniversalAgent.MySQLOptions
	6, // 5: management.v1.UniversalAgent.postgresql_options:type_name -> management.v1.UniversalAgent.PostgreSQLOptions
	8, // 6: management.v1.UniversalAgent.updated_at:type_name -> google.protobuf.Timestamp
	0, // 7: management.v1.ListAgentsResponse.agents:type_name -> management.v1.UniversalAgent
...
func file_management_v1_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_management_v1_agent_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_management_v1_agent_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_management_v1_agent_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_management_v1_agent_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_management_v1_agent_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_management_v1_agent_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_management_v1_agent_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
