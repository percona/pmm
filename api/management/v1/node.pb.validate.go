...
// Validate checks the field values on CreateNodeInstallTokenRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CreateNodeInstallTokenRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateNodeInstallTokenRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// CreateNodeInstallTokenRequestMultiError, or nil if none found.
func (m *CreateNodeInstallTokenRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateNodeInstallTokenRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CreateNodeInstallTokenRequestMultiError(errors)
	}

	return nil
}

// CreateNodeInstallTokenRequestMultiError is an error wrapping multiple
// validation errors returned by CreateNodeInstallTokenRequest.ValidateAll()
// if the designated constraints aren't met.
type CreateNodeInstallTokenRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateNodeInstallTokenRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateNodeInstallTokenRequestMultiError) AllErrors() []error { return m }

// CreateNodeInstallTokenRequestValidationError is the validation error
// returned by CreateNodeInstallTokenRequest.Validate if the designated
// constraints aren't met.
type CreateNodeInstallTokenRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateNodeInstallTokenRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateNodeInstallTokenRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateNodeInstallTokenRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateNodeInstallTokenRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateNodeInstallTokenRequestValidationError) ErrorName() string {
	return "CreateNodeInstallTokenRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CreateNodeInstallTokenRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateNodeInstallTokenRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateNodeInstallTokenRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateNodeInstallTokenRequestValidationError{}

// Validate checks the field values on CreateNodeInstallTokenResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CreateNodeInstallTokenResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateNodeInstallTokenResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// CreateNodeInstallTokenResponseMultiError, or nil if none found.
func (m *CreateNodeInstallTokenResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateNodeInstallTokenResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateNodeInstallTokenResponseValidationError{
					field:  "ExpiresAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return CreateNodeInstallTokenResponseValidationError{
				field:  "ExpiresAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return CreateNodeInstallTokenResponseMultiError(errors)
	}

	return nil
}

// CreateNodeInstallTokenResponseMultiError is an error wrapping multiple
// validation errors returned by CreateNodeInstallTokenResponse.ValidateAll()
// if the designated constraints aren't met.
type CreateNodeInstallTokenResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateNodeInstallTokenResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateNodeInstallTokenResponseMultiError) AllErrors() []error { return m }

// CreateNodeInstallTokenResponseValidationError is the validation error
// returned by CreateNodeInstallTokenResponse.Validate if the designated
// constraints aren't met.
type CreateNodeInstallTokenResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateNodeInstallTokenResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateNodeInstallTokenResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateNodeInstallTokenResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateNodeInstallTokenResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateNodeInstallTokenResponseValidationError) ErrorName() string {
	return "CreateNodeInstallTokenResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CreateNodeInstallTokenResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateNodeInstallTokenResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateNodeInstallTokenResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateNodeInstallTokenResponseValidationError{}
