...
func file_management_v1_postgresql_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_management_v1_postgresql_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_management_v1_postgresql_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*PostgreSQLServiceResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
