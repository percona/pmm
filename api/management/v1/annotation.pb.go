...
func file_management_v1_annotation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_management_v1_annotation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_management_v1_annotation_proto_msgTypes[1].Exporter = func(v any, i int) any {
