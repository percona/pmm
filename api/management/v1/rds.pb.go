...
type AddRDSResponse struct {
	...
	Node                      *v1.RemoteRDSNode                  `protobuf:"bytes,2,opt,name=node,proto3" json:"node,omitempty"`
	RdsExporter               *v1.RDSExporter                    `protobuf:"bytes,3,opt,name=rds_exporter,json=rdsExporter,proto3" json:"rds_exporter,omitempty"`
	Mysql                     *v1.MySQLService                   `protobuf:"bytes,4,opt,name=mysql,proto3" json:"mysql,omitempty"`
	MysqldExporter            *v1.MySQLdExporter                 `protobuf:"bytes,5,opt,name=mysqld_exporter,json=mysqldExporter,proto3" json:"mysqld_exporter,omitempty"`
	QanMysqlPerfschema        *v1.QANMySQLPerfSchemaAgent        `protobuf:"bytes,6,opt,name=qan_mysql_perfschema,json=qanMysqlPerfschema,proto3" json:"qan_mysql_perfschema,omitempty"`
...
var file_management_v1_rds_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2f, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18,
	...
	0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19,
	...
	0x6c, 0x64, 0x5f, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x66, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e,
