...
type AddProxySQLServiceParams struct {
	...
	Timeout       *durationpb.Duration `protobuf:"bytes,24,opt,name=timeout,proto3" json:"timeout,omitempty"`
...
func (x *AddProxySQLServiceParams) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
var file_management_v1_proxysql_proto_depIdxs = []int32{
	...
	6, // 4: management.v1.AddProxySQLServiceParams.timeout:type_name -> google.protobuf.Duration
