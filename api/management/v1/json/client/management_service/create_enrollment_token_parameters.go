...
func (o *CreateEnrollmentTokenParams) WithBody(body CreateEnrollmentTokenBody) *CreateEnrollmentTokenParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create enrollment token params
func (o *CreateEnrollmentTokenParams) SetBody(body CreateEnrollmentTokenBody) {
	o.Body = body
}
