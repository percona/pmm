...
// WithDefaults hydrates default values in the start security checks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StartSecurityChecksParams) WithDefaults() *StartSecurityChecksParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the start security checks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StartSecurityChecksParams) SetDefaults() {
