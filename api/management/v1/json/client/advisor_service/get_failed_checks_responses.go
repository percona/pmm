...
func (o *GetFailedChecksOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/AdvisorChecks/FailedChecks][%d] getFailedChecksOk  %+v", 200, o.Payload)
}
...
func (o *GetFailedChecksDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/AdvisorChecks/FailedChecks][%d] GetFailedChecks default  %+v", o._statusCode, o.Payload)
}
