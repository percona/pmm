...
func (o *ChangeAdvisorChecksOK) Error() string {
	return fmt.Sprintf("[POST /v1/management/Advisors/Change][%d] changeAdvisorChecksOk  %+v", 200, o.Payload)
}
...
func (o *ChangeAdvisorChecksDefault) Error() string {
	return fmt.Sprintf("[POST /v1/management/Advisors/Change][%d] ChangeAdvisorChecks default  %+v", o._statusCode, o.Payload)
}
