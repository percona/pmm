...
func request_Remote_List_0(ctx context.Context, marshaler runtime.Marshaler, client RemoteClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RemoteListRequest
...
func RegisterRemoteHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RemoteClient) error {
	...
	mux.Handle("GET", pattern_Remote_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Remote_List_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Remote_List_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Remote_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v0", "remote"}, ""))
)

var (
	forward_Remote_List_0 = runtime.ForwardResponseMessage
)
