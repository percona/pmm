...
func file_platform_v1_platform_proto_rawDescGZIP() []byte {
	file_platform_v1_platform_proto_rawDescOnce.Do(func() {
		file_platform_v1_platform_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_platform_v1_platform_proto_rawDescData)))
	})
	return []byte(file_platform_v1_platform_proto_rawDescData)
}
