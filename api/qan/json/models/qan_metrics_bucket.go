...
type QANMetricsBucket struct {
	...
	// d client host
	DClientHost string `json:"d_client_host,omitempty"`

	// d database
	DDatabase string `json:"d_database,omitempty"`

	// d schema
	DSchema string `json:"d_schema,omitempty"`

	// Dimension Group.
	DServer string `json:"d_server,omitempty"`

	// d username
	DUsername string `json:"d_username,omitempty"`
...
// Validate validates this qan metrics bucket
func (m *QANMetricsBucket) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *QANMetricsBucket) validateExampleFormat(formats strfmt.Registry) error {
...
func (m *QANMetricsBucket) validateExampleType(formats strfmt.Registry) error {
...
func (m *QANMetricsBucket) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *QANMetricsBucket) UnmarshalBinary(b []byte) error {
	var res QANMetricsBucket
