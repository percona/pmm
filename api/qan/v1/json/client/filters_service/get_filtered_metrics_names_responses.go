...
func (o *GetFilteredMetricsNamesOK) Error() string {
	return fmt.Sprintf("[POST /v0/qan/Filters/Get][%d] getFilteredMetricsNamesOk  %+v", 200, o.Payload)
}
...
func (o *GetFilteredMetricsNamesDefault) Error() string {
	return fmt.Sprintf("[POST /v0/qan/Filters/Get][%d] GetFilteredMetricsNames default  %+v", o._statusCode, o.Payload)
}
