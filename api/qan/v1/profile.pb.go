...
func file_qan_v1_profile_proto_rawDescGZIP() []byte {
	file_qan_v1_profile_proto_rawDescOnce.Do(func() {
		file_qan_v1_profile_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_qan_v1_profile_proto_rawDescData)))
	})
	return []byte(file_qan_v1_profile_proto_rawDescData)
}
