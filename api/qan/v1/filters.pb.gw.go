...
func RegisterFiltersServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FiltersServiceServer) error {
	mux.Handle("POST", pattern_FiltersService_GetFilteredMetricsNames_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/qan.v1.FiltersService/GetFilteredMetricsNames", runtime.WithHTTPPathPattern("/v0/qan/Filters/Get"))
		if err != nil {
...
func RegisterFiltersServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FiltersServiceClient) error {
	mux.Handle("POST", pattern_FiltersService_GetFilteredMetricsNames_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/qan.v1.FiltersService/GetFilteredMetricsNames", runtime.WithHTTPPathPattern("/v0/qan/Filters/Get"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
