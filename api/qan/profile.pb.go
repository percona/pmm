...
func (*ReportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_6ef61db60192b689, []int{0}
}
...
func (*ReportMapFieldEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_6ef61db60192b689, []int{1}
}
...
func (*ReportReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_6ef61db60192b689, []int{2}
}
...
func (*ProfileRow) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_6ef61db60192b689, []int{3}
}
...
func (m *ProfileRow) GetRowNumber() string {
	if m != nil {
		return m.RowNumber
	}
	return ""
...
func (*Stats) Descriptor() ([]byte, []int) {
	return fileDescriptor_profile_6ef61db60192b689, []int{4}
}
...
func init() { proto.RegisterFile("qan/profile.proto", fileDescriptor_profile_6ef61db60192b689) }

var fileDescriptor_profile_6ef61db60192b689 = []byte{
	// 720 bytes of a gzipped FileDescriptorProto
	,
}
