...
func request_FiltersService_GetFilteredMetricsNames_0(ctx context.Context, marshaler runtime.Marshaler, client FiltersServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_FiltersService_GetFilteredMetricsNames_0(ctx context.Context, marshaler runtime.Marshaler, server FiltersServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetFilteredMetricsNamesRequest
	var metadata runtime.ServerMetadata
...
func RegisterFiltersServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FiltersServiceServer) error {
	mux.Handle("POST", pattern_FiltersService_GetFilteredMetricsNames_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/qan.v1beta1.FiltersService/GetFilteredMetricsNames", runtime.WithHTTPPathPattern("/v0/qan/Filters/Get"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FiltersService_GetFilteredMetricsNames_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_FiltersService_GetFilteredMetricsNames_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterFiltersServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FiltersServiceClient) error {
	mux.Handle("POST", pattern_FiltersService_GetFilteredMetricsNames_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/qan.v1beta1.FiltersService/GetFilteredMetricsNames", runtime.WithHTTPPathPattern("/v0/qan/Filters/Get"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FiltersService_GetFilteredMetricsNames_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var pattern_FiltersService_GetFilteredMetricsNames_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v0", "qan", "Filters", "Get"}, ""))

var forward_FiltersService_GetFilteredMetricsNames_0 = runtime.ForwardResponseMessage
