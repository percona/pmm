...
// UnimplementedUIEventsServer must be embedded to have
...
func (UnimplementedUIEventsServer) testEmbeddedByValue()                  {}
...
func RegisterUIEventsServer(s grpc.ServiceRegistrar, srv UIEventsServer) {
	// If the following call pancis, it indicates UnimplementedUIEventsServer was
