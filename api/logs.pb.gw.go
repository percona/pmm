...
func request_Logs_All_0(ctx context.Context, marshaler runtime.Marshaler, client LogsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LogsAllRequest
...
func RegisterLogsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LogsClient) error {
	...
	mux.Handle("GET", pattern_Logs_All_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Logs_All_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Logs_All_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Logs_All_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v0", "logs"}, ""))
)

var (
	forward_Logs_All_0 = runtime.ForwardResponseMessage
)
