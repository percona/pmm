...
// RegisterAlertsHandler registers the http handlers for service Alerts to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "AlertsClient".
...
func RegisterAlertsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AlertsClient) error {
	...
	mux.Handle("GET", pattern_Alerts_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Alerts_List_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_Alerts_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Alerts_Get_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
