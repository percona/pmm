...
func request_Base_Version_0(ctx context.Context, marshaler runtime.Marshaler, client BaseClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BaseVersionRequest
...
func RegisterBaseHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("GET", pattern_Base_Version_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Base_Version_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Base_Version_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Base_Version_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v0", "version"}, ""))
)

var (
	forward_Base_Version_0 = runtime.ForwardResponseMessage
)
