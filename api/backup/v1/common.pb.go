...
var (
	...
	file_backup_v1_common_proto_goTypes   = []interface{}{
...
func file_backup_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_backup_v1_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*File); i {
			case 0:
				return &v.state
			case 1:
		...
		file_backup_v1_common_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_backup_v1_common_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_backup_v1_common_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_backup_v1_common_proto_msgTypes[2].OneofWrappers = []interface{}{
