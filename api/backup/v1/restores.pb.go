...
type ListRestoreRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ListRestoreRequest) Reset() {
	*x = ListRestoreRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListRestoreRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRestoreRequest) ProtoMessage() {}

func (x *ListRestoreRequest) ProtoReflect() protoreflect.Message {
	mi := &file_backup_v1_restores_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRestoreRequest.ProtoReflect.Descriptor instead.
func (*ListRestoreRequest) Descriptor() ([]byte, []int) {
...
func (x *ListRestoreResponse) Reset() {
	*x = ListRestoreResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListRestoreResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRestoreResponse) ProtoMessage() {}

func (x *ListRestoreResponse) ProtoReflect() protoreflect.Message {
	mi := &file_backup_v1_restores_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRestoreResponse.ProtoReflect.Descriptor instead.
func (*ListRestoreResponse) Descriptor() ([]byte, []int) {
	return file_backup_v1_restores_proto_rawDescGZIP(), []int{2}
}

func (x *ListRestoreResponse) GetItems() []*RestoreHistoryItem {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_backup_v1_restores_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x22, 0x14, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4a, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74,
	...
	0x72, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69,
	0x74, 0x65, 0x6d, 0x73, 0x22, 0xab, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65,
	0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a,
	...
	,
	...
	0x09, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x2a, 0x85, 0x01, 0x0a, 0x0d, 0x52,
	0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1e, 0x0a, 0x1a,
	0x52, 0x45, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x55,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xaf, 0x04, 0x92, 0x41, 0x86, 0x04, 0x12, 0x15, 0x52, 0x65,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x20, 0x66, 0x72, 0x6f, 0x6d, 0x20, 0x61, 0x20, 0x42, 0x61, 0x63,
	0x6b, 0x75, 0x70, 0x1a, 0xec, 0x03, 0x43, 0x6f, 0x75, 0x6c, 0x64, 0x20, 0x72, 0x65, 0x74, 0x75,
	...
	0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x42, 0x92, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e,
	0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x52, 0x65, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68,
...
var (
	...
	file_backup_v1_restores_proto_msgTypes  = make([]protoimpl.MessageInfo, 5)
	file_backup_v1_restores_proto_goTypes   = []interface{}{
		...
		(*ListRestoreRequest)(nil),    // 2: backup.v1.ListRestoreRequest
		(*ListRestoreResponse)(nil),   // 3: backup.v1.ListRestoreResponse
		(*RestoreBackupRequest)(nil),  // 4: backup.v1.RestoreBackupRequest
		(*RestoreBackupResponse)(nil), // 5: backup.v1.RestoreBackupResponse
		(DataModel)(0),                // 6: backup.v1.DataModel
		(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
	}
)

var file_backup_v1_restores_proto_depIdxs = []int32{
	6, // 0: backup.v1.RestoreHistoryItem.data_model:type_name -> backup.v1.DataModel
	0, // 1: backup.v1.RestoreHistoryItem.status:type_name -> backup.v1.RestoreStatus
	7, // 2: backup.v1.RestoreHistoryItem.started_at:type_name -> google.protobuf.Timestamp
	7, // 3: backup.v1.RestoreHistoryItem.finished_at:type_name -> google.protobuf.Timestamp
	7, // 4: backup.v1.RestoreHistoryItem.pitr_timestamp:type_name -> google.protobuf.Timestamp
	1, // 5: backup.v1.ListRestoreResponse.items:type_name -> backup.v1.RestoreHistoryItem
	7, // 6: backup.v1.RestoreBackupRequest.pitr_timestamp:type_name -> google.protobuf.Timestamp
	2, // 7: backup.v1.RestoreService.ListRestores:input_type -> backup.v1.ListRestoreRequest
	4, // 8: backup.v1.RestoreService.RestoreBackup:input_type -> backup.v1.RestoreBackupRequest
	3, // 9: backup.v1.RestoreService.ListRestores:output_type -> backup.v1.ListRestoreResponse
	5, // 10: backup.v1.RestoreService.RestoreBackup:output_type -> backup.v1.RestoreBackupResponse
...
func file_backup_v1_restores_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_backup_v1_restores_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRestoreRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_backup_v1_restores_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRestoreResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
