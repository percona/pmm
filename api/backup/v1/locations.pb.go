...
func file_backup_v1_locations_proto_rawDescGZIP() []byte {
	file_backup_v1_locations_proto_rawDescOnce.Do(func() {
		file_backup_v1_locations_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_backup_v1_locations_proto_rawDescData)))
	})
	return []byte(file_backup_v1_locations_proto_rawDescData)
}
