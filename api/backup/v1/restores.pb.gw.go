...
func RegisterRestoreHistoryServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RestoreHistoryServiceServer) error {
	mux.Handle("POST", pattern_RestoreHistoryService_ListRestoreHistory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/backup.v1.RestoreHistoryService/ListRestoreHistory", runtime.WithHTTPPathPattern("/v1/backup/RestoreHistory/List"))
		if err != nil {
...
func RegisterRestoreHistoryServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RestoreHistoryServiceClient) error {
	mux.Handle("POST", pattern_RestoreHistoryService_ListRestoreHistory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/backup.v1.RestoreHistoryService/ListRestoreHistory", runtime.WithHTTPPathPattern("/v1/backup/RestoreHistory/List"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var pattern_RestoreHistoryService_ListRestoreHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "backup", "RestoreHistory", "List"}, ""))
