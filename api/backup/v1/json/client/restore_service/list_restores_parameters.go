...
// WithBody adds the body to the list restores params
func (o *ListRestoresParams) WithBody(body interface{}) *ListRestoresParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list restores params
func (o *ListRestoresParams) SetBody(body interface{}) {
	o.Body = body
}
