...
func (o *ListRestoreHistoryOK) Error() string {
	return fmt.Sprintf("[POST /v1/backup/RestoreHistory/List][%d] listRestoreHistoryOk  %+v", 200, o.Payload)
}
...
func (o *ListRestoreHistoryDefault) Error() string {
	return fmt.Sprintf("[POST /v1/backup/RestoreHistory/List][%d] ListRestoreHistory default  %+v", o._statusCode, o.Payload)
}
