...
func (o *ListLocationsOK) Error() string {
	return fmt.Sprintf("[POST /v1/backup/Locations/List][%d] listLocationsOk  %+v", 200, o.Payload)
}
...
func (o *ListLocationsDefault) Error() string {
	return fmt.Sprintf("[POST /v1/backup/Locations/List][%d] ListLocations default  %+v", o._statusCode, o.Payload)
}
