...
func (o *DeleteRoleOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/accesscontrol/roles/{role_id}][%d] deleteRoleOk  %+v", 200, o.Payload)
}
...
func (o *DeleteRoleDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/accesscontrol/roles/{role_id}][%d] DeleteRole default  %+v", o._statusCode, o.Payload)
}
