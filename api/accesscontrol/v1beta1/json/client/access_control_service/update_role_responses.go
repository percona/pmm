...
func (o *UpdateRoleOK) Error() string {
	return fmt.Sprintf("[PUT /v1/accesscontrol/roles/{role_id}][%d] updateRoleOk  %+v", 200, o.Payload)
}
...
func (o *UpdateRoleDefault) Error() string {
	return fmt.Sprintf("[PUT /v1/accesscontrol/roles/{role_id}][%d] UpdateRole default  %+v", o._statusCode, o.Payload)
}
