...
func (o *UpdateRoleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /v1/accesscontrol/roles/{role_id}][%d] updateRoleOk %s", 200, payload)
}
...
func (o *UpdateRoleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/accesscontrol/roles/{role_id}][%d] UpdateRole default %s", o._statusCode, payload)
}
...
type UpdateRoleDefaultBodyDetailsItems0 struct {
	...
	// update role default body details items0
	UpdateRoleDefaultBodyDetailsItems0 map[string]interface{} `json:"-"`
}

// UnmarshalJSON unmarshals this object with additional properties from JSON
func (o *UpdateRoleDefaultBodyDetailsItems0) UnmarshalJSON(data []byte) error {
	...
	var rcv UpdateRoleDefaultBodyDetailsItems0
	...
	*o = rcv
	...
	if len(stage2) > 0 {
		...
		o.UpdateRoleDefaultBodyDetailsItems0 = result
	}
...
func (o UpdateRoleDefaultBodyDetailsItems0) MarshalJSON() ([]byte, error) {
	var stage1 struct {
		// at type
		AtType string `json:"@type,omitempty"`
	}
	...
	if len(o.UpdateRoleDefaultBodyDetailsItems0) == 0 { // no additional properties
		return props, nil
	}

	// make JSON object for the additional properties
	additional, err := json.Marshal(o.UpdateRoleDefaultBodyDetailsItems0)
	if err != nil {
		return nil, err
	}
