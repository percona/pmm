...
func (o *StartDumpOK) Error() string {
	return fmt.Sprintf("[POST /v1/dump/Start][%d] startDumpOk  %+v", 200, o.Payload)
}
...
func (o *StartDumpDefault) Error() string {
	return fmt.Sprintf("[POST /v1/dump/Start][%d] StartDump default  %+v", o._statusCode, o.Payload)
}
