...
func (o *UploadDumpOK) Error() string {
	return fmt.Sprintf("[POST /v1/dumps:upload][%d] uploadDumpOk  %+v", 200, o.Payload)
}
...
func (o *UploadDumpDefault) Error() string {
	return fmt.Sprintf("[POST /v1/dumps:upload][%d] UploadDump default  %+v", o._statusCode, o.Payload)
}
