...
func (o *GetDumpLogsOK) Error() string {
	return fmt.Sprintf("[GET /v1/dumps/{dump_id}/logs][%d] getDumpLogsOk  %+v", 200, o.Payload)
}
...
func (o *GetDumpLogsDefault) Error() string {
	return fmt.Sprintf("[GET /v1/dumps/{dump_id}/logs][%d] GetDumpLogs default  %+v", o._statusCode, o.Payload)
}
