...
// Minimal ImportMeta declaration so @pmm-extensions/api can read `import.meta.env.DEV`
// without depending on Vite directly. Consuming apps (e.g. @pmm-extensions/shell) pull
