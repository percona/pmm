 ...
 *
 * An embedded host that owns the session instead of PMM Extensions (PMM) registers a
...
export const apiClient = axios.create({
  baseURL: `${EXTENSIONS_BASE_PATH}/api`,
  // Send the HttpOnly refresh cookie on /extensions/api/oauth/* requests (same-origin
