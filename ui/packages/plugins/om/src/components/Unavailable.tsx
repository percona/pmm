...
import type { OmUnavailableReason } from '../types';

interface UnavailableProps {
  /** Reason code from the document's `unavailable` map. */
  reason?: OmUnavailableReason | string | null;
}

/**
 * The em-dash-with-a-cause that stands in for every null OM reports.
 *
 * A null in OM means "not observable", never zero, and the document names the
