...
/**
 * A run's progress: every host's steps, rollback steps, and (once added) finalize
 * steps, rendered the same way wherever a run is shown - so there is one rendering
 * of it rather than several that can drift.
 */
