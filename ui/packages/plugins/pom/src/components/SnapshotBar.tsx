...
import type { PomSnapshotEnvelope } from '../types';

/**
 * Snapshot provenance, on screen rather than buried.
 *
 * POM serves the newest *terminal* run's snapshot, including one that reached no
 ...
 */
export function SnapshotBar({ envelope }: { envelope: PomSnapshotEnvelope }) {
  return (
