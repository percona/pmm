...
import type { PomRunStatus, PomServiceStatus } from '../types';
 ...
 */
export function StatusBadge({ status }: { status: PomServiceStatus }) {
  return (
    <Chip
      size="small"
...
export function RunStatusBadge({ status }: { status: PomRunStatus }) {
  return (
    <Chip
      size="small"
