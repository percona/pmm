    ...
    >
      ...
      <DialogContent sx={{ pt: 2 }}>
        <Typography variant="body1" sx={{ mb: 2 }}>
          The AI assistant wants to execute the following tool(s). Please review
        ...
        >
          <Typography variant="body2" color="warning.dark">
            <strong>Security Notice:</strong> Only approve tools if you trust
            the source and understand what they will do. Tool execution may
            access your system, databases, or external services.
          </Typography>
        </Box>
      </DialogContent>
      ...
      >
        <Button onClick={handleDeny} color="error" variant="outlined">
          Deny
        </Button>
        <Button
