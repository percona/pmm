    ...
    <Container maxWidth="lg">
      <Box sx={{ py: 4 }}>
        ...
        <Typography variant="body1" color="textSecondary" paragraph>
          This is a demonstration of how AI can be integrated into PMM Query
          Analytics (QAN). The AI assistant can analyze query performance data,
          suggest optimizations, and provide insights based on real QAN metrics.
        </Typography>

        <Alert severity="info" sx={{ mb: 4 }}>
          <Typography variant="body2">
            <strong>Note:</strong> This is a proof-of-concept demonstration
            created to showcase how AI can be integrated into QAN and to collect
            feedback from the community. There is currently no ETA for when this
            feature will be officially integrated into PMM.
          </Typography>
        </Alert>
        <Paper sx={{ p: 3, mb: 4 }}>
          ...
          <Typography variant="body2" paragraph>
            The AI assistant is integrated with PMM's Query Analytics engine to
            provide intelligent insights about database performance. It can
            analyze real query metrics, identify bottlenecks, and suggest
            optimization strategies.
          </Typography>

          <Typography variant="body2" paragraph>
            This demonstration shows how AI can be seamlessly integrated into
            database monitoring tools to provide intelligent analysis and
            optimization recommendations. The AI assistant understands query
            performance metrics and can help database administrators identify
          ...
          <Typography variant="body2" paragraph>
            Key capabilities include analyzing slow queries, suggesting index
            optimizations, identifying resource bottlenecks, and providing best
            practices for database performance tuning.
          </Typography>
        </Paper>
        ...
        <Paper sx={{ p: 3, mb: 4 }}>
          ...
          <Typography variant="body2" paragraph>
            1. <strong>Open the AI Chat:</strong> Click the floating chat button
            in the bottom-right corner
          </Typography>

          <Typography variant="body2" paragraph>
            2. <strong>Analyze Query Performance:</strong> Ask the AI to analyze
            the current QAN data, identify slow queries, or suggest
            optimizations
          </Typography>

          <Typography variant="body2" paragraph>
            3. <strong>Interactive Exploration:</strong> Use the query table
            below to filter and sort data, then ask the AI for insights about
            specific queries or patterns
          </Typography>
          ...
          <Box sx={{ mt: 3 }}>
            ...
            <Box sx={{ mt: 1 }}>
              <Typography
                ...
                display="block"
              >
                This will open the AI analysis popup with comprehensive analysis
                of all current QAN data
              </Typography>
            </Box>
          </Box>
        </Paper>
        ...
        <Paper sx={{ p: 3, mb: 4 }}>
          ...
          {qanError && (
            <Alert severity="info" sx={{ mb: 2 }}>
              <Typography variant="body2">
                <strong>QAN Data Status:</strong> Real QAN data is not
                available. This is normal in development environments.
              </Typography>
            </Alert>
          )}
          ...
          {qanError && !qanData && (
            <Alert severity="warning" sx={{ mb: 2 }}>
              ...
              <Typography variant="body2" color="textSecondary" sx={{ mt: 1 }}>
                This is normal in development environments where QAN collection
                may not be configured. In a production PMM setup with monitored
                databases, this would show real query performance data.
              </Typography>
            </Alert>
          )}
          ...
          {isLoadingQAN && !qanData && (
            <Box sx={{ textAlign: 'center', py: 3 }}>
              ...
              <Typography variant="body1">Loading QAN data...</Typography>
            </Box>
          )}
