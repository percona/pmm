...
export const PMM_ALERTING_TEMPLATES_PATH = `${PMM_NEW_NAV_PATH}/alerting/alert-rule-templates`;
export const PMM_ALERTING_NEW_FROM_TEMPLATE_PATH = `${PMM_NEW_NAV_PATH}/alerting/new-from-template`;
