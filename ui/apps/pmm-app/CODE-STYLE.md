...
> **Note**: this guide is based on [AirBnB's JavaScript Style Guide](https://github.com/airbnb/javascript). It shall be consistently applied across all of PMM's code base.
