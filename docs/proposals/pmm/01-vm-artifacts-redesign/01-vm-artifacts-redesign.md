...
[Currently](https://github.com/percona/pmm/blob/pmm-3.35.0/build/packer/pmm3.json), we build several VM artifacts with CentOS 7 as a base. There is also work to migrate that base to EL 9 base. 
