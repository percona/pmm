...
To reactivate silenced alerts, click **Unsilence All** or click on the disabled bell icon ![!](../_images/disabled_bell.png) corresponding to the alerts you want to reactivate. 
