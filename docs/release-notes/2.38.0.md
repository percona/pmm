...
If you want to upgrade manually in the meantime, check out the instructions in the [PMM is getting a modernized enterprise-grade foundation blog post](https://www.percona.com/blog/pmm-el9/).
