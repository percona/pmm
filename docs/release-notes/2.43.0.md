...
- [PMM-13159](https://perconadev.atlassian.net/browse/PMM-13159) - Removed experimental mongodb collection details dashboard as the same info is now available on the new experimental mongodb cluster summary dashboard.
