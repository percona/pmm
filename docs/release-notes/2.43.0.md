...
2. **MongoDB Replica Set Summary Dashboard**  
   - Extensively revamped with:
...
3. **MongoDB Sharded Cluster Summary Dashboard** (previously **MongoDB Cluster Summary**)  
   ...
   - Enhanced version information display, including MongoS (router) versions.
   - Improved visibility of all components within the sharded cluster architecture.

4. **Updated MongoDB Section Structure**  
