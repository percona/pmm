...
- [PMM-13255](https://perconadev.atlassian.net/browse/PMM-13255) - Fixed two issues in the MongoDB Replication Lag Alert where an error was returned when importing this alert rule template, and an incorrect current value for the lag was reported in the alert description.
