...
- [PMM-12451](https://perconadev.atlassian.net/browse/PMM-12451) and [PMM-13017](https://perconadev.atlassian.net/browse/PMM-13017)  - Fix issue with parsing JSON objects into correct data types. Aligning `explain` functionality with the official client.

- [PMM-13071](https://perconadev.atlassian.net/browse/PMM-13071) - Fix issue with unsupported explain type - `INSERT`. You will get a message that `INSERT` is 
