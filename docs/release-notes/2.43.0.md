...
- [PMM-13054](https://perconadev.atlassian.net/browse/PMM-13054) - The default number of log lines for each log file returned by the **Download server diagnostics** endpoint has been increased from 1,000 to 50,000. 
