...
- [PMM-12451](https://perconadev.atlassian.net/browse/PMM-12451) - Fix issue with parsing JSON objects into correct data types. Aligning `explain` functionality with the official client.
