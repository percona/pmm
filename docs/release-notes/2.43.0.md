...
#### Redesigned dashboards now in GA
...
- **Enhanced usability and insights**: Intuitive designs with improved filtering and comprehensive metrics, benefiting both new and experienced users.
...
#### Improved MongoDB navigation

To complement the dashboard improvements, we've also restructured the MongoDB monitoring section:

* **Reorganized menu**: The MongoDB section now offers more intuitive navigation.
* **New experimental offerings**: Introduction of **Oplog Details** and **Collection Overview** experimental dashboards.
