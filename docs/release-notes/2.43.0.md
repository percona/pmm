...
- [PMM-13111](https://perconadev.atlassian.net/browse/PMM-13111) - Fixed an issue with --disable-collector flag not supporting new collectors introduced in recent postgres_exporter upgrade.
