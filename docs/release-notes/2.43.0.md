...
- [PMM-13141](https://perconadev.atlassian.net/browse/PMM-13141) - Introduced new MongoDB metrics for Feature Compatibility Version (FCV), providing insights into the MongoDB version compatibility of individual nodes, enhancing monitoring capabilities for multi-version MongoDB deployments.
