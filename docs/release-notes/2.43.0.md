...
This is made possible via a new PBM collector in MongoDB exporter that gives you visibility to your PBM set up via these metrics:
...
These metrics are enabled by default, and you do not have to do anything on your end to get them if you are already running Percona Backup for MongoDB.
## Improvements
