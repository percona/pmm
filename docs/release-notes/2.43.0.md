...
### QAN: Upgrade `pg_query_go` to v5 and its impact on PostgreSQL 9.x

As part of our ongoing maintenance efforts, with [PMM-13133](https://perconadev.atlassian.net/browse/PMM-13133) we have upgraded the `pg_query_go` package to version 5. This latest version helps parse PostgreSQL queries in QAN, provides improved functionality, and enables subsequent upgrades of important dependencies.
