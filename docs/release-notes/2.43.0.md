...
- [PMM-13246](https://perconadev.atlassian.net/browse/PMM-13246) - Address four security vulnerabilities (CVEs) related to the GNU C Library (Glibc), specifically affecting the Name Service Cache Daemon (nscd):
 ...
 While these vulnerabilities did not directly impact PMM's core functionality, fixing them enhances the overall security of the PMM Server environment. 
