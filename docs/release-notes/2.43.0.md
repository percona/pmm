...
We're excited to announce significant enhancements to MongoDB monitoring in PMM, focusing on redesigned dashboards, streamlined navigation, and general availability of previously experimental dashboards.
...
You can find the updated dashboards in the **MongoDB** and **Dashboards** sections in the main menu, as they now replace the previous versions as the default dashboards for MongoDB monitoring.
...
![New MongoDB menu structure](../images/new_Mongo_menu.jpg)
