...
| ![!image](../../_images/mysql-dashboard.png)  ![!image](../../_images/haproxy-dashboard.png)  ![!image](../../_images/postresql-dashboard.png)  | Service Type dashboards |   Navigate to the dasboards available for the [services added for monitoring](../../install-pmm/install-pmm-client/connect-database/index.md) (MySQL, MongoDB, PostgreSQL, HAproxy or ProxySQL).
