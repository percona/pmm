...
!!! note
    ...
    There are two possible sources for query metrics provided by MySQL to get data for the Query Analytics: the [slow log](conf-mysql-slow-log.md) and the [Performance Schema](conf-mysql-perf-schema.md).
