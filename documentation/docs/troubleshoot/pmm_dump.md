...
6. Toggle on **Enable encryption** to encrypt the dump file. The **Encryption password** field appears below the toggle.
6. Enter a password and save it somewhere safe. PMM does not store it, and if you lose it you will need to create a new dump.
