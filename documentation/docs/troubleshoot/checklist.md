...
8. Have you allocated enough [disk space](https://www.percona.com/blog/how-much-disk-space-should-i-allocate-for-percona-monitoring-and-management/) for installing PMM? If not, check the disk allocation space.
