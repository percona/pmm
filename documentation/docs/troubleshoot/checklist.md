...
7. Does your system’s firewall allow TCP traffic on the [ports](../install-pmm/plan-pmm-installation/network_and_firewall.md#ports) used by PMM?
...
12. Is the [PMM Client](../install-pmm/install-pmm-client/index.md) installed, and is the node [registered with PMM Server](../install-pmm/install-pmm-client/index.md#register)?
