...
We have removed the `percona-telemetry-agent` binary from the PMM Server image. It was built on Go 1.26.5 and carried 8 HIGH-severity Go standard library vulnerabilities. Removing it eliminates those CVEs entirely.
...
### Grafana Tempo denial of service and information disclosure ([CVE-2026-21728](https://nvd.nist.gov/vuln/detail/CVE-2026-21728) and [CVE-2026-28377](https://nvd.nist.gov/vuln/detail/CVE-2026-28377))
