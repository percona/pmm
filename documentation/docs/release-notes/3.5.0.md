...
Full support for all PostgreSQL 18 variants and enhanced metrics collection are planned for PMM 3.6.0.
...
Security scanning tools may flag race condition vulnerabilities in the `opencontainers/selinux`, which was fixed in this version.
