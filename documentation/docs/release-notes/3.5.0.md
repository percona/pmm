...
The internal PostgreSQL server may fail to shut down gracefully, causing PostgreSQL and Grafana to enter FATAL state and display *"500 Internal Server Error"*.
