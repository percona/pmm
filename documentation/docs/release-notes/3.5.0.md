...
ClickHouse upgraded to 25.3.6.56
This release upgrades ClickHouse from version 23.8.2.7 to 25.3.6.56, which addresses security vulnerability CVE-2024-24790 in the net/netip Go package. The vulnerable clickhouse-diagnostics binary that was present in earlier versions has been removed from the package.
