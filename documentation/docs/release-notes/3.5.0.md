...
This release upgrades ClickHouse from version 23.8.2.7 to 25.3.6.56, fully resolving security vulnerability CVE-2024-24790 that was partially addressed in PMM 3.4.1. The new version includes an updated Go runtime and provides additional performance improvements and security enhancements.
