...
- [PMM-10461](https://perconadev.atlassian.net/browse/PMM-10461): Improved compatibility with proxy servers by standardizing all Nginx redirects to relative paths. Previously, PMM used a mixture of absolute and relative redirects, causing issues with some external proxies. All redirects now use relative paths, consistent with Grafana's behavior.
