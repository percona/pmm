...
To get started, see [Connect Valkey databases to PMM](../install-pmm/install-pmm-client/connect-database/valkey.md).
...
- Added idle connect
ions metric to the **Connections** panel in **Cluster Summary** and **Replica Set Summary** dashboards to help identify performance issues:
...
Go runtime vulnerabilities from Go 1.24.7 (CVE-2025-47912, CVE-2025-58183, CVE-2025-58186, CVE-2025-58187, CVE-2025-58188, CVE-2025-61724)__¶__
PMM 3.5.0 addresses these vulnerabilities through an upgrade to Go 1.24.9.

Security scanning tools may flag these CVEs as present in the Go 1.24.7 runtime used in earlier PMM versions. All reported vulnerabilities have been fixed in Go 1.24.9. PMM 3.5.0 upgrades the Go runtime to this patched version, resolving these CVEs and bringing additional runtime improvements and security enhancements.