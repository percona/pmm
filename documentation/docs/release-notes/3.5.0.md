...
**Release date**: November 20, 20205
...
To get stated, see [Connect Valkey and Redis databases to PMM](../install-pmm/install-pmm-client/connect-database/valkey-redis.md).
