...
Building on the existing OpenShift compatibility available for PMM Client, PMM 3.4.0 now extends full support to PMM Server as well. All PMM Docker images now meet Red Hat certification requirements, including non-root user execution and SecurityContextConstraints (SCC) support. This means that both PMM Client and PMM Server can be deployed seamlessly in OpenShift environments.
