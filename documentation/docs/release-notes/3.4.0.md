...
When adding MySQL instances that use PAM or external authentication plugins, include the allowCleartextPasswords=1 parameter. For example:

```bash
pmm-admin add mysql mysql-pam 127.0.0.1:8039 \
  --username=mysql_user \
