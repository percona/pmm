...
When adding RDS instances via **Inventory > Add Service**, you can now specify an Instance ID that matches your AWS RDS instance identifier. This optional field helps you manage large RDS deployments by providing a clear reference between monitored instances in PMM and their corresponding resources in AWS. 
