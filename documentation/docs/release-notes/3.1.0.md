...
Based on community feedback, we've improved the monitoring experience in both the **MongoDB ReplicaSet Summary** and the **MongoDB Sharded Cluster Summary** dashboards. These improvements deliver more accurate and actionable insights:
