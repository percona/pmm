...
The **Fired Alerts** tab under Alerting is now accessible to both Viewer and Editor roles, allowing teams to monitor triggered Alert Rules without needing elevated permissions.
