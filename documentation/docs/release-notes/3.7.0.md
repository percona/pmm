...
Existing OVF-based deployments will keep working, but new OVA images will not be available after PMM 3.9. Make sure you migrate to a supported deployment method before then:
