...
!!! caution "Technical Preview – MongoDB only"  
...
PMM 3.7.0 introduces Real-time Query Analytics (RTA), a new way to see exactly what's happening on your databases right now. 
