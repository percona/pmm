...
- [PMM-14822](https://perconadev.atlassian.net/browse/PMM-14822): Fixed navigation issues when Grafana anonymous access is enabled (`auth.anonymous` setting in `grafana.ini`), including missing menu items and search bar glitches.ini` file, including missing menu items and search bar glitches.
