...
After PMM 3.13 (expected January 2027), migration from PMM 2.x will no longer be supported. If you are still running PMM 2.x, [migrate PMM 2 to PMM 3](../pmm-upgrade/migrating_from_pmm_2.md) now.
