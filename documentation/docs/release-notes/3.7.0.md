...
## 📈 Improvements
- [PMM-14700](https://perconadev.atlassian.net/browse/PMM-14700): Advisor checks now only run for database types present in your inventory. Previously, all checks executed regardless of your actual setup. For example, MongoDB checks no longer run if you only had PostgreSQL services configured. This reduces resource usage and eliminates irrelevant results from your Advisor reports.
