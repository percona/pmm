...
- [PMM-14376](https://perconadev.atlassian.net/browse/PMM-14376): Fixed alerts continuing to fire after removing a service or node from PMM inventory. Alerts now check inventory before triggering, preventing false positives.
