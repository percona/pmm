...
To get started, go to **Query Analytics > Real-Time** and select a MongoDB service. For details, see [Real-Time Query Analytics](../use/qan/realtime.md).

[PMM-14550](https://perconadev.atlassian.net/browse/PMM-14550)
