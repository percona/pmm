...
- **Top 10 Queries by Shared Block Reads**: acts as a sequential scan indicator, showing queries reading the most shared blocks on average (requires `pg_stat_statements` or `pg_stat_monitor`)                               
