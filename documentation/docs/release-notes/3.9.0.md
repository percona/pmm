...
![Export RTA button](../images/ExportRTA.png.png)

See [Export data](../use/qan/QAN-realtime-analytics.md#export-data) for step-by-step instructions and a reference of all exported fields.
