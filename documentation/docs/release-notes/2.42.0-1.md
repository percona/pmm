# Percona Monitoring and Management 2.42.0-1 (2024-04-08)
...
1. UPGRADE IMMEDIATELY to PMM 2.42.0-1 or to the latest PMM 2 release [PMM 2.44.0-1](../release-notes/2.44.0.1.md).
...
|-------------------------------------------|---------|-------|
| PMM Open Virtual Appliance (OVA) installations | PMM 2.38.0 through  2.44.0 and PMM 3.0.0 |  Fixed in PMM 2.42.0-1, PMM 2.43.2-1, 2.44.0-1 and 3.0.0-1    |
...
=== "PREFERRED: Upgrade to PMM 2.42.0-1 or 2.44.0-1"
