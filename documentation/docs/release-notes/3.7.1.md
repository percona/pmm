...
- [PMM-14852](https://perconadev.atlassian.net/browse/PMM-14852): Fixed the **MongoDB InMemory Details** dashboard, where several panels were empty because PMM stopped reporting the metrics they rely on. Transactions, cache, and other panels now display data correctly for MongoDB instances using the InMemory storage engine.
