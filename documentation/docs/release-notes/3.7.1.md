...
- [PMM-14958](https://perconadev.atlassian.net/browse/PMM-14958): When monitoring MySQL instances with GTID and parallel replication enabled, PMM logs would fill up with duplicate metric errors. This is now fixed.
