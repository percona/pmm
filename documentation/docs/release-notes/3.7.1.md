...
- [PMM-14957](https://perconadev.atlassian.net/browse/PMM-14957): Fixed an issue where the PostgreSQL Summary dashboard would show no data after navigating away and back to it.
