...
- [PMM-13683](https://perconadev.atlassian.net/browse/PMM-13683) - Building on the OpenShift compatibility introduced for the PMM Client in version 2.44, PMM 3.0 extends this support to include PMM Server. All PMM Docker images now comply with Red Hat certification requirements, ensuring seamless deployment of the entire PMM stack in OpenShift environments.
