...
- [PMM-13683](https://perconadev.atlassian.net/browse/PMM-13360) -  Updated `vendor` and `maintainer` Docker image labels to meet Red Hat certification requirements, ensuring compatibility with PSMDB Operator 1.19.0 and seamless deployment in OpenShift environments.
