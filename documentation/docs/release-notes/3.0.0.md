...
The MongoDB Router Summary dashboard, initially introduced as an experimental dashboard in PMM v2, is now generally available in PMM v3. This dashboard provides comprehensive monitoring for MongoS routers in sharded MongoDB clusters, offering insights into MongoS availability, version details and resource utilization. 
