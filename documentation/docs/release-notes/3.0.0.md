...
- [Imporved user experience](#improved-user-experience)
...
PMM Server now supports rootless deployment through multiple methods, including the latest versions of Podman, Helm (chart version 1.4.0+), Docker, Virtual Appliance, and Amazon AWS.
