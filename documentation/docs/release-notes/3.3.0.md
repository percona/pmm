...
-  [Patroni Details](../reference/dashboards/dashboard-postgresql-patroni-details.md): Monitors high availability clusters and ensures uptime reliability (promoted from experimental status)
