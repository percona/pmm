...
We’ve also removed support for Ubuntu 20.04 LTS following its end-of-life, and included numerous bug fixes and performance improvements to enhance overall stability.
...
PMM 3.3.0 will soon be available for deployment through the [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-uww55ejutsnom?sr=0-1&ref_=beagle&applicationId=AWSMPContessa), making it easier to deploy Percona Monitoring and Management in your AWS environment. 

What to expect:

- Pre-configured AMI for quick deployment
- Simple hourly pricing plus standard EC2 costs
- Deploy with a few clicks directly from AWS Marketplace
