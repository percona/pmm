...
-  **Checkpoints, Buffers and WAL Usage**: monitors checkpoint performance and correlates I/O usage patterns
...
-  **PostgreSQL Patroni Details**: monitors high-availability PostgreSQL clusters with cluster member status, replication health, and failover monitoring (promoted from experimental status)
