...
To enable mongolog, add `--query-source=mongolog` when registering MongoDB services. For setup instructions, see [Connect MongoDB databases to PMM](../use/connecting-databases/mongodb/mongodbl#configure-query-source-for-mongodb.md).
