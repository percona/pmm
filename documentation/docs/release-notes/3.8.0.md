...
- [PMM-14441](https://perconadev.atlassian.net/browse/PMM-14441): PMM Dump now encrypts exports by default. When importing a dump, PMM expects an encrypted file. If your dump was created without encryption, add the `--no-encryption` flag when importing. See [Encrypted dumps](../troubleshoot/pmm_dump.md#encrypted-dumps).
