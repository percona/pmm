...
- [PMM-15112](https://1.atlassian.net/browse/PMM-15112): Fixed an issue where a leftover live reload script in Grafana caused an unexpected browser prompt for some users.
