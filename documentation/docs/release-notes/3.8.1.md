...
#### pgx memory-safety vulnerability

CRITICAL severity. Fixed by bumping pgx from v5.8.0 to v5.9.2 in the Percona Grafana fork. Tracked as [CVE-2026-33816](https://nvd.nist.gov/vuln/detail/CVE-2026-33816).

#### gRPC authorization bypass

HIGH severity. Fixed through upstream dependency updates across all PMM components. Tracked as [CVE-2026-33186](https://nvd.nist.gov/vuln/detail/CVE-2026-33186).

#### Go stdlib MIME header decoding DoS

HIGH severity. Fixed across pmm-dump, VictoriaMetrics, and vmalert by rebuilding on Go 1.26.4. Tracked as [CVE-2026-42504](https://nvd.nist.gov/vuln/detail/CVE-2026-42504).

#### Docker engine vulnerabilities in Nomad

HIGH severity. Fixed through upstream Nomad dependency update. Tracked as [CVE-2026-41567](https://nvd.nist.gov/vuln/detail/CVE-2026-41567) and [CVE-2026-42306](https://nvd.nist.gov/vuln/detail/CVE-2026-42306).

#### nginx TLS backend injection

HIGH severity. Fixed by upgrading the bundled nginx. Tracked as [CVE-2026-1642](https://nvd.nist.gov/vuln/detail/CVE-2026-1642).
...
#### Go JOSE denial of service

Affects the go-jose library used by Grafana for JWT/JWE processing. PMM authentication is required to reach the affected endpoints, and the impact is limited to denial of service. Will be resolved through a future Grafana upstream update. Tracked as [CVE-2026-34986](https://nvd.nist.gov/vuln/detail/CVE-2026-34986).

#### Docker engine vulnerabilities in Grafana transitive dependencies

Affects `moby/moby`, an unused transitive build dependency in the Grafana binary. PMM does not run or expose a Docker daemon, so the vulnerable code paths are never executed. Tracked as [CVE-2026-34040](https://nvd.nist.gov/vuln/detail/CVE-2026-34040), [CVE-2026-41567](https://nvd.nist.gov/vuln/detail/CVE-2026-41567), and [CVE-2026-42306](https://nvd.nist.gov/vuln/detail/CVE-2026-42306).

#### Grafana Tempo denial of service and information disclosure

Affects the Tempo tracing datasource compiled into Grafana. PMM does not configure or use Tempo, so the vulnerable endpoints are not reachable. Tracked as [CVE-2026-21728](https://nvd.nist.gov/vuln/detail/CVE-2026-21728) and [CVE-2026-28377](https://nvd.nist.gov/vuln/detail/CVE-2026-28377).

#### Apache Thrift integer overflow

Affects the Thrift library, an unused transitive dependency in the Grafana binary. PMM uses gRPC and HTTP/JSON for inter-component communication, not Thrift, so the vulnerable code path is unreachable. Tracked as [CVE-2026-41602](https://nvd.nist.gov/vuln/detail/CVE-2026-41602).

#### Prometheus library vulnerabilities

Affects the Prometheus library embedded in Grafana for PromQL evaluation. PMM does not use Azure OAuth or Prometheus remote read, and Grafana access requires PMM authentication. Tracked as [CVE-2026-42151](https://nvd.nist.gov/vuln/detail/CVE-2026-42151) and [CVE-2026-42154](https://nvd.nist.gov/vuln/detail/CVE-2026-42154).

#### OpenTelemetry vulnerabilities

Affects the OpenTelemetry SDK in the Grafana binary. The PATH hijacking CVEs require pre-existing container compromise, and PMM does not accept inbound OpenTelemetry traffic, so none are exploitable in a standard deployment. Tracked as [CVE-2026-29181](https://nvd.nist.gov/vuln/detail/CVE-2026-29181), [CVE-2026-24051](https://nvd.nist.gov/vuln/detail/CVE-2026-24051), and [CVE-2026-39883](https://nvd.nist.gov/vuln/detail/CVE-2026-39883).
