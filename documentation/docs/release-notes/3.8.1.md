...
Updated PMM Client and Server dependencies to address multiple security vulnerabilities, including a critical gRPC authorization bypass (CVE-2026-33186) and high severity fixes for Docker, Go JOSE, go-getter, and OpenTelemetry dependencies.
