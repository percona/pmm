...
- **Instances Overview**: the **Overview** section now focuses on topology and health metrics instead of detailed resource metrics. Detailed metrics like **Cursors**, **Latency**, and **Query Efficiency** are now only available in **Instance Summary**, **Replica Set Summary**, and **Sharded Cluster Summary**.
