...
## 📈 Improvements
- [PMM-14685](https://perconadev.atlassian.net/browse/PMM-14685): Added **MongoDB [CVE‑2025‑14847](https://nvd.nist.gov/vuln/detail/CVE-2025-14847) Alert for Vulnerable Version with Active Zlib Compression** alert. PMM now monitors MongoDB instances for vulnerable versions using zlib network compression and alerts when a risk is detected. The alert recommends upgrading to a fixed MongoDB version to ensure security.
...
- [PMM-14670](https://perconadev.atlassian.net/browse/PMM-14670): Fixed an issue where old Query Analytics data wasn’t being deleted. Data older than your retention period is now removed correctly.
