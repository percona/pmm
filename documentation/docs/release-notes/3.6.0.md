...
Based on your feedback, we've simplified several MongoDB dashboards so you can find what you need faster and see your data more clearly:

- **Instances Overview**: The **Overview** section now focuses on topology and health metrics instead of detailed resource metrics. The **Cursors**, **Latency**, and **Query Efficiency** panels are now only available in more detailed dashboards: **Instance Summary**, **Replica Set Summary**, and **Sharded Cluster Summary**.
- **Instance Summary**: Clearer **Uptime**, **QPS**, and **Latency** panels with one-decimal precision. The **Command Operations** panel now includes additional metrics.
- **Router Summary**: Improved decimal precision across metrics. A new **Routers** panel at the top shows router status at a glance for quick cluster visibility:

    ![!Current Topology section](../../../documentation/docs/images/current%20topology.png)
