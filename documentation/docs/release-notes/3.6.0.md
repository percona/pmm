...
- [PMM-14528](https://perconadev.atlassian.net/browse/PMM-14528): Updated Watchtower and Docker API libraries  with full Docker v29.0.0 support. The `DOCKER_API_VERSION` workaround is no longer required. If you're using an older PMM version and see `client version is too old` errors, see [Troubleshoot upgrade issues](../troubleshoot/upgrade_issues.md#watchtower-fails-with-client-version-is-too-old-error).
