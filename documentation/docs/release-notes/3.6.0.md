...
Building on the initial PostgreSQL 18 Community support introduced in PMM 3.5.0, this release adds enhanced metrics collection for Query Analytics, including WAL buffer usage and parallel worker statistics.
