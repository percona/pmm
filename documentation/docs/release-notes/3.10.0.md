...
PMM has always been about monitoring your databases. With 3.10.0, you can act on what you find, too.

Alongside monitoring, you can now also run database operations directly in PMM through the new Management framework, powered by Percona's Services Enablement Platform (SEP). No SSH, no extra tools, no context switching.

In this Tech Preview, that means running MySQL backups and sending diagnostic results to your Percona Support case.
In future releases, the integration will expand to support more database operations and database types, giving you a single place to monitor and manage your database infrastructure.
