...
Run and schedule MySQL backups using XtraBackup, Mydumper, or Binlog against MySQL services in your PMM inventory. You can also restore backups and track job status, backup type, and execution history. This will replace the existing PMM MySQL backup feature once the SEP integration reaches GA.
