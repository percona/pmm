...
- **InnoDB redo log panels** in [MySQL InnoDB Details](../reference/dashboards/dashboard-mysql-innodb-details.md) now render correctly across all supported MySQL versions.
...
- **Top Tables by Rows Read** and **Top Tables by Rows Changed** in [MySQL Table Details](../reference/dashboards/dashboard-mysql-table-details.md) now show data for all MySQL variants, including Community MySQL.
