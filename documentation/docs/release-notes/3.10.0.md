...
- [**Support Diagnostics**](../manage/support-diagnostics.md): run targeted diagnostic scripts on your database hosts and send the results straight to your Percona support case in ServiceNow, without connecting to any server or uploading files yourself.
