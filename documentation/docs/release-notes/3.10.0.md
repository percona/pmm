...
Alongside monitoring, you can now also run database operations directly in PMM through the new Management framework, powered by Percona's Services Enablement Platform (SEP). 
