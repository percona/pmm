...
- [PMM-14735](https://perconadev.atlassian.net/browse/PMM-14735): Added [Upgrade PMM HA Cluster using Helm](../pmm-upgrade/upgrade_helm_ha.md), a tested, step-by-step topic for upgrading a PMM HA Cluster deployment, including how to identify the active leader afterward and how to upgrade the PostgreSQL, ClickHouse, and VictoriaMetrics clusters it depends on.
