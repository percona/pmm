...
The new Management framework in this release lets you run database operations directly from PMM, without SSH access or extra software. It connects PMM to Percona's Services Enablement Platform (SEP), the same tool Percona teams use to manage database operations on customer hosts. 
...
To get started, see [Management framework](../manage/index.md).
