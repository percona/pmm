# Percona Monitoring and Management 2.43.2-1
...
|-------------------------------------------|---------|-------|
| PMM Open Virtual Appliance (OVA) installations | PMM 2.38.0 through  2.2.44.0 and PMM 3.0.0 |  Fixed in  PMM 2.43.2-1, 2.44.0-1 and 3.0.0-1    |
