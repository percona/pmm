...
If you are an advanced user, you can access the Nomad API (internal port `4646`) through the standard PMM HTTPS port by appending `/nomad` to your PMM Server URL (e.g., `https://<pmm-server>/nomad`). You must have Administrator privileges to access this endpoint.
