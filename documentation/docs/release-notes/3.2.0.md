...
- [PMM-13748](https://perconadev.atlassian.net/browse/PMM-13748) - Added GSSAPI authentication support for MongoDB monitoring. PMM now supports connecting to MongoDB and Percona Server for MongoDB (PSMDB)  using the GSSAPI authentication mechanism commonly used in Kerberos environments. 
