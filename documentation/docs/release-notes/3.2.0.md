...
Nomad is disabled by default and its increase in Docker image size has no performance impact when not enabled. For more information, see [Nomad configuration](../reference/nomad.md). 
