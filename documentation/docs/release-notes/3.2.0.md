...
- [PMM-13807](https://perconadev.atlassian.net/browse/PMM-13807) - Fixed an issue where `pmm-agent` crashes when it encounters a query that uses the "value" keyword as a column name.
