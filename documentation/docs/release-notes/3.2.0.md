...
- [PMM-13210](https://perconadev.atlassian.net/browse/PMM-13210) - Upgraded VictoriaMetrics to version 1.114.0, which includes several performance improvements and bug fixes. This upgrade enhances the overall performance and reliability of PMM's metrics storage and retrieval.
