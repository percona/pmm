...
!!! note "Release update - January 30th, 2025 "
    ...
    This update was required to ensure compatibility with PSMDB Operator 1.19.0 and enables seamless deployment in OpenShift environments.
