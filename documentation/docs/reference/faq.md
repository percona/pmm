...
- [Community forum :octicons-link-external-16:](https://www.percona.com/forums/questions-discussions/percona-monitoring-and-management){:target="_blank"}.
- [PMM project in JIRA :octicons-link-external-16:](https://jira.percona.com/projects/PMM){:target="_blank"}.
...
!!! seealso alert alert-info "See also"
    [Grafana Alerting :octicons-link-external-16:](https://grafana.com/docs/grafana/latest/alerting/){:target="_blank"}

## How do I use a custom Prometheus configuration file?

Normally, PMM Server fully manages the [Prometheus configuration file :octicons-link-external-16:](https://prometheus.io/docs/prometheus/latest/configuration/configuration/){:target="_blank"}.
...
!!! seealso alert alert-info "See also"
    - [API](../api/index.md)
    - [Percona blog: Extending PMM’s Prometheus Configuration :octicons-link-external-16:](https://www.percona.com/blog/2020/03/23/extending-pmm-prometheus-configuration/){:target="_blank"}
...
Read our [Privacy Policy :octicons-link-external-16:](https://www.percona.com/privacy-policy){:target="_blank"} to learn how PMM manages personal and confidential data. More technical details can be found in [Data handling in PMM](personal_data_handling.md).

## Why am I getting a "User already exists" error when logging back into PMM?

Following [CVE fix 2023-3128 :octicons-link-external-16:](https://grafana.com/blog/2023/06/22/grafana-security-release-for-cve-2023-3128/){:target="_blank"} in the 2.38 release, PMM increases security by only allowing authentications based on the unique user ID provided by the identity provider.
