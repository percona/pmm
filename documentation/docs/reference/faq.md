...
- [Community forum](https://www.percona.com/forums/questions-discussions/percona-monitoring-and-management){:target="_blank"}.
- [PMM project in JIRA](https://jira.percona.com/projects/PMM){:target="_blank"}.
...
!!! seealso alert alert-info "See also"
    - [API](../api/index.md)
    - [Percona blog: Extending PMM’s Prometheus Configuration](https://www.percona.com/blog/2020/03/23/extending-pmm-prometheus-configuration/){:target="_blank"}
...
Read our [Privacy Policy](https://www.percona.com/privacy-policy){:target="_blank"} to learn how PMM manages personal and confidential data. More technical details can be found in [Data handling in PMM](personal_data_handling.md).
