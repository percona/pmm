...
Change the user account password with [ALTER USER](https://dev.mysql.com/doc/refman/8.4/en/alter-user.html) or [SET PASSWORD](https://dev.mysql.com/doc/refman/8.4/en/set-password.html) command. 
