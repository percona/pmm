...
- **Amazon S3-compatible**: enables you to use not only AWS S3, but also other storage solutions that support S3 API, like [min.io :octicons-link-external-16:](https://min.io/){:target="_blank"}.
...
For more information, see the [Percona Backup for MongoDB (PBM) documentation :octicons-link-external-16:](https://docs.percona.com/percona-backup-mongodb/details/storage-configuration.html#remote-filesystem-server-storage){:target="_blank"}.

## Prepare a location for S3-compatible storage
If you want to store backup artifacts in S3-compatible storage, you can use [Amazon S3 :octicons-link-external-16:](https://aws.amazon.com/s3/){:target="_blank"}, [Min.io :octicons-link-external-16:](https://min.io/){:target="_blank"} or any other storage solution with S3-compatible API.
...
A sample [IAM :octicons-link-external-16:](https://aws.amazon.com/iam/){:target="_blank"} policy is:
