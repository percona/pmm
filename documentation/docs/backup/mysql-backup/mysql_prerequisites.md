...
9. Check that the latest versions of the following packages are installed and included in the `$PATH` environment variable:
    ...
    - [`xtrabackup`](https://www.percona.com/software/mysql-database/percona-xtrabackup){:target="_blank"}, which includes:

        - [`xbcloud`](https://www.percona.com/doc/percona-xtrabackup/2.3/xbcloud/xbcloud.html){:target="_blank"}

        - [`xbstream`](https://www.percona.com/doc/percona-xtrabackup/2.3/xbstream/xbstream.html){:target="_blank"}
