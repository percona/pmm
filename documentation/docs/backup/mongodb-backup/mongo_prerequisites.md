...
6. Check that your MongoDB Services are managed as clusters in PMM. Go to **Inventory > Services** page, expand the **Details** section :material-arrow-downward: on the **Options** column, and make sure that all the services in the table specify a cluster name.
