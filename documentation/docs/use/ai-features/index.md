...
| **PMM Agent (chat backend)** | An optional mode where chat goes through the **PMM Agent** with a built-in system prompt instead of talking to HolmesGPT directly. Admins choose this in settings. |
