...
Other useful metrics (when using **pg_stat_monitor**) to monitor PostgreSQL Server performance are [Histograms](https://docs.percona.com/pg-stat-monitor/user_guide.html#histogram){:target="_blank"}. 
