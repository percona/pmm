...
| [**:material-server: Virtual Appliance**](../install-pmm-server/deployment-options/virtual/index.md) *(deprecated)* | Traditional environments | ✔  Pre-configured with all dependencies<br>✔  Dedicated resources | ⚠ Deprecated in PMM 3.7.0, will be removed in PMM 3.9.0<br>⚠ Migrate to Docker or another supported method |
...
=== "Small-scale (1-30 database instances)"
    ...
    - **PMM Server**: Docker (recommended) or Podman
