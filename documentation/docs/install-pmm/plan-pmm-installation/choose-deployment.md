...
| [Amazon AWS](../install-pmm-server/deployment-options/aws/deploy_aws.md) | AWS-based environments | Seamless AWS integration, easy provisioning | Monthly subscription costs, AWS infrastructure costs |
