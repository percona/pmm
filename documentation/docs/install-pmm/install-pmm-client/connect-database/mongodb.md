...
=== "Via CLI"
    ...
    !!! hint alert alert-success "Tips"
        ...
        - PMM does not gather collection and index metrics if it detects you have more than 200 collections, in order to limit the resource consumption. Check the [advanced options](../../..//use/commands/pmm-admin/pmm-admin.md#advanced-options) section if you want to modify this behaviour. 
...
- [`pmm-admin add mongodb`](../../..//use/commands/pmm-admin/pmm-admin.md#database-commands)
...
[PMM_ADMIN_MAN_PAGE]: ../../..//use/commands/pmm-admin/pmm-admin.md#database-commands
