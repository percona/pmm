...
The preferred method of adding an Amazon RDS database instance to PMM is via the :material-cog: **Configuration** → {{icon.inventory}} **PMM Inventory** → :material-plus-circle-outline: **Add Instance** menu option.
