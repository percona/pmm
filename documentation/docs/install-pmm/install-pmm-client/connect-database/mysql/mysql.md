...
=== "Slow query log"
    ...
    === "Automatic log rotation"
        ...
        The size is specified as a number followed by a suffix (e.g., `10M` for 10 megabytes). For detailed syntax, see [pmm-admin add mysql](../../../../use/commands/pmm-admin/pmm-admin.md#command-reference).
