...
1. Create a dedicated MySQL user with the required permissions:
   ...
   **Note:**
   If you are using an [Administrative Connection](https://dev.mysql.com/doc/refman/8.4/en/administrative-connection-interface.html){:target="_blank"}, you will also need to grant the `SERVICE_CONNECTION_ADMIN` privilege to the `pmm` user.
