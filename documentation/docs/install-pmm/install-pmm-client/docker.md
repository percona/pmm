...
The [PMM Client Docker image :octicons-link-external-16:](https://hub.docker.com/r/percona/pmm-client/tags/){:target="_blank"} provides a convenient way to run PMM Client as a pre-configured container without installing software directly on your host system.
...
1. Install [Docker Engine :octicons-link-external-16:](https://docs.docker.com/get-docker/){:target="_blank"}.
