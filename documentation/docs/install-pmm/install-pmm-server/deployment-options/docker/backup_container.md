...
## Back up PMM Server container
To back up your PMM Server container, follow the backup instructions for your deployment type.
{.power-number}

1. Identify your deployment type and storage method since different PMM Server deployments store data differently:
...
```sh
# For Docker deployments - check how data is stored
...
2. Choose the appropriate backup method based on your PMM Server deployment:
...
3. Verify the integrity of the backup:
