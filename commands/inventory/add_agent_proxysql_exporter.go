...
func init() {
	...
	AddAgentProxysqlExporterC.Arg("username", "ProxySQL username for scraping metrics").Default("root").StringVar(&AddAgentProxysqlExporter.Username)
	AddAgentProxysqlExporterC.Flag("password", "ProxySQL password for scraping metrics").StringVar(&AddAgentProxysqlExporter.Password)
