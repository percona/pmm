...
var changeAgentNodeExporterResultT = commands.ParseTemplate(`
Node Exporter agent configuration updated.
...
type changeAgentNodeExporterResult struct {
	Agent   *agents.ChangeAgentOKBodyNodeExporter `json:"node_exporter"`
	Changes []string                              `json:"changes,omitempty"`
}

func (res *changeAgentNodeExporterResult) Result() {}

func (res *changeAgentNodeExporterResult) String() string {
	return commands.RenderTemplate(changeAgentNodeExporterResultT, res)
}
...
func (cmd *ChangeAgentNodeExporterCommand) RunCmd() (commands.Result, error) {
	...
	if customLabels != nil {
		body.CustomLabels = &agents.ChangeAgentParamsBodyNodeExporterCustomLabels{
			Values: *customLabels,
		}
	}
	...
	return &changeAgentNodeExporterResult{
