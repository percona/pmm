...
var changeAgentQANMySQLPerfSchemaAgentResultT = commands.ParseTemplate(`
QAN MySQL PerfSchema agent configuration updated.
...
type changeAgentQANMySQLPerfSchemaAgentResult struct {
	Agent   *agents.ChangeAgentOKBodyQANMysqlPerfschemaAgent `json:"qan_mysql_perfschema_agent"`
	Changes []string                                         `json:"changes,omitempty"`
}

func (res *changeAgentQANMySQLPerfSchemaAgentResult) Result() {}

func (res *changeAgentQANMySQLPerfSchemaAgentResult) String() string {
	return commands.RenderTemplate(changeAgentQANMySQLPerfSchemaAgentResultT, res)
}
...
func (cmd *ChangeAgentQANMySQLPerfSchemaAgentCommand) RunCmd() (commands.Result, error) {
	var changes []string
	...
	body := &agents.ChangeAgentParamsBodyQANMysqlPerfschemaAgent{
		Enable:                 cmd.Enable,
	...
	if customLabels != nil && len(*customLabels) > 0 {
		body.CustomLabels = &agents.ChangeAgentParamsBodyQANMysqlPerfschemaAgentCustomLabels{
			Values: *customLabels,
		}
	}
	...
	return &changeAgentQANMySQLPerfSchemaAgentResult{
