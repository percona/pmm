...
var changeAgentQANPostgreSQLPgStatementsAgentResultT = commands.ParseTemplate(`
QAN PostgreSQL PgStatements agent configuration updated.
...
type changeAgentQANPostgreSQLPgStatementsAgentResult struct {
	Agent   *agents.ChangeAgentOKBodyQANPostgresqlPgstatementsAgent `json:"qan_postgresql_pgstatements_agent"`
	Changes []string                                                `json:"changes,omitempty"`
}

func (res *changeAgentQANPostgreSQLPgStatementsAgentResult) Result() {}

func (res *changeAgentQANPostgreSQLPgStatementsAgentResult) String() string {
	return commands.RenderTemplate(changeAgentQANPostgreSQLPgStatementsAgentResultT, res)
}
...
func (cmd *ChangeAgentQANPostgreSQLPgStatementsAgentCommand) RunCmd() (commands.Result, error) {
	var changes []string
	...
	body := &agents.ChangeAgentParamsBodyQANPostgresqlPgstatementsAgent{
		Enable:                 cmd.Enable,
	...
	if customLabels != nil {
		body.CustomLabels = &agents.ChangeAgentParamsBodyQANPostgresqlPgstatementsAgentCustomLabels{
			Values: *customLabels,
		}
	}
	...
	params := &agents.ChangeAgentParams{
		...
		Body: agents.ChangeAgentBody{
			QANPostgresqlPgstatementsAgent: body,
		},
	...
	return &changeAgentQANPostgreSQLPgStatementsAgentResult{
