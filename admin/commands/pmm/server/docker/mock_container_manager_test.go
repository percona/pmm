...
func (_m *mockContainerManager) ChangeServerPassword(ctx context.Context, containerID string, newPassword string) error {
...
func (_m *mockContainerManager) ContainerWait(ctx context.Context, containerID string, condition container.WaitCondition) (<-chan container.ContainerWaitOKBody, <-chan error) {
...
func (_m *mockContainerManager) CreateVolume(ctx context.Context, volumeName string, labels map[string]string) (*types.Volume, error) {
...
func (_m *mockContainerManager) InstallDocker(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *mockContainerManager) IsDockerInstalled() (bool, error) {
	ret := _m.Called()
...
func (_m *mockContainerManager) ParsePullImageProgress(r io.Reader, p *tea.Program) (<-chan struct{}, <-chan error) {
	ret := _m.Called(r, p)
