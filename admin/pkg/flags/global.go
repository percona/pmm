...
type GlobalFlags struct {
	...
	AgentConfigFile         string      `name:"agent-config-file" help:"Path to pmm-agent configuration file (used to read server credentials)" env:"PMM_AGENT_CONFIG_FILE"`
	AgentConfigKeyFile      string      `name:"agent-config-file-key-file" help:"Path to the key file for decrypting agent configuration" env:"PMM_AGENT_CONFIG_FILE_KEY_FILE"`
	AgentConfigKeyPassword  string      `name:"agent-config-file-key-password" help:"Password for the agent configuration key file" env:"PMM_AGENT_CONFIG_FILE_KEY_PASSWORD"`
