...
func NewMySQLRestoreJob(id string, timeout time.Duration, name string, locationConfig BackupLocationConfig, folder string, compression backuppb.BackupCompression) *MySQLRestoreJob {
...
func (j *MySQLRestoreJob) binariesInstalled() error {
	...
	if j.compression == backuppb.BackupCompression_QUICKLZ {
...
func restoreBackup(ctx context.Context, backupDirectory, mySQLDirectory string, compression backuppb.BackupCompression) error {
	...
	if compression != backuppb.BackupCompression_NONE {
