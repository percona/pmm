...
import (
	...
	agentpbv1 "github.com/percona/pmm/api/agentpb/v1"
)
...
func (_m *mockSupervisor) Changes() <-chan *agentpbv1.StateChangedRequest {
	ret := _m.Called()

	var r0 <-chan *agentpbv1.StateChangedRequest
	if rf, ok := ret.Get(0).(func() <-chan *agentpbv1.StateChangedRequest); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan *agentpbv1.StateChangedRequest)
		}
	}
...
func (_m *mockSupervisor) QANRequests() <-chan *agentpbv1.QANCollectRequest {
	ret := _m.Called()

	var r0 <-chan *agentpbv1.QANCollectRequest
	if rf, ok := ret.Get(0).(func() <-chan *agentpbv1.QANCollectRequest); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan *agentpbv1.QANCollectRequest)
		}
	}
...
func (_m *mockSupervisor) SetState(_a0 *agentpbv1.SetStateRequest) {
	_m.Called(_a0)
}
