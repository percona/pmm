...
func TestGet(t *testing.T) {
	t.Run("OnlyFlags", func(t *testing.T) {
		...
		expected := Config{
			...
			Paths: Paths{
				PathsBase:        "/usr/local/percona/pmm3",
				ExportersBase:    "/usr/local/percona/pmm3/exporters",
				NodeExporter:     "/usr/local/percona/pmm3/exporters/node_exporter",
				MySQLdExporter:   "/usr/local/percona/pmm3/exporters/mysqld_exporter",
				MongoDBExporter:  "/usr/local/percona/pmm3/exporters/mongodb_exporter",
				PostgresExporter: "/usr/local/percona/pmm3/exporters/postgres_exporter",
				ProxySQLExporter: "/usr/local/percona/pmm3/exporters/proxysql_exporter",
				RDSExporter:      "/usr/local/percona/pmm3/exporters/rds_exporter",
				AzureExporter:    "/usr/local/percona/pmm3/exporters/azure_exporter",
				VMAgent:          "/usr/local/percona/pmm3/exporters/vmagent",
				TempDir:          "/usr/local/percona/pmm3/tmp",
				PTSummary:        "/usr/local/percona/pmm3/tools/pt-summary",
				PTPGSummary:      "/usr/local/percona/pmm3/tools/pt-pg-summary",
				PTMySQLSummary:   "/usr/local/percona/pmm3/tools/pt-mysql-summary",
				PTMongoDBSummary: "/usr/local/percona/pmm3/tools/pt-mongodb-summary",
			},
