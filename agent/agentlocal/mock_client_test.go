...
func (_m *mockClient) GetServerConnectMetadata() *agentpbv1.ServerConnectMetadata {
	ret := _m.Called()

	var r0 *agentpbv1.ServerConnectMetadata
	if rf, ok := ret.Get(0).(func() *agentpbv1.ServerConnectMetadata); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*agentpbv1.ServerConnectMetadata)
		}
	}
