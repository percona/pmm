...
const insertSQL = `
  ...
  VALUES (
    ...
    :labels_value,
    :agent_id,
    CAST( :agent_type_s AS Enum8('qan-agent-type-invalid'=0, 'qan-mysql-perfschema-agent'=1, 'qan-mysql-slowlog-agent'=2, 'qan-mongodb-profiler-agent'=3, 'qan-postgresql-pgstatements-agent'=4, 'qan-postgresql-pgstatmonitor-agent'=5, 'qan-mongodb-mongolog-agent'=6, 'qan-clickhouse-querylog-agent'=7)) AS agent_type,
    :period_start_ts,
    :period_length_secs,
    :fingerprint,
    :example,
