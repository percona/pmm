...
init:                 ## Install tools.
	...
	go build -modfile=tools/go.mod -o bin/protoc-gen-grpc-gateway github.com/Percona-Lab/grpc-gateway/v2/protoc-gen-grpc-gateway
	go build -modfile=tools/go.mod -o bin/protoc-gen-openapi github.com/Percona-Lab/grpc-gateway/v2/protoc-gen-openapiv2
