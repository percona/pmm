...
install -d -p %{buildroot}%{_datadir}/percona-dashboards/panels/pmm-compat
...
cp -pa ./ui/apps/pmm-compat/dist/. %{buildroot}%{_datadir}/percona-dashboards/panels/pmm-compat
...
%{_datadir}/%{name}
%{_datadir}/pmm-ui
%{_datadir}/percona-dashboards/panels/pmm-compat
