...
* :jirabug:`PMM-5531`: A healthcheck indicator was implemented for the PMM Server Docker image. It is based on the `Docker HEALTHCHECK <https://docs.docker.com/engine/reference/builder/#healthcheck>`_. This feature can be tested as follows::
