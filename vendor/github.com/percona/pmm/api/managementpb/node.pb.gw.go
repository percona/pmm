...
func local_request_Node_Register_0(ctx context.Context, marshaler runtime.Marshaler, server NodeServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RegisterNodeRequest
	var metadata runtime.ServerMetadata
...
func RegisterNodeHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NodeServer) error {
	...
	mux.Handle("POST", pattern_Node_Register_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Node_Register_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_Node_Register_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "management", "Node", "Register"}, "", runtime.AssumeColonVerbOpt(true)))
)
