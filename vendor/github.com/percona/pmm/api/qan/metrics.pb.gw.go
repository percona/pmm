...
func request_Metrics_GetMetricsByDigest_0(ctx context.Context, marshaler runtime.Marshaler, client MetricsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.GetMetricsByDigest(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterMetricsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MetricsClient) error {
	...
	mux.Handle("POST", pattern_Metrics_GetMetricsByDigest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Metrics_GetMetricsByDigest_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Metrics_GetMetricsByDigest_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Metrics_GetMetricsByDigest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "qan", "GetMetricsByDigest"}, ""))
)

var (
	forward_Metrics_GetMetricsByDigest_0 = runtime.ForwardResponseMessage
)
