...
API tests are included into pmm repository and located in [api-tests directory](https://github.com/percona/pmm/tree/main/managed/api-tests). API tests runs against running PMM Server container.
