...
* To work correctly pmm-agent needs vmagent and exporters installed on the system.
  ...
  * Another option is to do it manually
    * vmagent and exporters can be installed by building each of them or by downloading the pmm-client tarball from [percona.com](https://www.percona.com/downloads/pmm3/) and copying binaries to the exporters_base directory configured in a `pmm-agent-dev.yaml` file.
