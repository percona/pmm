...
type EventsStatementsHistory struct {
	...
	NestingEventID       *int64  `reform:"NESTING_EVENT_ID"`
	NestingEventType     string  `reform:"NESTING_EVENT_TYPE"` // FIXME check that enum works
	NestingEventLevel    *int32  `reform:"NESTING_EVENT_LEVEL"`
}
