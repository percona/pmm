...
func (v *agentTableType) Columns() []string {
	return []string{"agent_id", "agent_type", "runs_on_node_id", "service_id", "node_id", "pmm_agent_id", "custom_labels", "created_at", "updated_at", "disabled", "status", "listen_port", "version", "username", "password", "tls", "tls_skip_verify", "aws_access_key", "aws_secret_key", "table_count", "table_count_tablestats_group_limit", "query_examples_disabled", "max_query_log_size", "metrics_url", "rds_basic_metrics_disabled", "rds_enhanced_metrics_disabled"}
}
...
func (s Agent) String() string {
	...
	res[24] = "RDSBasicMetricsDisabled: " + reform.Inspect(s.RDSBasicMetricsDisabled, true)
	res[25] = "RDSEnhancedMetricsDisabled: " + reform.Inspect(s.RDSEnhancedMetricsDisabled, true)
