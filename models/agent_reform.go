...
func (v *agentTableType) Columns() []string {
	return []string{"agent_id", "agent_type", "runs_on_node_id", "pmm_agent_id", "custom_labels", "created_at", "status", "listen_port", "version", "username", "password", "connection_string", "metrics_url"}
}
...
func (s Agent) String() string {
	...
	res[8] = "Version: " + reform.Inspect(s.Version, true)
	res[9] = "Username: " + reform.Inspect(s.Username, true)
	res[10] = "Password: " + reform.Inspect(s.Password, true)
	res[11] = "ConnectionString: " + reform.Inspect(s.ConnectionString, true)
