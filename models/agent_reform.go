...
func (v *agentRowTableType) Columns() []string {
	return []string{"id", "type", "runs_on_node_id", "disabled", "version", "listen_port", "service_username", "service_password"}
}
