...
func _01_initDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "01_init.down.sql", size: 20, mode: os.FileMode(0644), modTime: time.Unix(1547566053, 0)}
...
func _01_initUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "01_init.up.sql", size: 4851, mode: os.FileMode(0644), modTime: time.Unix(1547569245, 0)}
