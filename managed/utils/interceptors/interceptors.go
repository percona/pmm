...
func Unary(serverMetricsInterceptor grpc.UnaryServerInterceptor) grpc.UnaryServerInterceptor {
	return func(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
		...
		err := logRequest(l, "RPC "+info.FullMethod, func() error {
			var origErr error
			res, origErr = serverMetricsInterceptor(ctx, req, info, handler)
			l.Debugf("\nRequest:\n%s\nResponse:\n%s\n", req, res)
			return origErr
		})
		return res, err
...
func Stream(serverMetricsInterceptor grpc.StreamServerInterceptor) grpc.StreamServerInterceptor {
	return func(srv interface{}, ss grpc.ServerStream, info *grpc.StreamServerInfo, handler grpc.StreamHandler) error {
		...
		err := logRequest(l, "Stream "+info.FullMethod, func() error {
			...
			return serverMetricsInterceptor(srv, wrapped, info, handler)
		})
		return err
	}
}
