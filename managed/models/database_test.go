...
func TestDatabaseChecks(t *testing.T) {
	...
	t.Run("Agents", func(t *testing.T) {
		...
		require.NoError(t, err)
		_, err = db.Exec(
			"INSERT INTO agents (agent_id, agent_type, runs_on_node_id, pmm_agent_id, disabled, status, created_at, updated_at, tls, tls_skip_verify, query_length, query_examples_disabled, max_query_log_size, table_count_tablestats_group_limit, rds_basic_metrics_disabled, rds_enhanced_metrics_disabled, push_metrics) "+
				"VALUES ('/agent_id/1', 'pmm-agent', '/node_id/1', NULL, false, '', $1, $2, false, false, 0, false, 0, 0, true, true, false)",
			now, now)
		require.NoError(t, err)
		...
		t.Run("runs_on_node_id_xor_pmm_agent_id", func(t *testing.T) {
			t.Run("Normal", func(t *testing.T) {
				...
				require.NoError(t, err)
				_, err = tx.Exec(
					"INSERT INTO agents (agent_id, agent_type, runs_on_node_id, pmm_agent_id, node_id, disabled, status, created_at, updated_at, tls, tls_skip_verify, query_length, query_examples_disabled, max_query_log_size, table_count_tablestats_group_limit, rds_basic_metrics_disabled, rds_enhanced_metrics_disabled, push_metrics) "+
		...
		t.Run("node_id_or_service_id_or_pmm_agent_id", func(t *testing.T) {
			...
			t.Run("node_id set", func(t *testing.T) {
				...
				_, err = tx.Exec(
					"INSERT INTO agents (agent_id, agent_type, runs_on_node_id, pmm_agent_id, node_id, service_id, disabled, status, created_at, updated_at, tls, tls_skip_verify, query_length, query_examples_disabled, max_query_log_size, table_count_tablestats_group_limit, rds_basic_metrics_disabled, rds_enhanced_metrics_disabled, push_metrics) "+
...
func TestDatabaseMigrations(t *testing.T) {
	...
	t.Run("stats_collections field migration: string to string array", func(t *testing.T) {
		sqlDB := testdb.Open(t, models.SkipFixtures, pointer.ToInt(67))
		...
		require.NoError(t, err)
		require.Equal(t, createdAgent.AgentID, agent.AgentID)
