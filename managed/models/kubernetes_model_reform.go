...
var KubernetesClusterTable = &kubernetesClusterTableType{
	s: parse.StructInfo{
		...
		Fields: []parse.FieldInfo{
			...
			{Name: "PXC", Type: "*ComponentSettings", Column: "pxc"},
			{Name: "ProxySQL", Type: "*ComponentSettings", Column: "proxysql"},
			{Name: "HAProxy", Type: "*ComponentSettings", Column: "haproxy"},
			{Name: "Mongod", Type: "*ComponentSettings", Column: "mongod"},
