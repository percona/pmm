...
var AgentTable = &agentTableType{
	s: parse.StructInfo{
		...
		Fields: []parse.FieldInfo{
			...
			{Name: "Username", Type: "*EncryptedString", Column: "username"},
			{Name: "Password", Type: "*EncryptedString", Column: "password"},
			{Name: "AgentPassword", Type: "*EncryptedString", Column: "agent_password"},
