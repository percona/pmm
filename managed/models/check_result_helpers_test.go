...
func TestCheckResults(t *testing.T) {
	...
	create := func(t *testing.T, cr *models.CheckResult) *models.CheckResult {
		t.Helper()
		require.NoError(t, models.CreateCheckResult(t.Context(), q, cr))
		return cr
	}
	...
	t.Run("create and find", func(t *testing.T) {
		...
		got, err := models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc}, 0, 0)
	...
	t.Run("filters", func(t *testing.T) {
		...
		got, err := models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, ServiceName: "prod"}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)
		assert.Equal(t, "ProdMySQL", got[0].ServiceName)

		// node_name: case-insensitive substring.
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, NodeName: "node-b"}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)
		assert.Equal(t, "node-B", got[0].NodeName)

		// category: exact.
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, Category: "security"}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)

		// check_name: exact.
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, CheckName: "old_ver"}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)

		// severity: exact.
		sev := models.Severity(common.Critical)
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, Severity: &sev}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)
		...
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, Status: &st}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)
		assert.Equal(t, models.CheckResultOK, got[0].Status)

		count, err := models.CountCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc})
		require.NoError(t, err)
	...
	t.Run("time range filter", func(t *testing.T) {
		...
		got, err := models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, From: &from}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)
	})
	...
	t.Run("pagination ordered by checked_at desc", func(t *testing.T) {
		...
		got, err := models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc}, 0, 2)
		require.NoError(t, err)
		require.Len(t, got, 2)
		...
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc}, 2, 2)
		require.NoError(t, err)
		require.Len(t, got, 1)
	...
	t.Run("mark read", func(t *testing.T) {
		...
		notRead := false
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, IsRead: &notRead}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 1)
		assert.Equal(t, cr2.ID, got[0].ID)

		// Unmark.
		require.NoError(t, models.MarkCheckResultsRead(t.Context(), q, []string{cr1.ID}, false))
		got, err = models.FindCheckResults(t.Context(), q, models.CheckResultFilters{ServiceID: svc, IsRead: &notRead}, 0, 0)
		require.NoError(t, err)
		require.Len(t, got, 2)
	})
