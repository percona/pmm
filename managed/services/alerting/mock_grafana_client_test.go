...
// ListPMMRuleIDs provides a mock function with given fields: ctx
func (_m *mockGrafanaClient) ListPMMRuleIDs(ctx context.Context) (map[string]struct{}, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for ListPMMRuleIDs")
	}
