...
// mockPitrStorage is an autogenerated mock type for the pitrStorage type
type mockPitrStorage struct {
	mock.Mock
}

// ListPITRTimelines provides a mock function with given fields: ctx, location
func (_m *mockPitrStorage) ListPITRTimelines(ctx context.Context, location models.BackupLocation) ([]backup.Timeline, error) {
