...
// GetPGComponents provides a mock function with given fields: _a0, _a1
func (_m *mockComponentsService) GetPGComponents(_a0 context.Context, _a1 *dbaasv1beta1.GetPGComponentsRequest) (*dbaasv1beta1.GetPGComponentsResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *dbaasv1beta1.GetPGComponentsResponse
	if rf, ok := ret.Get(0).(func(context.Context, *dbaasv1beta1.GetPGComponentsRequest) *dbaasv1beta1.GetPGComponentsResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dbaasv1beta1.GetPGComponentsResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *dbaasv1beta1.GetPGComponentsRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
