...
func (_m *mockKubernetesClient) CleanupMonitoring() error {
	ret := _m.Called()
...
func (_m *mockKubernetesClient) DeleteVMAgent(ctx context.Context, namespace string, name string) error {
...
// DoCSVWait provides a mock function with given fields: _a0, _a1
func (_m *mockKubernetesClient) DoCSVWait(_a0 context.Context, _a1 types.NamespacedName) error {
	ret := _m.Called(_a0, _a1)
...
// DoRolloutWait provides a mock function with given fields: _a0, _a1
func (_m *mockKubernetesClient) DoRolloutWait(_a0 context.Context, _a1 types.NamespacedName) error {
	ret := _m.Called(_a0, _a1)
...
// GetSubscriptionCSV provides a mock function with given fields: ctx, key
func (_m *mockKubernetesClient) GetSubscriptionCSV(ctx context.Context, key types.NamespacedName) (types.NamespacedName, error) {
...
func (_m *mockKubernetesClient) ListClusterServiceVersion(ctx context.Context, namespace string) (*v1alpha1.ClusterServiceVersionList, error) {
...
func (_m *mockKubernetesClient) ListVMAgents(ctx context.Context, namespace string, labels map[string]string) (*v1beta1.VMAgentList, error) {
...
// ProvisionMonitoring provides a mock function with given fields: login, password, pmmPublicAddress, labels
func (_m *mockKubernetesClient) ProvisionMonitoring(login string, password string, pmmPublicAddress string, labels map[string]string) error {
	ret := _m.Called(login, password, pmmPublicAddress, labels)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, map[string]string) error); ok {
		r0 = rf(login, password, pmmPublicAddress, labels)
	} else {
		r0 = ret.Error(0)
	}
