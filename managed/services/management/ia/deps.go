...
//go:generate $PMM_RELEASE_PATH/mockery -name=alertManager -case=snake -inpkg -testonly
//go:generate $PMM_RELEASE_PATH/mockery -name=vmAlert -case=snake -inpkg -testonly
