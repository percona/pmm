...
func TestMysqlAndXtrabackupCompatible(t *testing.T) {
	...
	compatible := []mysqlAndPXBVersions{
		...
		// MySQL [8.0.22; 9.0), PXB [8.0.22; 9.0) - aligned versions (PXB >= MySQL)
		{"8.0.22", "8.0.22"},
		{"8.0.22", "8.0.22-15.0"},
		{"8.0.22", "8.0.50"},
		{"8.0.22", "8.99.99"},
		...
		// MySQL [8.0.34; 9.0), PXB [8.0.34; 9.0) - universal compatibility (PXB 8.0.34+ works with any MySQL 8.0.34+)
		{"8.0.34", "8.0.34"},
		{"8.0.34", "8.0.35"},
		{"8.0.34-26", "8.0.35-27"},
		{"8.0.44", "8.0.35"},
	...
	incompatible := []mysqlAndPXBVersions{
		...
		// MySQL [8.0.22; 9.0), PXB [8.0.22; 9.0) - aligned versions
		{"8.0.22", "8.0.21"},
		{"8.0.22", "9.0"},
		//
		{"8.0.28", "8.0.22-15.0"},
