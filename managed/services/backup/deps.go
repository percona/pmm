...
//go:generate $PMM_RELEASE_PATH/mockery -name=agentService -case=snake -inpkg -testonly
//go:generate $PMM_RELEASE_PATH/mockery -name=versioner -case=snake -inpkg -testonly
//go:generate $PMM_RELEASE_PATH/mockery -name=compatibilityService -case=snake -inpkg -testonly
