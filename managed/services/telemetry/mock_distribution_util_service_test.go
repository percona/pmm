...
func (_m *mockDistributionUtilService) getDistributionMethodAndOS() (serverpbv1.DistributionMethod, pmmv1.DistributionMethod, string) {
	ret := _m.Called()

	var r0 serverpbv1.DistributionMethod
	var r1 pmmv1.DistributionMethod
	var r2 string
	if rf, ok := ret.Get(0).(func() (serverpbv1.DistributionMethod, pmmv1.DistributionMethod, string)); ok {
		return rf()
	}
