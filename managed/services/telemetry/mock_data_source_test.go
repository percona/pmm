...
func (_m *mockDataSource) FetchMetrics(ctx context.Context, config Config) ([]*telemetryv1.GenericReport_Metric, error) {
	...
	var r0 []*telemetryv1.GenericReport_Metric
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, Config) ([]*telemetryv1.GenericReport_Metric, error)); ok {
		return rf(ctx, config)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Config) []*telemetryv1.GenericReport_Metric); ok {
		r0 = rf(ctx, config)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*telemetryv1.GenericReport_Metric)
		}
	}
