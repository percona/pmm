...
func TestMySQLdExporterConfig(t *testing.T) {
	...
	expected := &agentpb.SetStateRequest_AgentProcess{
		...
		Args: []string{
			...
			"--collect.custom_query.hr.directory=/usr/local/percona/pmm3/collectors/custom-queries/mysql/high-resolution",
			"--collect.custom_query.lr",
			"--collect.custom_query.lr.directory=/usr/local/percona/pmm3/collectors/custom-queries/mysql/low-resolution",
			"--collect.custom_query.mr",
			"--collect.custom_query.mr.directory=/usr/local/percona/pmm3/collectors/custom-queries/mysql/medium-resolution",
