...
Normally we stick to Semantic Versioning and thus a X.Y.Z release is bug fixes
only, however we felt it important to introduce two new improvements.
...
* :pmmbug:`1634`: The |graph.advanced-data-exploration| dashboard did
