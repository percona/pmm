...
* :pmmbug:`1339`: Improve Tooltips for Dashboard mysql-query-response-time
...
* :pmmbug:`3471`: Fix global status metric names in `mysqld_exporter`
...
* :pmmbug:`3188`: Bug with memory usage for Amazon Aurora
* :pmmbug:`2615`: PMM Managed QAN fails to start - wrong logging
* :pmmbug:`2592`: MySQL Replication Dashboard shows error with multi-source replication
* :pmmbug:`2327`: Member State Uptime and Max member Ping time charts return an error
