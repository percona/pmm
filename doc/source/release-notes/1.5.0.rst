...
Percona announces the release of Percona Monitoring and Management |release|, with a focus on the following features:
...
- Enhanced support for MySQL on Amazon RDS and Amazon Aurora – Dedicated Amazon
  ...
  OS Metrics to Amazon RDS / Aurora MySQL Metrics
...
- Improved interface – A simple, consistent user interface makes it faster and
  more fluid to switch between Query Analytics and Metrics Monitor
...
Query Analytics is now integrated into Metrics Monitor and appears as a separate
dashboard known as PMM Query Analytics.
...
- :pmmbug:`1133`: Query Analytics is available from Grafana as a dashboard
