...
correlate application events (common cases: application deploys, outages, and
upgrades).
...
- :pmmbug:`2353`: Additional snapshot changes for using |grafana| 5
...
- :pmmbug:`2366`: Some charts were moved on Home dashboards
