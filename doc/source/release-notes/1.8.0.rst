...
- :pmmbug:`PMM-2124`: The number of the new version is missing in the
  notification of the successful update of |pmm|
- :pmmbug:`PMM-1453`: mysqld_exporter wrong mapping of innodb_buffer_pool_pages 
- :pmmbug:`PMM-2029`: Deadlock when adding external exporter 
- :pmmbug:`PMM-1908`: RDS MySQL nodes do not display Current QPS 
- :pmmbug:`PMM-2100`: rds_exporter crashed after running for several minutes 
- :pmmbug:`PMM-1511`: PXC cluster is not recognized correctly when |mariadb|
  nodes are monitored
- :pmmbug:`PMM-1715`: |mongodb| |qan|: Wrong Per Query Stats
- :pmmbug:`PMM-1893`: In |qan|, the Tables element can be empty 
- :pmmbug:`PMM-1941`: Fingerprint storage bug 
- :pmmbug:`PMM-1933`: If some parts of collector got an error, whole collector
  is down
- :pmmbug:`PMM-1934`: mysqld_exporter/collector/info_schema_auto_increment.go
  fails if there are same table names but with different cases
- :pmmbug:`PMM-1951`: Regression in |pmm-admin.add| |opt.mysql-queries| only -
  not working
