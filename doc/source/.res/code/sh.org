...
#+begin-block:: edit etc/systemd/system/pmm-mysql-metrics
+edit.etc-systemd-system-pmm-mysql-metrics+

.. code-block:: bash

   $ cd /etc/systemd/system
   $ edit pmm-mysql-metrics-42002.service
...
.. code-block:: guess
   ...
   Unit]
   escription=PMM Prometheus mysqld_exporter 42002
   ...
   tartLimitInterval=5
   tartLimitBurst=10
   xecStart=/bin/sh -c '/usr/local/percona/pmm-client/mysqld_exporter \
