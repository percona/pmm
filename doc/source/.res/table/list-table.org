...
.. list-table::
   ...
   * - rds_exporter_erroneous_requests
     - No corresponding |amazon-cloundwatch| metric. The number of erroneous API requests made to CloudWatch.
     - Count
   * - rds_exporter_requests_total
     - No corresponding |amazon-cloundwatch| metric. API requests made to |amazon-cloudwatch|
     - Count
   * - rds_exporter_scrape_duration_seconds
     - No corresponding |amazon-cloudwatch| metric. The time that the current RDS scrape took.
     - Seconds
   * - rds_latency
