...
You can control data retention by passing the :option:`METRICS_RETENTION` and
:option:`QUERIES_RETENTION` environment variables when
...
the minimum resolution for metrics by passing the :option:`METRICS_RESOLUTION`
